...
// Arquivo: wu-panel-2026/pages/manager/royalty-splits.php
// Rota:    wu-panel-2026/manager/royalty-splits
// ══════════════════════════════════════════════════════════════
                    ...
                    <form method="GET" class="d-flex align-items-end gap-2 flex-wrap flex-grow-1">
                        ...
                        <div style="flex:1;min-width:100px">
                            ...
                            <select name="year" class="form-select form-select-sm">
                                ...
                                <?php foreach ($years_avail as $y): ?>
                                    <option value="<?php echo $y; ?>" <?php echo $f_year == (string)$y ? 'selected' : ''; ?>>
                                        <?php echo $y; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div style="flex:1;min-width:100px">
                            ...
                            <select name="month" class="form-select form-select-sm">
                                <option value="">Todos</option>
                                <?php for ($m = 1; $m <= 12; $m++): ?>
                                    <option value="<?php echo $m; ?>" <?php echo $f_month == (string)$m ? 'selected' : ''; ?>>
                        ...
                        <div class="d-flex gap-1 align-self-end">
                            <button type="submit" class="btn btn-sm text-white" style="background:#FF0089">
