                ...
                <div class="ms-auto d-flex align-items-center">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li>
                                <a class="dropdown-item" href="../settings/config"><i
                                        class="bi bi-sliders me-2"></i>Configurações</a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="../help/help"><i
                    ...
                    <div class="filter-section fade-in-custom">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" id="filter-track"
                        ...
                        <div class="advanced-filters" id="advanced-filters">
                            <div class="row g-3 mt-3 pt-3 border-top">
                                <div class="col-md-4">
                                    ...
                                    <div class="row g-2">
                                        <div class="col">
                                            <input type="number" class="form-control" id="streams-min"
                                                placeholder="Mín" />
                                        </div>
                                        ...
                                        <div class="col">
                                            <input type="number" class="form-control" id="streams-max"
                                                placeholder="Máx" />
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="quick-filter mt-3">
                            ...
                            <button class="btn btn-outline-primary btn-sm filter-quick" data-filter="month"
                                data-active="true">
                                Este Mês
                            </button>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <div class="form-check form-check-inline">
                                                ...
                                                <label class="form-check-label" for="select-all-tracks">Selecionar
                                                    Todos</label>
                                            </div>
                                            <span class="text-muted ms-3" id="selected-tracks-count">0
                                                selecionados</span>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="col-account"
                                                    checked />
                                                <label class="form-check-label" for="col-account">Conta</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="col-track"
                                                    checked />
                                                <label class="form-check-label" for="col-track">Música</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="col-artist"
                                                    checked />
                                                <label class="form-check-label" for="col-artist">Artista</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="col-streams"
                                                    checked />
                                                <label class="form-check-label" for="col-streams">Streams</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="col-platform"
                                                    checked />
                                                <label class="form-check-label" for="col-platform">Plataforma</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="col-playlist"
                                                    checked />
                                                <label class="form-check-label" for="col-playlist">Playlist</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="col-territory"
                                                    checked />
