...
// Arquivo: wu-panel-2026/pages/analytics/home.php
// Rota:    wu-panel-2026/analytics
// ═══════════════════════════════════════════════════════════════════════════
    ...
    (function() {
        ...
        window.toggleBlock = async function(id, action) {
            ...
            const result = await Swal.fire({
                ...
                text: action === 'block' ?
                    'A track ficará bloqueada e não aparecerá no TOP 5 da plataforma.' :
                    'A track voltará a aparecer no TOP 5 da plataforma.',
                icon: 'warning',
