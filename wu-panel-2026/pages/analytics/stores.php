...
<head>
  ...
  <title>Desempenho por Lojas Digitais — <?php echo APP_NAME; ?></title>
...
<body>
      ...
      <ul class="nav flex-column mt-3">
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="collapseAnalytics">
            ...
            <a href="../analytics/stores" class="nav-link active">
      ...
      <div class="container-fluid py-0">
        <div class="row mb-3 mt-2">
          <div class="welcome-text col-auto d-sm-block">
            <h2 class="h4 mb-2">
              <i class="bi bi-shop me-2"></i> Desempenho por Lojas Digitais
            </h2>
          ...
          <div class="col-auto ms-auto text-end mt-n1 mt-3 mb-2">
            <button class="btn btn-wasomupfy text-white shadow-sm me-2" onclick="exportData()">
              <i class="bi bi-download me-2"></i> Exportar Relatório
            </button>
            <button class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#compareStoresModal">
              <i class="bi bi-graph-up-arrow me-1"></i> Comparar Lojas
            </button>
          </div>
        </div>
        ...
        <div class="card mb-4">
          <div class="card-body">
            <div class="row g-3">
              ...
              <div class="col-md-3">
                <label for="storeType" class="form-label">Tipo de Loja</label>
                <select class="form-select" id="storeType">
                  <option value="">Todos os tipos</option>
                  <option value="streaming">Streaming</option>
                  <option value="download">Download</option>
                  <option value="social">Redes Sociais</option>
                  <option value="radio">Rádio Digital</option>
                </select>
              </div>
              <div class="col-md-3">
                ...
                <select class="form-select" id="sortBy">
                  ...
                  <option value="royalty">Taxa de Royalty</option>
                </select>
              </div>
            </div>
                ...
                <div class="d-flex justify-content-between">
                  ...
                  <div class="form-check form-switch">
                    ...
                    <label class="form-check-label" for="realTimeUpdate">
                      <i class="bi bi-lightning-charge me-1"></i> Atualização
                      em Tempo Real
                    </label>
                  </div>
                </div>
        ...
        <div class="row mb-4">
          <div class="col-md-3">
            <div class="metric-card revenue fade-in">
              <h3 class="mb-2 counter" data-valor="24589050" data-tipo="moeda" id="totalRevenue">
                Kz0
              </h3>
              <p class="mb-0">Receita Total</p>
              <div class="metric-trend">
                <i class="bi bi-arrow-up-right me-1 trend-up"></i>
                <span class="trend-up counter" data-valor="12.5" data-tipo="porcentagem">+0%</span>
                <small class="ms-2">vs período anterior</small>
              </div>
            </div>
          </div>
          <div class="col-md-3">
            <div class="metric-card streams fade-in">
              <h3 class="mb-2 counter" data-valor="8500000" data-tipo="contagem" id="totalStreams">
                0
              </h3>
              <p class="mb-0">Streams Totais</p>
              <div class="metric-trend">
                <i class="bi bi-arrow-up-right me-1 trend-up"></i>
                <span class="trend-up counter" data-valor="8.2" data-tipo="porcentagem">+0</span>
                <small class="ms-2">vs período anterior</small>
              </div>
            </div>
          </div>
          <div class="col-md-3">
            <div class="metric-card downloads fade-in">
              <h3 class="mb-2 counter" data-valor="42.851" data-tipo="decimal" id="totalDownloads">
                0
              </h3>
              <p class="mb-0">Downloads Totais</p>
              <div class="metric-trend">
                <i class="bi bi-arrow-down-right me-1 trend-down"></i>
                <span class="trend-down counter" data-valor="3.1" data-tipo="porcentagem">-0</span>
                <small class="ms-2">vs período anterior</small>
              </div>
            </div>
          </div>
          <div class="col-md-3">
            <div class="metric-card royalties fade-in">
              <h3 class="mb-2 counter" data-valor="78.5" data-tipo="porcentagem" id="avgRoyalty">
                0
              </h3>
              <p class="mb-0">Royalty Médio</p>
              <div class="metric-trend">
                <i class="bi bi-dash-circle me-1 trend-neutral"></i>
                <span class="trend-neutral counter" data-valor="0.0" data-tipo="porcentagem">0</span>
                <small class="ms-2">vs período anterior</small>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-8">
                ...
                <ul class="nav nav-tabs card-header-tabs" id="analysisTabs" role="tablist">
                  <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="revenue-tab" data-bs-toggle="tab" data-bs-target="#revenue"
                      ...
                      <i class="bi bi-currency-dollar me-1"></i> Receita
                    </button>
                  </li>
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="streams-tab" data-bs-toggle="tab" data-bs-target="#streams"
                      type="button" role="tab">
                      <i class="bi bi-play-circle me-1"></i> Streams
                    </button>
                  </li>
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="growth-tab" data-bs-toggle="tab" data-bs-target="#growth" type="button"
                      role="tab">
                      <i class="bi bi-graph-up-arrow me-1"></i> Crescimento
                    </button>
                  </li>
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="geography-tab" data-bs-toggle="tab" data-bs-target="#geography"
                      type="button" role="tab">
                      <i class="bi bi-globe me-1"></i> Geografia
                    </button>
                  </li>
                </ul>
              </div>
            ...
            <div class="card">
              <div class="card-header">
                <h5 class="mb-0">
                  <i class="bi bi-lightbulb me-2"></i> Insights e
                  Recomendações
                </h5>
              </div>
              <div class="card-body">
                <div class="insight-card mb-3 fade-in">
                  <h6><i class="bi bi-trophy me-2"></i> Top Performer</h6>
                  <p class="mb-0">
                    Spotify lidera com 42% da receita total. Considere
                    promover exclusivos nesta plataforma.
                  </p>
                </div>

                <div class="row">
                  <div class="col-md-6">
                    <div class="comparison-card positive fade-in">
                      <h6 class="mb-1">
                        <i class="bi bi-arrow-up-right me-2"></i> Crescimento
                        Notável
                      </h6>
                      <p class="mb-0 text-muted">
                        YouTube Music cresceu 34% no último mês.
                      </p>
                    </div>

                    <div class="comparison-card positive fade-in">
                      <h6 class="mb-1">
                        <i class="bi bi-coin me-2"></i> Alta Rentabilidade
                      </h6>
                      <p class="mb-0 text-muted">
                        Apple Music possui o maior royalty por stream (R$
                        0.0085).
                      </p>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="comparison-card negative fade-in">
                      <h6 class="mb-1">
                        <i class="bi bi-arrow-down-right me-2"></i> Atenção
                        Necessária
                      </h6>
                      <p class="mb-0 text-muted">
                        Deezer apresentou queda de 12% nos streams.
                      </p>
                    </div>
                    ...
                    <div class="comparison-card negative fade-in">
                      ...
                      <p class="mb-0 text-muted">
                        Tidal tem baixa penetração no mercado brasileiro.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-md-4">
            ...
            <div class="card mb-4">
              <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">
                  <i class="bi bi-trophy me-2"></i> Ranking de Lojas
                </h5>
                <small class="text-muted">Top 10</small>
              </div>
              <div class="card-body">
                <div id="storesRanking">
            ...
            <div class="card">
              <div class="card-header">
                <h5 class="mb-0">
                  <i class="bi bi-globe-americas me-2"></i> Top Países
                </h5>
              </div>
              <div class="card-body">
                <div id="countriesPerformance">
                  <!-- Performance por país será carregada via JavaScript -->
                  <div class="text-center py-4">
                    <div class="spinner-border text-primary" role="status">
                      <span class="visually-hidden">Carregando...</span>
                    </div>
        ...
        <div class="card mt-4">
          <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">
              <i class="bi bi-table me-2"></i> Desempenho Detalhado por Loja
            </h5>
            <div class="d-flex gap-2">
              <input type="text" class="form-control form-control-sm" placeholder="Buscar loja..." style="width: 200px"
                id="storeSearch" />
              <button class="btn btn-outline-secondary btn-sm" onclick="searchStores()">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-hover store-table">
                <thead>
                  <tr>
                    <th width="60">Rank</th>
                    <th>Loja Digital</th>
                ...
                <tbody id="storesTable">
                  ...
                  <tr>
                    <td colspan="9" class="text-center py-5">
                      ...
                      <p class="mt-2">Carregando dados das lojas...</p>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <nav aria-label="Paginação" class="mt-3">
              <ul class="pagination justify-content-center" id="storesPagination">
  ...
  <!-- Modal Comparar Lojas -->
  <div class="modal fade" id="compareStoresModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">
            <i class="bi bi-graph-up-arrow me-2"></i> Comparar Lojas Digitais
          </h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <div class="mb-3">
            <label class="form-label">Selecione até 4 lojas para comparar</label>
            <div class="row" id="compareStoresContainer">
              <!-- Lojas para comparar serão carregadas aqui -->
            </div>
          </div>

          <div class="mb-3">
            <label for="compareMetric" class="form-label">Métrica para Comparação</label>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary" onclick="generateComparisonReport()">
            <i class="bi bi-download me-1"></i> Exportar Comparação
          </button>
        </div>
      </div>
    </div>
  ...
  <div class="modal fade" id="storeDetailsModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="storeModalTitle">Detalhes da Loja</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
  ...
  <script src="js/stores-performance.js"></script>
</body>
