...
<head>
  ...
  <title>Gerenciamento de Visitantes — <?php echo APP_NAME; ?></title>
      ...
      <div class="container-fluid py-0">
        <div class="row mb-3 mt-2">
          <div class="welcome-text col-auto d-sm-block">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item">
                  <a href="../security/home" class="text-secondary">Segurança</a>
                </li>
          ...
          <div class="col-auto ms-auto text-end mt-n1 mt-3 mb-2">
            <button class="btn btn-wasomupfy text-white shadow-sm me-2" id="refresh-visitors-btn">
              <i class="bi bi-arrow-clockwise me-2"></i> Atualizar
            </button>
            <button class="btn btn-danger text-white shadow-sm" data-bs-toggle="modal"
                ...
                <div class="card-body">
                  <div class="d-flex justify-content-between align-items-center">
                    <div>
                      ...
                      <span class="badge bg-success real-time-badge">Tempo Real</span>
                    </div>
                    <div class="stat">
                ...
                <div class="card-body">
                  <div class="d-flex justify-content-between align-items-center">
                    <div>
                      ...
                      <h3 class="card-title mb-0 counter badge badge-soft-pink" data-valor="5" data-tipo="contagem"
                        id="total-count">
                        0
                      </h3>
                ...
                <div class="card-body">
                  <div class="d-flex justify-content-between align-items-center">
                    <div>
                      ...
                      <h3 class="card-title mb-0 counter badge badge-soft-pink" data-tipo="contagem" id="blocked-count">
                        0
                      </h3>
                  ...
                  <div class="map-container">
                    <div class="map-placeholder" id="map-placeholder">
                      <div class="text-center">
                        <i class="bi bi-globe-americas display-4 mb-3 text-muted"></i>
          ...
          <div class="search-container fade-in-custom mt-3">
            <div class="row g-3">
              <div class="col-md-2">
                ...
                <input type="text" class="form-control" id="filter-ip" placeholder="Ex: 192.168.1.1" />
              </div>
              <div class="col-md-2">
            ...
            <div class="d-flex justify-content-between align-items-center mt-2 mb-2">
              ...
              <span class="badge bg-primary" id="visitor-results-count">0 resultados</span>
            </div>
          </div>
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    <div>
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="select-all-visitors" />
                        <label class="form-check-label" for="select-all-visitors">Selecionar Todos</label>
                      </div>
                      <span class="text-muted ms-3" id="selected-count">0 selecionados</span>
                    </div>
                    <div class="btn-group">
                      <button class="btn btn-outline-primary btn-sm" id="export-selected-btn">
                        <i class="bi bi-download me-1"></i> Exportar
                      </button>
                      <button class="btn btn-outline-warning btn-sm" id="block-selected-btn">
          ...
          <div class="card fade-in-custom mt-3">
            ...
            <nav aria-label="Page navigation">
              <ul class="pagination justify-content-center" id="visitors-pagination"></ul>
            </nav>
          </div>
        ...
        <div class="modal-dialog modal-fullscreen">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-warning" id="toggle-block-btn">
                <i class="bi bi-shield-lock me-2"></i> Bloquear/Desbloquear
              </button>
              <button type="button" class="btn btn-danger" id="delete-visitor-btn">
              ...
              <div class="modal-body">
                ...
                <div class="form-section mt-3">
                  ...
                  <div class="row g-3 mt-2">
                    <div class="col-md-6">
                      <label for="block-type" class="form-label">Tipo de Bloqueio*</label>
                    ...
                    <div class="col-md-6" id="custom-block-duration" style="display: none">
                      <label for="block-duration" class="form-label">Duração (dias)</label>
                      <input type="number" class="form-control" id="block-duration" min="1" max="365" value="7" />
                    </div>
                    <div class="col-md-12">
                      <label for="block-reason" class="form-label">Motivo do Bloqueio*</label>
                    ...
                    <div class="col-md-12">
                      <label for="block-notes" class="form-label">Observações Adicionais</label>
                      <textarea class="form-control" id="block-notes" rows="3"
                        placeholder="Detalhes adicionais sobre o bloqueio..."></textarea>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="modal-content">
            ...
            <form id="bulk-delete-form">
              <div class="modal-body">
                ...
                <div class="mt-4">
                  <div class="mb-3">
                    <label for="delete-option" class="form-label">Opção de Limpeza*</label>
                  ...
                  <div class="mb-3">
                    <label for="delete-confirm" class="form-label">Digite "EXCLUIR TUDO" para confirmar*</label>
                    <input type="text" class="form-control" id="delete-confirm" required />
                  </div>

                  <div class="mb-3">
                    <label for="admin-password-bulk" class="form-label">Senha de Administrador*</label>
                    <input type="password" class="form-control" id="admin-password-bulk" required />
                  </div>
                </div>
              </div>
              <div class="modal-footer">
          ...
          <div class="modal-content">
            ...
            <form id="export-form">
              <div class="modal-body">
                ...
                <div class="mb-3">
                  <label for="export-range" class="form-label">Período*</label>
                ...
                <div class="mb-3">
                  <label for="export-fields" class="form-label">Campos a Incluir</label>
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="field-ip" checked />
                    <label class="form-check-label" for="field-ip">Endereço IP</label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="field-location" checked />
                    <label class="form-check-label" for="field-location">Localização</label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="field-device" checked />
                    <label class="form-check-label" for="field-device">Dispositivo</label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="field-browser" checked />
                    <label class="form-check-label" for="field-browser">Navegador</label>
                  </div>
                  <div class="form-check">
