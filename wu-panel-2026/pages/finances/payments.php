...
<head>
    ...
    <title>Gerenciamento de Pagamentos — <?php echo APP_NAME; ?></title>
    ...
    <div class="wrapper">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav flex-column mt-3">
                ...
                <li class="nav-item">
                    <a href="../finances/payments" class="nav-link active">
                    ...
                    <div class="welcome-text col-auto d-sm-block">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                <li class="breadcrumb-item"><a href="../finances/payments"
