...
// Arquivo: wu-panel-2026/pages/payments/edit.php
// Rota:    wu-panel-2026/payments/edit?id=X
// ═══════════════════════════════════════════════════════════════════════════════
                        ...
                        <div class="col-lg-4">
                            <div class="pe-card">
                                ...
                                <div class="mt-2 small">Plano:
                                    <strong><?php echo htmlspecialchars($pay['name_plan']); ?></strong></div>
                                <div class="mt-2 small">Valor: <?php echo number_format((float)$pay['amount'], 2); ?>
                                    AOA</div>
                                <div class="mt-2 small">Referência:
                                    <code><?php echo htmlspecialchars($pay['payment_ref']); ?></code></div>
                            </div>
                            <div class="pe-card">
