...
<head>
  ...
  <title>Nova Mensagem — <?php echo APP_NAME; ?></title>
      ...
      <div class="container-fluid py-0">
        <div class="row mb-3 mt-2">
          <div class="welcome-text col-auto d-sm-block">
            <h2 class="mb-3">
              <i class="bi bi-pencil me-2"></i> Nova Mensagem
            </h2>
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item">
                  <a href="inbox" class="text-secondary">Caixa de Entrada</a>
                </li>
          ...
          <div class="col-lg-10">
            <div class="card compose-card">
              <div class="card-body">
                <form id="composeForm">
                  <div class="mb-3">
                    <label for="toRecipients" class="form-label">Para *</label>
                    <div id="recipientsContainer" class="mb-2">
                      <!-- Tags de destinatários serão adicionadas aqui -->
                    </div>
                    <input type="text" class="form-control" id="toRecipients"
                      placeholder="Digite e-mails separados por vírgula ou selecione da lista" />
                    <small class="text-muted">Pressione Enter ou Tab para adicionar</small>
                  </div>

                  <div class="row mb-3">
                    <div class="col-md-6">
                      <label for="ccRecipients" class="form-label">CC</label>
                      <input type="text" class="form-control" id="ccRecipients" placeholder="Cópia para" />
                    </div>
                    <div class="col-md-6">
                      <label for="bccRecipients" class="form-label">BCC</label>
                      <input type="text" class="form-control" id="bccRecipients" placeholder="Cópia oculta para" />
                    </div>
                  </div>

                  <div class="mb-3">
                    <label for="emailSubject" class="form-label">Assunto *</label>
                    <input type="text" class="form-control" id="emailSubject" placeholder="Assunto da mensagem"
                      required />
                  </div>
                  ...
                  <div class="mb-3">
                    ...
                    <div class="editor-toolbar">
                      <div class="btn-group btn-group-sm" role="group">
                        ...
                        <button type="button" class="btn btn-outline-secondary" onclick="formatText('bullet')">
                          <i class="bi bi-list-ul"></i>
                        </button>
                        <button type="button" class="btn btn-outline-secondary" onclick="formatText('number')">
                    ...
                    <div class="editor-content" id="emailMessage" contenteditable="true"
                      placeholder="Digite sua mensagem aqui..."></div>
                  </div>

                  <div class="mb-3">
                    <label for="emailAttachments" class="form-label">Anexos</label>
                    <input type="file" class="form-control" id="emailAttachments" multiple />
                    <small class="text-muted">Arraste arquivos aqui ou clique para selecionar (máx.
                      25MB total)</small>

                    <div id="attachmentsPreview" class="attachment-preview" style="display: none">
                      <h6 class="mb-2">Arquivos anexados:</h6>
                  ...
                  <div class="quick-templates">
                    <h6 class="mb-2">
                      <i class="bi bi-stars me-2"></i> Modelos Rápidos
                    </h6>
                    <div class="row">
                      <div class="col-md-4">
                        <div class="template-item" onclick="loadTemplate('greeting')">
                          <h6 class="mb-1">Saudação</h6>
                          <p class="text-muted small mb-0">
                            Modelo formal de abertura
                          </p>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="template-item" onclick="loadTemplate('followup')">
                          <h6 class="mb-1">Acompanhamento</h6>
                          <p class="text-muted small mb-0">
                            Para seguir up de tickets
                          </p>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="template-item" onclick="loadTemplate('support')">
                          <h6 class="mb-1">Resposta de Suporte</h6>
                          <p class="text-muted small mb-0">
                  ...
                  <div class="d-flex justify-content-between mt-4">
                    <div>
                      ...
                      <button type="button" class="btn btn-outline-primary ms-2" onclick="previewEmail()">
            ...
            <div class="card mt-3">
              <div class="card-body">
                <h6>
                  <i class="bi bi-lightbulb me-2"></i> Dicas para uma boa
                  mensagem:
                </h6>
                <ul class="mb-0">
                  <li>Use um assunto claro e objetivo</li>
                  <li>Seja direto no primeiro parágrafo</li>
                  <li>Use listas para itens importantes</li>
                  <li>Revise antes de enviar</li>
                  <li>Adicione anexos relevantes</li>
                </ul>
              </div>
            </div>
          </div>
  ...
  <div class="modal fade" id="previewModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Pré-visualização do Email</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary" onclick="sendEmail()">
            <i class="bi bi-send me-1"></i> Enviar Agora
          </button>
        </div>
      </div>
    </div>
