...
// Arquivo: wu-panel-2026/pages/artist/view.php
// Rota:    wu-panel-2026/artist/view?id=X
// ══════════════════════════════════════════════
                            ...
                            <div class="d-flex align-items-center gap-4 position-relative" style="z-index:1">
                                <div class="av-avatar-wrap flex-shrink-0">
                                    ...
                                    <div class="av-avatar-ini-lg" style="background:<?php echo $color; ?>">
                                        <?php echo $ini; ?></div>
                                    <?php endif; ?>
                                    <?php $dot_color = match ($artist['status_artist']) { 'active' => '#22c55e', 'inactive' => '#6b7280', 'blocked' => '#ef4444', default => '#eab308' }; ?>
