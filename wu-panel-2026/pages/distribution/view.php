...
// Arquivo: wu-panel-2026/pages/distribution/view.php
// Rota:    wu-panel-2026/releases/view?id=X
// ══════════════════════════════════════════════════════════════
                        ...
                        <div class="card mb-4" style="border-radius:14px;overflow:hidden">
                            ...
                            <?php foreach ($tracks as $idx => $t):
                                    $audio_url = $t['audio_exists']
                                        ...
                                        : null;
                                    $meta_parts = [];
                                    if ($t['name_author'])       $meta_parts[] = 'Autor: ' . $t['name_author'];
                                    if ($t['name_author_feat'])  $meta_parts[] = 'Feat: ' . $t['name_author_feat'];
