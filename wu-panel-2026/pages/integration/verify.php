...
// Arquivo: wu-panel-2026/pages/integration/verify.php
// Rota:    wu-panel-2026/integration/verify
// ═══════════════════════════════════════════════════════════════════════════
...
if ($export_csv === '1' && isset($_GET['csrf'])) {
    ...
    fputcsv($out, [
        'ID', 'Canal', 'ID do Canal', 'URL', 'Código Verificação',
        'Estado', 'Data Registo', 'Verificado em', 'Utilizador', 'E-mail', 'Artista'
    ], ';');
                        ...
                        <div class="row g-2 align-items-end">
                            <div class="col-md-3">
                                ...
                                <select name="status" class="form-select form-select-sm filter-instant">
                                    ...
                                    <option value="verified" <?php echo $status === 'verified' ? 'selected' : ''; ?>>
                            ...
                            <div class="col-md-5">
                                ...
                                <input type="text" name="search" class="form-control form-control-sm filter-debounce"
                                    placeholder="Nome do canal, ID, e-mail, artista..."
                                    value="<?php echo htmlspecialchars($search); ?>">
                            </div>
                            <div class="col-md-2">
                                <button type="submit" class="btn btn-sm text-white w-100" style="background:#FF0089"><i
                        ...
                        <table class="table table-hover mb-0" id="verify">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="fw-bold"><?php echo htmlspecialchars($ch['channel_name']); ?></div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header" style="background:#FF0089">
                    <h5 class="modal-title text-white fw-bold"><i class="bi bi-youtube me-2"></i>Detalhes do Canal</h5>
