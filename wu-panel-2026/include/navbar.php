<?php
// ══════════════════════════════════════════════
// WASOM UPFY v2.0 — Navbar Admin (reutilizável)
// Arquivo: admin/include/navbar.php
//
// Requer platform_admin.php carregado antes.
//
// Uso:
//   <?php require_once PATH_ADMIN . '/include/navbar.php'; 
?>
    ...
    <div class="ms-auto d-flex align-items-center">
        ...
        <div class="dropdown me-2 position-relative">
            <button class="btn btn-outline-light btn-sm position-relative" type="button" data-bs-toggle="dropdown"
                ...
                <?php if ($adm_total_notifs > 0): ?>
                    <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">
                        <?php echo $adm_total_notifs; ?>
                    </span>
                <?php endif; ?>
            </button>
            <ul class="dropdown-menu dropdown-menu-start p-0" style="min-width:260px">
                <li class="dropdown-header bg-dark text-white p-2 d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge bg-danger"><?php echo $adm_total_notifs; ?></span>
                </li>
                <?php if ($adm_pending_releases > 0 && hasPermission($admin_id, 'music.approve')): ?>
                    <li>
                        <a class="dropdown-item p-2" href="<?php echo APP_URL . '/' . ADMIN_PATH; ?>/releases/pending">
                            <i class="bi bi-hourglass-split text-warning me-2"></i>
                            <?php echo $adm_pending_releases; ?> lançamento(s) pendente(s)
                        </a>
                    </li>
                <?php endif; ?>
                <?php if ($adm_pending_payments > 0 && hasPermission($admin_id, 'finances.view')): ?>
                    <li>
                        <a class="dropdown-item p-2" href="<?php echo APP_URL . '/' . ADMIN_PATH; ?>/finances/payments">
                            <i class="bi bi-credit-card text-info me-2"></i>
                            <?php echo $adm_pending_payments; ?> pagamento(s) por aprovar
                        </a>
                    </li>
                <?php endif; ?>
                <?php if ($adm_open_tickets > 0 && hasPermission($admin_id, 'support.view')): ?>
                    <li>
                        <a class="dropdown-item p-2" href="<?php echo APP_URL . '/' . ADMIN_PATH; ?>/support">
                ...
                <li class="dropdown-footer text-center p-2">
                    <a href="<?php echo APP_URL . '/' . ADMIN_PATH; ?>/support" class="text-primary">Ver todas</a>
                </li>
            </ul>
        </div>
        ...
        <div class="dropdown me-2 position-relative">
            ...
            <ul class="dropdown-menu dropdown-menu-start p-0" style="min-width:250px">
                ...
                <li class="dropdown-footer text-center p-2">
                    <a href="<?php echo APP_URL . '/' . ADMIN_PATH; ?>/support" class="text-primary">Ir para suporte</a>
                </li>
            </ul>
        </div>
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                ...
                <?php endif; ?>
                <li>
                    <a class="dropdown-item" href="<?php echo APP_URL . '/' . ADMIN_PATH; ?>/faq">
        ...
        <div class="modal-content modal-bottom">
            ...
            <div class="modal-body">
                ...
                <div style="display:flex;align-items:center;gap:14px;padding:14px 16px;
                            background:#f8f7fc;border-radius:12px;margin-bottom:14px">
                    <div style="width:48px;height:48px;border-radius:50%;
                                background:linear-gradient(135deg,#FF0089,#ff6bb5);
                                display:flex;align-items:center;justify-content:center;
                                font-weight:800;font-size:.95rem;color:#fff;flex-shrink:0;overflow:hidden">
                        <?php if ($admin_photo): ?>
                            <img src="<?php echo APP_URL; ?>/assets/comprovantes/uploads/employees/<?php echo htmlspecialchars($admin_photo); ?>"
                    ...
                    <div>
                        ...
                        <div style="font-size:.78rem;color:#888"><?php echo getRoleLabel($admin_role); ?> ·
