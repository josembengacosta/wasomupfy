  ...
  <header>
    <nav class="navbar navbar-expand-lg transparent navbar-transparent navbar-dark">
      <div class="container px-3">
        <a class="navbar-brand" href="home" title="Home"><img src="assets/img/brand/wasomupfy_brand.png" width="65"
            class="img-logo" height="60" alt="Logo Wasom Upfy" /></a>
        ...
        <div class="offcanvas offcanvas-start offcanvas-nav" style="width: 20rem">
          ...
          <div class="offcanvas-body pt-0 align-items-center">
            <ul class="navbar-nav mx-auto align-items-lg-center">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="about" title="Sobre" role="button" data-bs-toggle="link"
                  ...
                  <div class="row row-cols-lg-3">
                    ...
                    <div class="col">
                      <div class="mt-3 mt-lg-0">
                        ...
                        <a title="Parcerias" class="dropdown-item" href="page/services/music-promotion">Promoção de
                          música
                          <span class="badge bg-success">Novo</span></a>
                        <a title="Indisponível" class="dropdown-item" href="page/services/customized-services">Serviços
                          personalizados
                          <span class="badge bg-warning">Indisponível</span></a>
                      </div>
                      ...
                      <div class="mt-3">
                        ...
                        <a title="Canal WhatsApp" class="dropdown-item"
                          href="https://whatsapp.com/channel/0029VaCEDqo59PwWpU0nGa04">Canal WhatsApp</a>
                      </div>
                    </div>
        ...
        <div class="row g-4 text-center">
          <div class="col-md-3 col-6" data-cue="zoomIn">
            <div class="stat-card p-4 rounded-4 shadow-sm">
              ...
              <h3 class="stat-number display-5 fw-bold text-dark mb-2" data-counter="150">
                0
              </h3>
          ...
          <div class="col-md-3 col-6" data-cue="zoomIn" data-delay="100">
            <div class="stat-card p-4 rounded-4 shadow-sm">
              ...
              <h3 class="stat-number display-5 fw-bold text-dark mb-2" data-counter="500">
                0
              </h3>
          ...
          <div class="col-md-3 col-6" data-cue="zoomIn" data-delay="200">
            <div class="stat-card p-4 rounded-4 shadow-sm">
              ...
              <h3 class="stat-number display-5 fw-bold text-dark mb-2" data-counter="2500">
                0
              </h3>
          ...
          <div class="col-md-3 col-6" data-cue="zoomIn" data-delay="300">
            <div class="stat-card p-4 rounded-4 shadow-sm">
              ...
              <h3 class="stat-number display-5 fw-bold text-dark mb-2" data-counter="50">
                0
              </h3>
      ...
      <div class="container">
        <div class="row align-items-center g-5">
          <div class="col-lg-6" data-cue="slideInLeft">
            <span class="badge bg-wasomupfy bg-opacity-10 text-wasomupfy rounded-pill px-4 py-2 mb-3 d-inline-block">
              Nossa Origem
            </span>
            <h2 class="display-6 fw-bold mb-4">Quem Somos?</h2>
            <div class="timeline ps-3 border-start border-wasom">
              <div class="timeline-item mb-4">
                <div class="timeline-date text-wasomupfy fw-semibold">
                  2021 - 2022
                </div>
                <h4 class="h5 mb-2">O Início de uma Revolução</h4>
                <p>
                  A Wasom Upfy é idealizada por
                  <strong>Cristiano Amadeu</strong> em Luanda. O foco inicial
                  foi preencher a lacuna entre o talento independente angolano
                  e as grandes prateleiras digitais do mundo, estabelecendo os
                  primeiros pilares de distribuição.
                </p>
              </div>
              ...
              <div class="timeline-item mb-4">
                ...
                <p>
                  Consolidamos nossa presença no
                  <strong>Instagram, YouTube e LinkedIn</strong>, criando uma
                  comunidade vibrante. Implementamos tecnologia própria para
                  garantir que artistas africanos chegassem a mais de 150
                  países com transparência total.
                </p>
              </div>
              ...
              <div class="timeline-item mb-4">
                ...
                <p>
                  ...
                  <strong>500 artistas agenciados</strong>. Nossa rede
                  estratégica expandiu-se, garantindo parcerias diretas com
                  curadores de playlists globais.
                </p>
              </div>
              ...
              <div class="timeline-item mb-4">
                ...
                <p>
                  Lançamento de ferramentas de análise de dados exclusivas
                  para nossos artistas, permitindo que eles entendam onde seu
                  público está e como maximizar os lucros do seu catálogo
                  musical.
                </p>
              </div>
              ...
              <div class="timeline-item">
                ...
                <p>
                  A Wasom Upfy posiciona-se como a principal ponte tecnológica
                  para a música africana global. Com presença em Luanda e
                  alcance em todos os continentes, somos o padrão ouro para
                  quem busca impacto e sustentabilidade artística.
                </p>
              </div>
            </div>
          </div>
          <div class="col-lg-6" data-cue="slideInRight">
            <div class="about-image-wrapper position-relative">
              <img src="assets/img/theme/story.png" alt="Equipe Wasom Upfy" class="rounded-4 img-fluid shadow-lg"
                loading="lazy" />
              <div
                class="about-badge bg-wasom text-wasomupfy rounded-3 p-3 shadow position-absolute bottom-0 start-0 translate-middle">
                <h5 class="mb-1">+500 Artistas</h5>
                <p class="small mb-0 opacity-75 text-wasomupfy font-bolder">
                  Empoderados
                </p>
              </div>
            </div>
            ...
            <div class="card border-0 h-100 shadow-sm hover-lift">
              <div class="card-body p-4">
                ...
                <p class="mb-0 text-muted">
                  Acelerar a carreira de artistas independentes através de uma
                  infraestrutura tecnológica de ponta, garantindo que a música
                  africana rompa fronteiras e gere receita real em escala
                  global.
                </p>
              </div>
            </div>
          ...
          <div class="col-lg-4" data-cue="zoomIn" data-delay="100">
            <div class="card border-0 h-100 shadow-sm hover-lift">
              <div class="card-body p-4">
                ...
                <p class="mb-0 text-muted">
                  Ser a maior autoridade global em distribuição e marketing de
                  ritmos africanos, sendo reconhecida como o parceiro número 1
                  de artistas que buscam profissionalismo e liderança no
                  mercado digital.
                </p>
              </div>
            </div>
              ...
              <div class="card-body p-4">
                ...
                <ul class="list-unstyled mb-0">
                  <li class="d-flex align-items-start mb-2">
                    ...
                    <span class="fw-semibold">Inovação Orientada a Dados:</span>
                    <span> Decisões inteligentes para o sucesso.</span>
                  </li>
                  <li class="d-flex align-items-start mb-2">
                    <i class="bi bi-check-circle-fill text-wasomupfy me-2 mt-1"></i>
                    <span class="fw-semibold">Transparência Radical:</span>
                    <span> O artista sempre no controle dos ganhos.</span>
                  </li>
                  <li class="d-flex align-items-start mb-2">
                    <i class="bi bi-check-circle-fill text-wasomupfy me-2 mt-1"></i>
                    <span class="fw-semibold">Paixão Cultural:</span>
                    <span> Elevando a essência da nossa arte ao mundo.</span>
                  </li>
                  <li class="d-flex align-items-start">
                    <i class="bi bi-check-circle-fill text-wasomupfy me-2 mt-1"></i>
                    <span class="fw-semibold">Excelência Executiva:</span>
                    <span> Agilidade e rigor em cada lançamento.</span>
                  </li>
                </ul>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-lg-8 text-center">
            <span
              class="badge bg-wasomupfy bg-opacity-10 text-wasomupfy rounded-pill px-3 py-2 mb-3 d-inline-block">Nossos
              Serviços</span>
            <h2 class="display-6 fw-bold mb-4">O Que Fazemos?</h2>
            <p class="lead text-muted">
              Oferecemos soluções completas para levar sua música ao mundo
            </p>
          </div>
        </div>
                ...
                <div class="d-flex align-items-start mb-4">
                  ...
                  <div>
                    ...
                    <p class="text-muted mb-0">
                      Levamos sua música para todas as plataformas principais
                    </p>
                  </div>
                </div>
                <ul class="list-unstyled mb-0">
                  ...
                  <li class="d-flex align-items-center mb-2">
                    <i class="bi bi-check-circle-fill text-wasomupfy me-2"></i>
                    <span>Mais de 200 serviços mundiais</span>
                  </li>
              ...
              <div class="card-body p-3">
                <div class="d-flex align-items-start mb-4">
                  ...
                  <div>
                    ...
                    <p class="text-muted mb-0">
                      Maximizamos seu alcance com campanhas inteligentes
                    </p>
                  </div>
                </div>
                <ul class="list-unstyled mb-0">
              ...
              <div class="card-body p-3">
                <div class="d-flex align-items-start mb-4">
                  ...
                  <div>
                    ...
                    <p class="text-muted mb-0">
                      Colocamos sua música nas playlists certas
                    </p>
                  </div>
                </div>
                <ul class="list-unstyled mb-0">
              ...
              <div class="card-body p-3">
                <div class="d-flex align-items-start mb-4">
                  ...
                  <div>
                    ...
                    <p class="text-muted mb-0">
                      Desenvolvemos sua carreira musical
                    </p>
                  </div>
                </div>
                <ul class="list-unstyled mb-0">
    ...
    <section class="py-5" data-cue="fadeIn">
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-lg-8 text-center">
            <span
              class="badge bg-wasomupfy bg-opacity-10 text-wasomupfy rounded-pill px-3 py-2 mb-3 d-inline-block">Alcance
              Mundial</span>
            <h2 class="display-6 fw-bold mb-4">Presença Global</h2>
            <p class="lead text-muted">
              Sediados em Luanda, alcançamos o mundo através da tecnologia
            </p>
          </div>
        </div>
        ...
        <div class="row g-4">
          <div class="col-md-4" data-cue="zoomIn">
            <div class="global-card text-center p-4">
              ...
              <p class="text-muted mb-0">
                Desenvolvemos soluções digitais exclusivas que automatizam
                processos e garantem eficiência na distribuição global.
              </p>
            </div>
          </div>
          ...
          <div class="col-md-4" data-cue="zoomIn" data-delay="100">
            <div class="global-card text-center p-4">
              ...
              <p class="text-muted mb-0">
                Parcerias com plataformas, curadores e influenciadores em
                todos os continentes para maximizar o alcance.
              </p>
            </div>
          </div>
          ...
          <div class="col-md-4" data-cue="zoomIn" data-delay="200">
            <div class="global-card text-center p-4">
              ...
              <p class="text-muted mb-0">
                Modelos de negócio que valorizam o trabalho criativo e
                garantem retorno justo para os artistas.
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="container text-center">
        <div class="row justify-content-center mb-4">
          <div class="col-lg-6">
            ...
            <div class="divider-center bg-wasomupfy mb-2" style="width: 50px; height: 3px; margin: 0 auto"></div>
          </div>
        </div>
          ...
          <div class="col-md-5 col-lg-4" data-cue="zoomIn">
            <div class="team-card p-4 rounded-5 transition-all hover-lift border-0 shadow-sm bg-light-100">
              <div class="position-relative mb-4 d-inline-block">
                <img
                  src="https://media.licdn.com/dms/image/v2/D4D03AQH2TwTrIPX5sA/profile-displayphoto-scale_200_200/B4DZuvfPHZJQAY-/0/1768175763296?e=2147483647&v=beta&t=wXk2jDLxJ3ukV2cJXE3ge-e5bFvtoY1WusRqAHJneRM"
                  class="rounded-circle border border-4 border-wasomupfy" width="180" height="180"
                  style="object-fit: cover" alt="Cristiano Amadeu" />
                <div class="position-absolute bottom-0 end-0 bg-wasomupfy text-white rounded-circle p-2 shadow" style="
                      width: 45px;
                      height: 45px;
                      display: flex;
                      align-items: center;
              ...
              <p class="text-muted small mb-4 px-3">
                Visionário e estratega, liderando a Wasom Upfy na missão de
                digitalizar e globalizar a música africana.
              </p>
        ...
        <div class="row align-items-center g-5">
          <div class="col-lg-6" data-cue="slideInLeft">
            ...
            <p class="lead mb-4 opacity-90">
              Mais que uma empresa, somos uma
              <strong>plataforma de expressão artística</strong> que conecta
            ...
            <div class="brand-values">
              <div class="brand-value-item d-flex align-items-start mb-3">
                ...
                <div>
                  ...
                  <p class="small opacity-75 mb-0">
                    Movimento constante rumo à inovação
                  </p>
                </div>
              </div>
              <div class="brand-value-item d-flex align-items-start mb-3">
                ...
                <div>
                  ...
                  <p class="small opacity-75 mb-0">
                    Artistas no centro de cada decisão
                  </p>
                </div>
              </div>
              <div class="brand-value-item d-flex align-items-start">
                ...
                <div>
                  ...
                  <p class="small opacity-75 mb-0">
                    Vozes africanas em todos os continentes
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="brand-showcase">
              <div class="brand-card card rounded-4 p-4 shadow-lg mb-4">
                <div class="text-center">
                  <img src="assets/img/brand/wasomupfy_brand.png" alt="Logo Wasom Upfy" class="img-fluid mb-3"
                    width="200" loading="lazy" style="border-radius: 50%" />
                  <h5 class="mb-2">Wasom Upfy</h5>
                  <p class="small mb-3">Onde música encontra propósito</p>
                  <a href="https://www.youtube.com/@wasomupfy" target="_blank" rel="noopener noreferrer"
        ...
        <div class="row justify-content-center">
          <div class="col-lg-8 text-center">
            <h2 class="display-6 fw-bold mb-4">
              Pronto para levar sua música ao mundo?
            </h2>
            <p class="lead text-muted mb-5">
              Junte-se a centenas de artistas que já transformaram suas
        ...
        <div class="row g-5" id="ft-links">
          ...
          <div class="col-lg-3 col-6">
            ...
            <ul class="list-unstyled mb-0">
              ...
              <li class="mb-2">
                <a href="page/services/customized-services" class="text-reset text-decoration-none hover-white">Serviços
                  Premium</a>
              </li>
            </ul>
          </div>
            ...
            <ul class="list-unstyled mb-0">
              <li class="mb-2">
                <a href="https://www.facebook.com/m.me/2007900989425052" target="_blank"
                  rel="external noopener noreferrer" class="text-reset text-decoration-none hover-white">Atendimento
                </a>
              </li>
              <li class="mb-2">
        ...
        <div class="col-md-6 text-center text-md-end">
          <ul class="list-inline mb-0 small">
            <li class="list-inline-item">
              <a href="page/politicies/privacy" class="text-reset text-decoration-none">Política de Privacidade</a>
            </li>
