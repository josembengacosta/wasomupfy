...
$redirect_after = isset($_GET['from'])
    ...
    : '';
$login_url =  APP_URL . '/login' . ($redirect_after ? '?redirect=' . $redirect_after : '');
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Sessão Expirada — <?php echo APP_NAME; ?></title>
...
<body>
    ...
    <nav class="status-nav">
        <a class="nav-brand" href="<?php echo APP_URL ?>/login">
    ...
    <div class="page-wrap">
        ...
        <div class="fade-in action-group">
            <a href="<?php echo APP_URL ?>/register" class="btn-secondary-action">
                <i class="bi bi-person-plus"></i>Criar Conta
            </a>
            <a href="<?php echo APP_URL ?>" class="btn-secondary-action">
        ...
        <div class="fade-in quick-links">
            ...
            <a class="quick-link" href="<?php echo APP_URL ?>/forgot-password">
