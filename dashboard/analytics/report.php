...
<head>
  ...
  <title>Relatórios — Wasom Upfy</title>
      ...
      <div class="row align-items-center mb-4">
        <div class="col-md-8">
          <div class="page-header-compact">
            ...
            <p class="lead">
              Todos os relatórios mensais dos conteúdos distribuídos por esta conta estão
              disponíveis aqui. Faça o download para análise detalhada em seu dispositivo.
    ...
    <div class="table-card mb-4">
      <div class="card">
        ...
        <div class="table-responsive mt-4">
          <table id="reportsWasomupfy" class="table table-striped table-hover">
            <thead>
              <tr>
                <th>Mês</th>
                <th>Ano</th>
            ...
            <tbody>
              <tr>
                ...
                <td>kz50.000.00</td>
                <td>
                  <a href="" class="details-link text-dark fs-5"><i class="bi bi-download"></i></a>
                </td>
              </tr>
              <tr>
                <td>Janeiro</td>
  ...
  <script>
    ...
    $(document).ready(function() {
      $("#reportsWasomupfy").DataTable({
        ...
        info: true,
        lengthChange: false,
        pageLength: 10, // Limite de 3 linhas por página
        language: {
          search: "Pesquisa os relatórios por mês ou ano:",
