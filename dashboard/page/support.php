...
<head>
    ...
    <title>Wasom Upfy - Enviar pedido de suporte </title>
...
<body>
    ...
    <div class="container my-4">
        ...
        <div class="welcome-text col-auto d-sm-block support-header text-center">
            <h1>Enviar pedido de suporte</h1>
            <!-- Stats Description -->
            <p class="stats-description" style="font-size: medium;">
                Preencha o formulário abaixo para entrar em contato com nossa equipe de suporte. Antes, <a href="faq"
                    target="_blank" class="text-secondary">consulte o FAQ</a> para respostas rápidas!
            </p>
        </div>
        ...
        <form class="support-form " id="supportForm" onsubmit="submitSupportRequest(event)">
            <div class="form-group">
                <label for="name">Nome <span class="text-danger">*</span></label>
                <input type="text" id="name" placeholder="Insira o seu nome completo" name="name" autocomplete="name"
                    required>
            ...
            <div class="form-group">
                ...
                <input type="email" id="email" placeholder="Insira o seu e-mail válido" name="email"
                    autocomplete="email" required>
                <div class="error-message" id="emailError">Por favor, insira um e-mail válido.</div>
            </div>

            <div class="form-group">
                <label for="urgency">Urgência <span class="text-danger">*</span></label>
                ...
                <div class="error-message" id="urgencyError">Por favor, selecione a urgência.</div>
            </div>

            <div class="form-group">
                <label for="issueType">Tipo de Problema <span class="text-danger">*</span></label>
                ...
                <div class="error-message" id="issueTypeError">Por favor, selecione o tipo de problema.</div>
            </div>

            <div class="form-group">
                <label for="description">Descrição do Problema <span class="text-danger">*</span></label>
                <textarea id="description" name="description" placeholder="Insira a descrição do problema"
                    required></textarea>
                <div class="error-message" id="descriptionError">Por favor, descreva o problema.</div>
            </div>
            ...
            <div class="form-group" id="attachmentContainer">
                ...
                <button type="button" class="add-attachment-btn" onclick="addAttachmentField()">+ Adicionar
                    Arquivo</button>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Pedido de suporte enviado com sucesso! Você receberá uma resposta em breve.
                </div>
