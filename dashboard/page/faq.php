                ...
                ════════════════════════════════════════ -->
                    ...
                    <div class="faq-item visible" id="faq34" data-category="suporte">
                        <div class="question" onclick="toggleFAQ(this)" role="button" aria-expanded="false">
                            ...
                            <span data-i18n="faq34_question">A <?php echo APP_NAME ?> oferece reembolsos?</span>
                            <span class="faq-cat-tag" data-i18n="cat_suporte">Suporte</span>
                            <i class="bi bi-chevron-down toggle-icon"></i>
                        </div>
                        <div class="answer" id="faq34-answer" data-i18n="faq34_answer">
                            <strong>Não.</strong> Todos os pagamentos efectuados à <?php echo APP_NAME ?> são
                            <strong>definitivos e não reembolsáveis</strong>,
                            independentemente da circunstância, conforme a nossa Política de Não Reembolso.
                            A única excepção é uma cobrança duplicada por erro técnico comprovável da plataforma,
                            que poderá ser analisada para <strong>crédito de conta</strong> (não reembolso monetário).
                            Nesse caso, deves abrir um <a href="support">pedido de suporte</a> com os comprovativos
                            no prazo de <strong>72 horas</strong> após a ocorrência.
                            A análise não garante resultado favorável.
                        </div>
                    </div>
