<?php
// ══════════════════════════════════════════════
// WASOM UPFY v2.0 — Gestão de Conta
...
<head>
    ...
    <title>Gestão de Conta — Wasom Upfy</title>
...
<body>
            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav m-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link" href="../launch/releases"><i
                                class="bi bi-disc me-1"></i>Lançamentos</a></li>
                    <li class="nav-item"><a class="nav-link" href="../analytics/statistics"><i
                                class="bi bi-bar-chart me-1"></i>Estatísticas</a></li>
                    <li class="nav-item"><a class="nav-link" href="../finances/overview"><i
                                class="bi bi-currency-dollar me-1"></i>Finanças</a></li>
                    <li class="nav-item"><a class="nav-link" href="../artists/artists-list"><i
                                class="bi bi-people me-1"></i>Artistas</a></li>
                </ul>
            </div>
            <div class="user-menu d-flex align-items-center">
                <button class="theme-toggle btn btn-link text-white p-0 me-2" id="themeToggle"><i class="bi bi-sun"
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item fw-bold" href="../user/profile"><i
                                    class="bi bi-person me-2"></i><?php echo $first_name; ?></a>
                            <div class="px-3 pb-1 text-muted" style="font-size:.75rem">Conta #<?php echo $account_id; ?>
                            </div>
                        </li>
                        <li>
                        ...
                        <li><a class="dropdown-item" href="../user/profile"><i class="bi bi-person me-2"></i>Meu
                                Perfil</a></li>
                        <li><a class="dropdown-item active" href="manage-account"><i class="bi bi-tools me-2"></i>Gestão
                                de Conta</a></li>
                        <li>
                            <hr class="dropdown-divider" />
                        </li>
                        <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#logoutModal"><i
                                    class="bi bi-box-arrow-right me-2"></i>Desconectar</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasMenu">
        ...
        <div class="offcanvas-body">
            <ul class="nav flex-column">
                <li><a class="nav-link" href="../painel"><i class="bi bi-speedometer2 me-2"></i>Dashboard</a></li>
                <li><a class="nav-link" href="../launch/releases"><i class="bi bi-disc me-2"></i>Lançamentos</a></li>
                <li><a class="nav-link" href="../user/profile"><i class="bi bi-person me-2"></i>Meu Perfil</a></li>
                <li><a class="nav-link active" href="manage-account"><i class="bi bi-tools me-2"></i>Gestão de Conta</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="container py-4" style="max-width:1060px">
        ...
        <div class="d-flex align-items-start justify-content-between mb-4 flex-wrap gap-2">
            <div>
                <h1 class="h3 fw-bold mb-1"><i class="bi bi-tools me-2" style="color:var(--wasom)"></i>Gestão de Conta
                </h1>
                    ...
                    <div class="artist-profile-hero">
                        <div style="position:relative;z-index:1">
                            <?php if ($has_artist_profile): ?>
                                <div class="artist-tag"><i class="bi bi-patch-check-fill"></i>Perfil Artístico Configurado
                                </div>
                            <?php else: ?>
                            ...
                            <?php if (!$has_artist_profile): ?>
                                ...
                                <h3 style="color:#fff;margin:0;font-size:1.1rem;font-weight:800">Cria o teu perfil artístico
                                </h3>
                    ...
                    <div class="section-card">
                        ...
                        <?php if (!$has_artist_profile): ?>
                            <div class="alert alert-info small d-flex gap-2 mb-3" style="border-radius:10px">
                                ...
                                <div>
                                    O <strong>nome artístico ou de banda</strong> é o nome que vai aparecer nas plataformas
                        ...
                        <form id="artist-profile-form">
                            ...
                            <div class="d-flex gap-2 mt-4">
                                ...
                                <?php if ($has_artist_profile): ?>
                                    <a href="../artists/artists-list" class="btn btn-outline-secondary px-3"
                        ...
                        <?php if ($has_artist_profile): ?>
                            ...
                            <div class="mt-4 pt-3 border-top d-flex gap-2 align-items-start"
                                ...
                                <div>
                                    O perfil artístico <strong>não pode ser eliminado</strong> enquanto tiveres lançamentos
                                    associados.
                                    Para criar um novo perfil artístico separado, vai a
                                    <a href="../artists/add-artist" style="color:var(--wasom)">Artistas</a>.
                                </div>
                            </div>
                        <?php endif; ?>
                    </div>
                        ...
                        <?php else: ?>
                            ...
                            <div class="d-none d-lg-grid mb-2 px-3"
                                ...
                                <div style="font-size:.7rem;color:#999;text-transform:uppercase;letter-spacing:.5px">
                                    Colaborador</div>
                                <div style="font-size:.7rem;color:#999;text-transform:uppercase;letter-spacing:.5px">Estado
                                </div>
                                <div style="font-size:.7rem;color:#999;text-transform:uppercase;letter-spacing:.5px">Função
                                </div>
                                <div style="font-size:.7rem;color:#999;text-transform:uppercase;letter-spacing:.5px">Acções
                                </div>
                            </div>
    ...
    <nav class="bottom-nav d-lg-none">
        <ul class="nav justify-content-around">
            ...
            <li class="nav-item"><a class="nav-link active" href="manage-account"><i
                        class="bi bi-tools"></i><span>Conta</span></a></li>
        </ul>
    </nav>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <div class="mt-2 d-flex align-items-center gap-2">
                                ...
                                <small class="text-muted" style="font-size:.72rem">Cola o URL de qualquer foto de perfil
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-text" id="role-desc-text">Pode criar e editar lançamentos e artistas.</div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="form-text">Clica <i class="bi bi-arrow-repeat"></i> para gerar uma senha forte.
