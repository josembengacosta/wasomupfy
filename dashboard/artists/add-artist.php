<?php
// ══════════════════════════════════════════════
// WASOM UPFY v2.0.1.1 — Gestão de Artistas
            ...
            <div class="row align-items-center" style="position:relative;z-index:1">
                <div class="col-md-8">
                    <nav aria-label="breadcrumb" style="margin-bottom:8px">
                        <ol class="breadcrumb mb-0" style="font-size:.90rem;opacity:.6">
                            ...
                            <li class="breadcrumb-item"><a href="artists-list"
                                    class="text-white text-decoration-none">Artistas</a></li>
                            <li class="breadcrumb-item active text-white">
                                <?php echo $edit_artist ? 'Editar Artista' : 'Gestão de Artistas'; ?></li>
                        </ol>
                    </nav>
                    <h1 class="fw-bold mb-1" style="font-size:1.6rem">
                        <i class="bi bi-person-plus-fill me-2"
                            style="color:#FF0089"></i><?php echo $edit_artist ? 'Editar Artista' : 'Gestão de Artistas'; ?>
                    </h1>
                ...
                <div class="col-md-4 text-md-end mt-3 mt-md-0">
                    <button class="btn fw-bold" style="background:#FF0089;color:#fff;border:none;border-radius:20px;"
                        onclick="window.location='artists-list'">
                        <i class="bi-person-plus-fill me-1"></i>Lista de Artistas
                    </button>
                    <?php if (!$edit_artist && $can_add): ?>
                    <button class="btn fw-bold"
                        style="background:rgba(255,255,255,.12);color:#fff;border:none;border-radius:20px;"
                        data-bs-toggle="modal" data-bs-target="#createArtistModal">
