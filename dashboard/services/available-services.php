...
<head>
  ...
  <title>Contas e Serviçoes — Wasom Upfy</title>
...
" rel="stylesheet" />
  ...
  <link rel="stylesheet" href="../../css/available-services.css" />
...
<body>
  ...
  <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasMenu" aria-labelledby="offcanvasMenuLabel">
    ...
    <div class="offcanvas-body">
      <ul class="nav flex-column">
        ...
        <li class="nav-item d-lg-none">
          <a class="nav-link" href="available-services"><i class="bi bi-star"></i> Conta e serviços disponíveis</a>
        </li>
        <li class="nav-item d-lg-none">
  ...
  <div class="container my-4">
    ...
    <!-- Stats Description -->
    <h4 class="stats-description-title">Serviços disponível</h4>

    <!-- Launch Card para visualizar info de artist  -->
        ...
        <div class="align-items-lg-center">
          <div class="text-center">
            <div class="welcome-text d-flex justify-content-between align-items-center">
              ...
              <a href="#other_link1" data-bs-toggle="collapse" id="link1" data-bs-target="#collapseOneAccount"
                onclick="other_link()" aria-expanded="false" aria-controls="collapseOneAccount" class="text-secondary">
                Mostrar</a>

              <a href="#other_link2" data-bs-toggle="collapse" id="link2" data-bs-target="#collapseOneAccount"
                onclick="other_link1()" aria-expanded="false" aria-controls="collapseOneAccount" class="text-secondary">
                Ocultar</a>
            </div>
            <hr />
            <div id="collapseOneAccount" class="accordion-collapse collapse w-100" data-bs-parent="#accordionExample">
              <div class="service-card position-relative">
                <span class="badge bg-success position-absolute top-0 end-0 m-3">Plano Ativo</span>
                <p class="mt-5">
                  Com o <strong>Manager</strong>, você tem acesso a mais
                  benefícios que o plano Single, como:
                </p>
                <ul class="list-unstyled ml-auto">
                  <li>
                    <i class="bi bi-person-fill me-2"></i> Até 10 artistas por
                    conta;
                  </li>
                  <li>
                    <i class="bi bi-disc-fill me-2"></i> Lançamento
                    ilimitados;
                  </li>
                  <li>
                    <i class="bi bi-currency-dollar me-2"></i> 90% de
                    royalties;
                  </li>
                  <li>
                    <i class="bi bi-bar-chart me-2"></i> Acesso a dados
                    detalhados;
                  </li>
                  <li>
                    <i class="bi bi-people me-2"></i> Adição de até 10
                    colaboradores e muito mais;
                  </li>
                </ul>
                <p><strong>Data de subscrição:</strong> 10/06/2025</p>
                <p><strong>Data de renovação:</strong> 10/06/2025</p>
                <a href="#" class="btn" data-bs-toggle="modal" data-bs-target="#upgradeModal">Deseja fazer uma alteração
                  ao plano?</a>
              </div>
            </div>
          </div>
    ...
    <p class="stats-description">
      Caso deseja fazer a alteração do plano disponível em sua conta, basta
      entrar em contacto com a nossa equipe de
      <a href="../page/support" id="link1" target="_blank" title="Suporte Wasom Upfy" class="text-secondary">suporte</a>
      para mais informações de como proceguir com a alteração do plano
      disponivel em sua conta.
    </p>
  </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>
            Tem certeza de que deseja alterar seu plano? Entre em contacto com
            o suporte para prosseguir.
          </p>
        </div>
        <div class="modal-footer">
          ...
          <a href="../page/support?=" class="btn btn-primary">Contactar Suporte</a>
        </div>
      </div>
    </div>
  </div>
