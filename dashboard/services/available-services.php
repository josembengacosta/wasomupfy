...
<body>
    ...
    ============================================ */ ?>
        ...
        <?php if ($active_plan): ?>
            ...
            <div class="current-plan-card mb-4">
                ...
                <div class="row g-2 mb-3">
                    ...
                    <div class="col-6 col-md-3">
                        <div class="current-plan-stat">
                            <div class="stat-val"><?php echo $active_plan['max_artists'] ?: 'Ilimitado'; ?></div>
                    ...
                    <div class="col-6 col-md-3">
                        <div class="current-plan-stat">
                            <div class="stat-val" style="font-size:1rem">
                                <?php echo $is_sub ? $expires_fmt : ($releases_limit ? "$releases_used / $releases_limit" : 'Ilimitado'); ?>
                            </div>
                ...
                <?php if ($releases_limit !== null): ?>
                    <?php if ($releases_used >= $releases_limit): ?>
                        <div class="alert alert-danger mt-3 py-2 small mb-0">
                            <i class="bi bi-exclamation-triangle-fill me-1"></i>
                            <strong>Limite atingido!</strong> Já usaste todos os lançamentos do teu plano.
                            <a href="<?php echo APP_URL . '/' . APP_URL_PANEL ?>/all-plans" class="alert-link fw-bold d-block mt-1">
                                <i class="bi bi-arrow-up-circle me-1"></i>Faz upgrade agora →
                            </a>
                        </div>
                    <?php elseif (($releases_limit - $releases_used) <= 2): ?>
                        <div class="alert alert-warning mt-3 py-2 small mb-0">
                            <i class="bi bi-hourglass-split me-1"></i>
                            Restam apenas <strong><?php echo $releases_limit - $releases_used; ?></strong> lançamento(s).
                            <a href="<?php echo APP_URL . '/' . APP_URL_PANEL ?>/all-plans" class="alert-link fw-bold d-block mt-1">
                                <i class="bi bi-arrow-up-circle me-1"></i>Considera fazer upgrade →
                            </a>
                        </div>
                    <?php endif; ?>
                <?php endif; ?>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div
                            ...
                            <div class="p-3 pt-2">
                                ...
                                <?php else: ?>
                                    <a href="<?php echo APP_URL . '/' . APP_URL_PANEL ?>/payment/pay?plan=<?php echo urlencode($plan['slug_plan']); ?>"
                                        class="btn w-100 btn-sm"
                                        style="background:linear-gradient(135deg,#FF0089,#c8006e);color:#fff;border:none;border-radius:9px;font-weight:600">
                                        <i class="bi bi-arrow-up-circle me-1"></i>Escolher
        ...
        <div class="contact-info-bar mb-4">
            <i class="bi bi-arrow-repeat fs-4" style="color:#FF0089;flex-shrink:0"></i>
            <div style="flex:1">
                <div class="fw-semibold" style="font-size:.9rem">Queres mudar de plano?</div>
                <div class="text-muted" style="font-size:.8rem">
                    Podes fazer upgrade diretamente escolhendo um novo plano abaixo. O teu plano atual será substituído
                    e os teus dados permanecem intactos.
                </div>
            </div>
            <a href="#all-plans" class="btn btn-sm flex-shrink-0"
                ...
                <i class="bi bi-chevron-down me-1"></i>Ver planos
            </a>
        </div>
        ...
        <script>
            ...
            (function() {
                function refreshNotifBadge() {
                    fetch('https://wasomupfy.rf.gd/dashboard/ajax/notifications_api.php?action=count', {
