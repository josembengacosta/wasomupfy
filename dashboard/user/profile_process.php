...
case 'update_profile':
    ...
    $db->prepare("
        ...
        WHERE id_users = ?
    ")->execute([
        $first_name, $second_name ?: null, $user_name_new,
        $tel_user ?: null, $country_user ?: null, $city_user ?: null,
        $about_user ?: null, $url_user ?: null,
        $name_artist_band ?: null, $photo_path,
        $id_users
    ]);
...
case 'toggle_2fa':
    ...
    if ($enable) {
        ...
        $label    = rawurlencode(APP_NAME) . ':' . rawurlencode($user['email_user']);
...
case 'deactivate_account':
    ...
    jsonOut(true, 'Conta desactivada. Tens 29 dias para recuperar.', ['redirect' => APP_URL . '../login']);
...
case 'delete_account':
    ...
    jsonOut(true, 'Conta eliminada.', ['redirect' => APP_URL]);
