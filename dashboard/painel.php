<?php
// WASOM UPFY v2.0.1.1 - Painel Principal
            ...
            <div class="row align-items-center" style="position:relative;z-index:1">
                <div class="col-md-8">
                    ...
                    <h1 class="fw-bold mb-1" style="font-size:1.9rem">
                        <i class="bi bi-house-door-fill me-2" style="color:#FF0089"></i>Olá, seja
                        bem-vindo(a) de volta <span class="text-warning"
                            style="font-weight: 400; box-sizing: border-box; font-family: 'Homemade', cursive; font-style: normal;"><?php echo $first_name; ?>!</span>
                    </h1>
