        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="text-center py-4">
                    ...
                    <a href="finances/create-account" class="btn btn-pink btn-sm">
                ...
                <div class="card mb-3 p-3 d-flex flex-row align-items-center gap-3">
                    ...
                    <?php endif; ?>
                    <a href="finances/create-account" class="btn btn-sm btn-outline-secondary ms-auto">
...
function confirmWithdrawal() {
    ...
    `,
        ...
        preConfirm: () => {
            ...
            return fetch('withdrawal_process.php', {
                    method: 'POST',
                    body: fd
                })
                .then(r => r.json())
