<?php
// ══════════════════════════════════════════════════════
// WASOM UPFY v2.0.1.1 — Divisão de Royalties
                ...
                <div class="col-md-4 text-md-end mt-3 mt-md-0">
                    <?php if (!empty($artists)): ?>
                        <button class="btn fw-bold"
                            style="background:#FF0089;color:#fff;border:none;border-radius:20px;" data-bs-toggle="modal"
                            data-bs-target="#modalNewSplit">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content" style="border-radius:20px;border:none">
                ...
                <div class="modal-body" style="padding:24px 28px">
                    <form method="POST" action="finances/split_process" id="formNewSplit" novalidate>
        ...
        <div class="modal-dialog modal-dialog-centered" style="max-width:380px">
            <div class="modal-content" style="border-radius:18px;border:none">
                ...
                <div class="modal-footer border-0" style="padding:0 24px 22px;gap:10px">
                    ...
                    <form method="POST" action="finances/split_process" style="flex:1">
                        <input type="hidden" name="csrf_token"
                            value="<?php echo htmlspecialchars($_SESSION['csrf_token'] ?? ''); ?>" />
