...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $siteUrl; ?>/css/register.css" />
...
<body data-theme="default" data-layout="fluid">
    ...
    <main class="content">
        <div class="container-fluid p-0">
            ...
            <section>
                <div class="row justify-content-center">
                    <div class="col-xl-5 col-lg-8 col-md-10 col-11 m-auto">
                            ...
                            <div class="card-body p-4">
                                ...
                                <form method="POST" action="register_process" class="needs-validation"
                                    ...
                                    <div class="form-step" id="step-2">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mb-3">
                                                <label for="country" class="form-label">País <span
                                                        class="text-danger">*</span></label>
                                                <select class="form-select" id="country" name="country_user" required>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mb-3">
                                                <label for="phone" class="form-label">Telefone
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-12 d-flex justify-content-between">
                                                ...
                                                <button type="button" class="btn btn-wasomupfy" onclick="nextStep(3)">
                                    ...
                                    <div class="form-step" id="step-3">
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <div class="password-wrapper">
                                                    <input type="password" class="form-control" id="password"
                                                        name="password_user" required minlength="10"
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <div class="password-wrapper">
                                                    <input type="password" class="form-control" id="confirm_password"
                                                        name="confirm_password" required minlength="10"
                                        ...
                                        <div class="password-requirements">
                                            ...
                                            <ul class="requirements-list">
                                                <li id="req-length">
                                                    <i class="bi bi-x-circle req-icon" id="icon-length"></i>
                                                    <span>Mínimo 10 caracteres</span>
                                                </li>
                                                <li id="req-letter">
                                                    <i class="bi bi-x-circle req-icon" id="icon-letter"></i>
                                                    <span>1 letra maiúscula e 1 minúscula</span>
                                                </li>
                                                <li id="req-number">
                                                    <i class="bi bi-x-circle req-icon" id="icon-number"></i>
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-12 d-flex justify-content-between">
                                                ...
                                                <button type="button" class="btn btn-wasomupfy" onclick="nextStep(4)">
                                                    Continuar <i class="bi bi-arrow-right ms-2"></i>
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-step" id="step-4">
                                        ...
                                        <div class="review-data">
                                            ...
                                            <div class="review-item">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="review-value" id="review-fullname"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="review-item">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="review-value" id="review-birthdate"></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-12 d-flex justify-content-between">
                                                ...
                                                <button type="submit" class="btn btn-wasomupfy" id="submit-btn">
