...
<head>
    ...
    <link rel="shortcut icon" href="http://localhost/wasomupfy/assets/img/icones/wasomupfy_fiv.png"
        type="image/x-icon" />
    <link rel="apple-touch-icon" href="http://localhost/wasomupfy/assets/img/icones/wasomupfy_fiv_512.png" />
...
<body>
    ...
    <div class="page-wrap">
        ...
        <!-- Logo -->
        <a class="brand-logo" href="http://localhost/wasomupfy/home">
            <img src="http://localhost/wasomupfy/assets/img/brand/wasomupfy_brand.png"
        ...
        <div class="main-card">
            ...
            <div class="action-row">
                <a href="http://localhost/wasomupfy/home" class="btn-home">
        ...
        <div class="page-footer">
            ...
            <p>
                <a href="http://localhost/wasomupfy/page/politicies/terms">Termos de Uso</a>
                &nbsp;·&nbsp;
                <a href="http://localhost/wasomupfy/page/politicies/privacy">Política de Privacidade</a>
                &nbsp;·&nbsp;
                <a
    ...
    var searchMap = [{
            ...
            url: 'http://localhost/wasomupfy/page/services/music-distribution',
        ...
        },
        {
            ...
            url: 'http://localhost/wasomupfy/plan/all-plans',
            label: 'Planos'
        },
        {
    ...
    function doSearch() {
        ...
        if (best) {
            ...
            window.location.href = 'http://localhost/wasomupfy/home#' + encodeURIComponent(query);
        }
    }
