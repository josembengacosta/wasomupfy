...
<head>
    ...
    <meta name="keywords" content="Wasom Upfy, Wasom, Upfy, Plano Single, Basic Plan, Basic" />
    ...
    <meta property="og:title" content="Wasom Upfy - Plano Single." />
    ...
    <title> Wasom Upfy | Plano Single</title>
                        ...
                        <ul class="navbar-nav mx-auto align-items-lg-center">
                            ...
                            <li class="nav-item dropdown active">
                                ...
                                <div class="dropdown-menu dropdown-menu-md" aria-labelledby="navbarDropdown">
                                    ...
                                    <a title="Single" class="dropdown-item mb-3 text-body active" href="single">
                ...
                <div class="row justify-content-center text-center">
                    <div class="col-xl-8 col-lg-10 text-center" data-cue="fadeIn">
                        ...
                        <p class="lead text-white-stable mb-4 opacity-90">Distribua seu próximo hit em todas as
                            plataformas por apenas 2.000Kz</p>
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    ...
                                    <div class="text-end">
                                        <div class="price-display">
                                            <span class="price-amount display-3 fw-bold">2.000</span>
                                            <span class="price-period h4 text-muted fw-normal">Kz</span>
                                        </div>
                                ...
                                <div class="process-steps">
                                    ...
                                    <div class="process-step d-flex">
                                        ...
                                        <div>
                                            ...
                                            <p class="small text-muted mb-0">Sua música vai ao ar em 72h</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card border-0 h-100 shadow-sm hover-lift">
                            <div class="card-body p-4">
                                ...
                                <ul class="list-unstyled mb-4">
                                    ...
                                    <li class="d-flex align-items-start">
                                        <i class="bi bi-check-lg text-success mt-1 me-2"></i>
                                        <span>Todos os recursos do Single</span>
                                    </li>
                                </ul>
                        ...
                        <div class="card border-wasom border-3 h-100 shadow-lg hover-lift position-relative">
                            ...
                            <div class="card-body p-4">
                                ...
                                <ul class="list-unstyled mb-4">
                                    ...
                                    <li class="d-flex align-items-start">
                                        <i class="bi bi-check-lg text-success mt-1 me-2"></i>
                                        <span>Economia de 75% vs Single</span>
                                    </li>
                                </ul>
