...
<head>
    ...
    <meta name="keywords" content="Wasom Upfy, Wasom, Upfy, Plano, Plan Album, Album, Plano Album" />
    ...
    <meta property="og:title" content="Wasom Upfy - Nossos planos." />
...
<body>
                        ...
                        <ul class="navbar-nav mx-auto align-items-lg-center">
                            ...
                            <li class="nav-item dropdown active">
                                ...
                                <div class="dropdown-menu dropdown-menu-md" aria-labelledby="navbarDropdown">
                                    ...
                                    <a title="Álbum" class="dropdown-item mb-3 text-body active" href="album">
                                        <div class="d-flex align-items-center">
                                    ...
                                    <a title="Label" class="dropdown-item mb-3 text-body" href="label">
                                        <div class="d-flex align-items-center">
    ...
    <main>
        ...
        <section class="all-plans-hero jarallax position-relative overflow-hidden py-5" data-jarallax data-speed="0.4">
            <img class="jarallax-img" src="../assets/img/theme/plan_album.png" alt="Plano Álbum Wasom Upfy"
                loading="lazy">
                    ...
                    <div class="col-xl-8 col-lg-10 text-center" data-cue="fadeIn">
                        <nav aria-label="breadcrumb" class="d-flex justify-content-center mb-3">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Plano Álbum</li>
                            </ol>
                        </nav>
                        <!-- <span class="badge bg-wasomupfy text-white-stable fw-semibold px-4 py-2 mb-3">Para Projetos
                            Completos</span> -->
                        <h1 class="display-4 mb-4 text-white-stable fw-bold">Plano Álbum</h1>
                        <p class="lead text-white-stable mb-4 opacity-90">Distribua seu projeto completo com até 15
                            faixas por
                            apenas 5.000Kz/álbum</p>
                        <div class="d-flex flex-wrap justify-content-center gap-2 mb-4">
                            <span class="badge bg-secondary text-black fw-semibold px-3 py-2">
                                <i class="bi bi-music-note-list text-success me-1"></i> 15 Faixas
                            </span>
                            <span class="badge bg-secondary text-black fw-semibold px-3 py-2">
                                <i class="bi bi-percent text-success me-1"></i> 90% Royalties
                            </span>
                            <span class="badge bg-secondary text-black fw-semibold px-3 py-2">
                                <i class="bi bi-tag text-success me-1"></i> Selo Personalizado
                            </span>
                        </div>
            ...
            <div class="container">
                <div class="row g-3 text-center">
                    <div class="col-md-3 col-6">
                        <div class="stat-item">
                            <h3 class="h2 fw-bold mb-1">15</h3>
                            <p class="small mb-0 opacity-85">Faixas por Álbum</p>
                        </div>
                    </div>
                    <div class="col-md-3 col-6">
                        <div class="stat-item">
                    ...
                    <div class="col-md-3 col-6">
                        <div class="stat-item">
                            <h3 class="h2 fw-bold mb-1">72h</h3>
                            <p class="small mb-0 opacity-85">Lançamento</p>
                        </div>
                    </div>
                    <div class="col-md-3 col-6">
                        <div class="stat-item">
                            <h3 class="h2 fw-bold mb-1">Selo</h3>
                            <p class="small mb-0 opacity-85">Personalizado</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row justify-content-center mb-6">
                    <div class="col-lg-10 text-center">
                        <h2 class="display-5 fw-bold mb-3">Perfeito para EPs, Álbuns e Projetos Completos</h2>
                        <p class="lead text-muted">Distribua até 15 faixas em um único álbum com todos os recursos
                            profissionais</p>
                    </div>
                </div>
                        ...
                        <div class="pricing-card-main card border-0 shadow-lg hover-lift">
                            <div class="card-header border-0 pt-5 pb-4 px-5">
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    <div>
                                        <h3 class="h2 fw-bold mb-2">Plano Álbum</h3>
                                        <p class="text-muted mb-0">Por álbum completo</p>
                                    </div>
                                    <div class="text-end">
                                        <div class="price-display">
                                            <span class="price-amount display-3 fw-bold">5.000</span>
                                            <span class="price-period h4 text-muted fw-normal">Kz/álbum</span>
                                        </div>
                                        <div class="badge bg-success mt-2">Economize 70% vs Single</div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-5">
                                    <div class="d-flex justify-content-between mb-2">
                                        ...
                                        <span class="fw-bold text-success">90% Artista | 10% Wasom Upfy</span>
                                    </div>
                                    <div class="progress" style="height: 12px; border-radius: 6px;">
                                        <div class="progress-bar bg-wasom-gradient" role="progressbar"
                                            style="width: 90%" aria-label="Royalties do artista" aria-valuenow="90"
                                ...
                                <!-- Album Preview -->
                                <div class="album-preview bg-light-100 rounded-4 p-4 mb-4">
                                    <div class="d-flex align-items-center">
                                        <div class="album-cover me-4">
                                            <div class="album-placeholder bg-dark rounded-3 d-flex align-items-center justify-content-center"
                                                style="width: 80px; height: 80px;">
                                                <i class="bi bi-vinyl text-white fs-4"></i>
                                            </div>
                                        </div>
                                        <div class="album-info">
                                            <h5 class="mb-1">Seu Álbum Completo</h5>
                                            <p class="text-muted mb-2 small">Até 15 faixas • 1 Álbum • Selo
                                                Personalizado</p>
                                            <div class="d-flex gap-2">
                                                <span class="badge bg-dark">Faixa 1</span>
                                                <span class="badge bg-dark">Faixa 2</span>
                                                <span class="badge bg-dark">Faixa 3</span>
                                                <span class="badge bg-dark text-white">+12</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body pt-4 pb-5 px-5">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h4 class="h5 mb-3 text-dark"><i
                                                class="bi bi-check-circle-fill text-success me-2"></i> Recursos
                                            Principais:</h4>
                                        <ul class="list-unstyled mb-4">
                                            <li class="d-flex align-items-start mb-3">
                                                <i class="bi bi-check-lg text-success mt-1 me-3"></i>
                                                <span><strong>15 faixas</strong> por álbum</span>
                                            </li>
                                            <li class="d-flex align-items-start mb-3">
                                                <i class="bi bi-check-lg text-success mt-1 me-3"></i>
                                            ...
                                            <li class="d-flex align-items-start mb-3">
                                                <i class="bi bi-check-lg text-success mt-1 me-3"></i>
                                                <span><strong>ISRC e UPC grátis</strong> para todas as faixas</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-md-6">
                                        <h4 class="h5 mb-3 text-dark"><i class="bi bi-star-fill text-warning me-2"></i>
                                            Vantagens Exclusivas:</h4>
                                        <ul class="list-unstyled mb-4">
                                            <li class="d-flex align-items-start mb-3">
                                                <i class="bi bi-check-lg text-success mt-1 me-3"></i>
                                                <span><strong>Selo personalizado</strong> (label name)</span>
                                            </li>
                                            <li class="d-flex align-items-start mb-3">
                                                <i class="bi bi-check-lg text-success mt-1 me-3"></i>
                                                <span><strong>Smartlink e pre-salve</strong> do álbum</span>
                                            </li>
                                            <li class="d-flex align-items-start mb-3">
                                                <i class="bi bi-check-lg text-success mt-1 me-3"></i>
                                                <span><strong>Lançamento em 72h</strong></span>
                                            </li>
                                            <li class="d-flex align-items-start mb-3">
                                                <i class="bi bi-check-lg text-success mt-1 me-3"></i>
                                                <span><strong>Suporte premium</strong> (WhatsApp + E-mail)</span>
                                            </li>
                                            <li class="d-flex align-items-start mb-3">
                                                <i class="bi bi-check-lg text-success mt-1 me-3"></i>
                                ...
                                <!-- Comparação de Valor -->
                                <div class="value-comparison bg-wasom-light rounded-4 p-4 mt-4">
                                    <h5 class="mb-3"><i class="bi bi-calculator text-wasom me-2"></i> Economia
                                        Inteligente:</h5>
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            <div class="comparison-item text-center p-3 rounded-3">
                                                <h6 class="mb-2">Plano Single</h6>
                                                <div class="h4 fw-bold mb-1">17.250 Kz</div>
                                                <p class="small text-muted mb-0">Para 15 singles</p>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div
                                                class="comparison-item text-center p-3 rounded-3 border-wasom border-2">
                                                <h6 class="mb-2 text-muted">Plano Álbum</h6>
                                                <div class="h4 fw-bold mb-1 text-wasomupfy">5.000 Kz</div>
                                                <p class="small text-muted mb-0">Para 15 faixas</p>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="comparison-item text-center p-3 rounded-3">
                                                <div class="h4 fw-bold mb-1 text-success">73%</div>
                                                <p class="small mb-0">Economia</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cta-box bg-wasom-light rounded-4 p-4 mt-5">
                                    <div class="row align-items-center">
                                        <div class="col-md-8">
                                            <h4 class="h5 mb-2">Pronto para lançar seu álbum?</h4>
                                            <p class="mb-0 text-muted">Economize 73% distribuindo seu projeto completo
                                            </p>
                                        </div>
                                        <div class="col-md-4 text-md-end">
                                            <a href="/wasomupfy/register?plan=album"
                    ...
                    <div class="col-lg-4" data-cue="slideInRight">
                        ...
                        <div class="card border-0 shadow-sm mb-4 hover-lift">
                            <div class="card-body p-4">
                                <h4 class="h5 mb-3"><i class="bi bi-people-fill text-wasom me-2"></i> Ideal para:</h4>
                                <ul class="list-unstyled mb-0">
                                    <li class="d-flex align-items-start mb-2">
                                        <i class="bi bi-check-circle text-success mt-1 me-2"></i>
                                        <div>
                                            <span class="fw-medium">Artistas com EPs/Álbuns</span>
                                            <p class="small text-muted mb-0">Projetos completos de até 15 faixas</p>
                                        </div>
                                    </li>
                                    <li class="d-flex align-items-start mb-2">
                                        <i class="bi bi-check-circle text-success mt-1 me-2"></i>
                                        <div>
                                            <span class="fw-medium">Coletâneas</span>
                                            <p class="small text-muted mb-0">Compilações de várias músicas</p>
                                        </div>
                                    </li>
                                    <li class="d-flex align-items-start mb-2">
                                        <i class="bi bi-check-circle text-success mt-1 me-2"></i>
                                        <div>
                                            <span class="fw-medium">Artistas em crescimento</span>
                                            <p class="small text-muted mb-0">Que lançam projetos regularmente</p>
                                        </div>
                                    </li>
                                    <li class="d-flex align-items-start">
                                        <i class="bi bi-check-circle text-success mt-1 me-2"></i>
                                        <div>
                                            <span class="fw-medium">Produtores</span>
                                            <p class="small text-muted mb-0">Com álbuns de produção</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="card border-0 shadow-sm mb-4 hover-lift">
                            <div class="card-body p-4">
                                <h4 class="h5 mb-3"><i class="bi bi-collection-play text-wasom me-2"></i> Recursos de
                                    Álbum:</h4>
                                <ul class="list-unstyled mb-0">
                                    <li class="d-flex align-items-start mb-2">
                                        <i class="bi bi-music-note-beamed text-primary mt-1 me-2"></i>
                                        <div>
                                            <span class="fw-medium">Ordem das faixas</span>
                                            <p class="small text-muted mb-0">Defina a sequência das músicas</p>
                                        </div>
                                    </li>
                                    <li class="d-flex align-items-start mb-2">
                                        <i class="bi bi-image text-primary mt-1 me-2"></i>
                                        <div>
                                            <span class="fw-medium">Arte do álbum</span>
                                            <p class="small text-muted mb-0">Capa principal + imagens extras</p>
                                        </div>
                                    </li>
                                    <li class="d-flex align-items-start mb-2">
                                        <i class="bi bi-file-text text-primary mt-1 me-2"></i>
                                        <div>
                                            <span class="fw-medium">Créditos completos</span>
                                            <p class="small text-muted mb-0">Para todas as faixas</p>
                                        </div>
                                    </li>
                                    <li class="d-flex align-items-start">
                                        <i class="bi bi-tags text-primary mt-1 me-2"></i>
                                        <div>
                                            <span class="fw-medium">Gêneros múltiplos</span>
                                            <p class="small text-muted mb-0">Até 3 gêneros por álbum</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="card border-0 shadow-sm hover-lift">
                            <div class="card-body p-4">
                                <h4 class="h5 mb-3"><i class="bi bi-award text-wasom me-2"></i> Selo Personalizado:</h4>
                                <div class="label-preview rounded-3 p-3 text-center mb-3">
                                    <i class="bi bi-vinyl fs-1 mb-2"></i>
                                    <h6 class="mb-1">SEU SELO AQUI</h6>
                                    <p class="small opacity-75 mb-0">Nome personalizado nas plataformas</p>
                                </div>
                                <p class="small text-muted mb-0">
                                    Seu nome de selo aparecerá como "Label" em todas as plataformas de streaming, dando
                                    mais profissionalismo ao seu lançamento.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row justify-content-center mb-6">
                    <div class="col-lg-8 text-center">
                        ...
                        <h2 class="display-5 fw-bold mb-4">Perguntas sobre o Plano Álbum</h2>
                        <p class="text-muted lead">Tire suas dúvidas sobre lançamentos de álbuns</p>
                    </div>
                </div>

                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <div class="accordion" id="albumFaqAccordion">
                            <div class="accordion-item border-0 mb-3 shadow-sm">
                                <h3 class="accordion-header">
                                    <button class="accordion-button bg-wasomupfy rounded-3" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#faq1">
                                        Quantas faixas posso incluir no álbum?
                                    </button>
                                </h3>
                                <div id="faq1" class="accordion-collapse collapse show"
                                    data-bs-parent="#albumFaqAccordion">
                                    <div class="accordion-body">
                                        O Plano Álbum permite até 15 faixas por álbum. Isso inclui músicas principais,
                                        interlúdios, skits e faixas bônus. Cada faixa recebe seu próprio ISRC gratuito e
                                        aparece separadamente nas plataformas.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item border-0 mb-3 shadow-sm">
                                <h3 class="accordion-header">
                                    <button class="accordion-button bg-wasomupfy rounded-3 collapsed" type="button"
                                        ...
                                        Como funciona o selo personalizado?
                                    </button>
                                </h3>
                                <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#albumFaqAccordion">
                                    <div class="accordion-body">
                                        Você pode escolher um nome para seu selo (ex: "Minha Gravadora Records"). Este
                                        nome aparecerá como "Label" em todas as plataformas de streaming (Spotify, Apple
                                        Music, etc.), dando mais credibilidade ao seu lançamento. Pode ser alterado a
                                        cada novo álbum.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item border-0 mb-3 shadow-sm">
                                <h3 class="accordion-header">
                                    <button class="accordion-button bg-wasomupfy rounded-3 collapsed" type="button"
                                        ...
                                        Posso lançar singles depois de um álbum?
                                    </button>
                                </h3>
                                <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#albumFaqAccordion">
                                    <div class="accordion-body">
                                        Sim! O Plano Álbum não impede lançamentos futuros. Você pode lançar um álbum
                                        agora e depois singles separadamente usando o Plano Single, ou fazer upgrade
                                        para o Plano Artista para lançamentos ilimitados.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item border-0 mb-3 shadow-sm">
                                <h3 class="accordion-header">
                                    <button class="accordion-button bg-wasomupfy rounded-3 collapsed" type="button"
                                        ...
                                        E se meu álbum tiver menos de 15 faixas?
                                    </button>
                                </h3>
                                <div id="faq4" class="accordion-collapse collapse" data-bs-parent="#albumFaqAccordion">
                                    <div class="accordion-body">
                                        O valor é fixo para álbuns de 1 a 15 faixas. Mesmo que seu álbum tenha apenas 5
                                        faixas, você paga o mesmo valor e aproveita todos os benefícios do plano. É
                                        ideal para EPs, mixtapes e projetos menores também.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item border-0 shadow-sm">
                                <h3 class="accordion-header">
                                    <button class="accordion-button bg-wasomupfy rounded-3 collapsed" type="button"
                                        ...
                                        Posso atualizar para o Plano Artista depois?
                                    </button>
                                </h3>
                                <div id="faq5" class="accordion-collapse collapse" data-bs-parent="#albumFaqAccordion">
                                    <div class="accordion-body">
                                        Com certeza! Se você começar com o Plano Álbum e depois quiser mais
                                        flexibilidade, pode fazer upgrade para o Plano Artista a qualquer momento. O
                                        valor pago no álbum será considerado no cálculo proporcional.
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row justify-content-center mb-6">
                    <div class="col-lg-8 text-center">
                        <span class="badge bg-wasomupfy text-white fw-semibold px-3 py-2 mb-3">Compare
                            Planos</span>
                        <h2 class="display-5 fw-bold mb-4">Encontre o Plano Perfeito</h2>
                        <p class="text-muted lead">Veja nossas outras opções para diferentes necessidades</p>
                    </div>
                </div>
                        ...
                        <div class="card border-0 h-100 shadow-sm hover-lift">
                            <div class="card-body p-4">
                                ...
                                <ul class="list-unstyled mb-4">
                                    ...
                                    <li class="d-flex align-items-start">
                                        <i class="bi bi-check-lg text-success mt-1 me-2"></i>
                                        <span>Perfeito para testes</span>
                                    </li>
                                </ul>
                    ...
                    <div class="col-md-4" data-cue="zoomIn" data-delay="100">
                        <div class="card border-wasom border-3 h-100 shadow-lg hover-lift position-relative">
                            <div class="position-absolute top-0 start-50 translate-middle">
                                <span class="badge bg-wasomupfy text-white fw-semibold px-3 py-2">Mais
                                    Popular</span>
                            </div>
                            <div class="card-body p-4">
                    ...
                    <div class="col-md-4" data-cue="zoomIn" data-delay="200">
                        <div class="card border-0 h-100 shadow-sm hover-lift">
                            <div class="card-body p-4">
                                ...
                                <div class="price-display mb-3">
                                    <span class="price-amount h3 fw-bold">70.000</span>
                                    <span class="price-period text-muted">Kz/ano</span>
                                </div>
                                <ul class="list-unstyled mb-4">
                                    <li class="d-flex align-items-start mb-2">
                                        <i class="bi bi-check-lg text-success mt-1 me-2"></i>
                                        <span>10 artistas na conta</span>
                                    </li>
                                    <li class="d-flex align-items-start mb-2">
                                        <i class="bi bi-check-lg text-success mt-1 me-2"></i>
                                        <span>5 colaboradores por faixa</span>
                                    </li>
                                    <li class="d-flex align-items-start">
                                        <i class="bi bi-check-lg text-success mt-1 me-2"></i>
                                        <span>Ideal para gravadoras</span>
                                    </li>
                                </ul>
        ...
        <section class="py-5 bg-light-100" data-cue="fadeIn">
            <div class="container">
                <div class="row justify-content-center text-center">
                    <div class="col-lg-8">
                        <h2 class="display-5 fw-bold mb-4">Pronto para lançar seu álbum?</h2>
