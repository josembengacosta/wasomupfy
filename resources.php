...
<head>
  ...
  <meta name="keywords" content="Wasom Upfy, Wasom, Upfy, Recursos, Recurs, Recursos Wasom Upfy" />
  ...
  <meta property="og:title" content="Wasom Upfy - Recursos que podem fazer a diferença." />
  ...
  <title>Wasom Upfy | Recursos</title>
...
<body>
        ...
        <div class="offcanvas offcanvas-start offcanvas-nav" style="width: 20rem">
          ...
          <div class="offcanvas-body pt-0 align-items-center">
            <ul class="navbar-nav mx-auto align-items-lg-center">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="resources" title="Recursos" role="button" data-bs-toggle="link"
                  aria-expanded="false">
                  Recursos</a>
              </li>
              <li class="nav-item dropdown">
  ...
  <main>
    <section class="resources-hero jarallax position-relative overflow-hidden py-5" data-jarallax data-speed="0.4">
      <img class="jarallax-img" src="assets/img/theme/resources.png" alt="Recursos Wasom Upfy" loading="lazy" />
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 gy-5">
          <div class="col" data-cue="zoomIn">
            <div class="text-center text-md-start">
              ...
              <h2 class="h4 mb-3 text-dark fw-bold">
                Distribuição Ilimitada
              </h2>
              <p class="paragrafo text-muted">
                Distribuímos suas músicas para todos os principais serviços de
                streaming do mundo. Esteja presente onde seu público está.
              </p>
            </div>
          </div>
          ...
          <div class="col" data-cue="zoomIn">
            <div class="text-center text-md-start">
              ...
              <p class="paragrafo text-muted">
                Sua música passa por uma análise automática e manual para
                garantir que todos os metadados estejam perfeitos para as
                lojas.
              </p>
            </div>
          </div>
          ...
          <div class="col" data-cue="zoomIn">
            <div class="text-center text-md-start">
              ...
              <p class="paragrafo text-muted">
                Controle total sobre seu catálogo. Remova faixas de circulação
                com apenas um clique diretamente no painel Wasom Upfy.
              </p>
            </div>
          </div>
          ...
          <div class="col" data-cue="zoomIn">
            <div class="text-center text-md-start">
              ...
              <h2 class="h4 mb-3 text-dark fw-bold">Seleção de Perfil</h2>
              <p class="paragrafo text-muted">
                Mapeamento preciso para Spotify e Apple Music. Garantimos que
                seus lançamentos caiam no perfil de artista correto.
              </p>
            </div>
          </div>
          ...
          <div class="col" data-cue="zoomIn">
            <div class="text-center text-md-start">
              <div class="mb-3 text-wasomupfy">
                <i class="fa-solid fa-earth-africa fs-1"></i>
              </div>
              <h2 class="h4 mb-3 text-dark fw-bold">Gestão Territorial</h2>
              <p class="paragrafo text-muted">
                Escolha onde sua música deve ser ouvida. Bloqueie ou libere
                países específicos conforme sua estratégia de marketing.
              </p>
            </div>
          </div>
              ...
              <div class="row align-items-center">
                ...
                <div class="col-lg-11">
                  ...
                  <p class="mb-0 text-muted">
                    Agende a data e a hora exata. Utilize o período de
                    antecedência para criar campanhas de Pre-save e garantir
                    que o mundo todo ouça sua música ao mesmo tempo.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="p-4 p-lg-5 rounded-4 shadow-sm border-start border-4 border-wasomupfy">
              <div class="row align-items-center">
                ...
                <div class="col-lg-11">
                  ...
                  <p class="mb-0 text-muted">
                    Nossa equipe está pronta para ajudar em cada etapa do
                    processo. Oferecemos suporte humanizado para resolver
                    dúvidas sobre uploads, pagamentos ou gestão de carreira de
                    forma rápida.
                  </p>
                </div>
              </div>
              ...
              <div class="row align-items-center">
                ...
                <div class="col-lg-11">
                  <h2 class="h4 fw-bold text-dark">
                    Pagamentos e Relatórios Transparentes
                  </h2>
                  <p class="mb-0 text-muted">
                    Receba seus ganhos diretamente na sua conta com total
                    transparência. Acompanhe relatórios detalhados de vendas e
                    streams para saber exatamente de onde vem o seu sucesso.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="p-4 p-lg-5 rounded-4 shadow-sm border-start border-4 border-wasomupfy">
              <div class="row align-items-center">
                ...
                <div class="col-lg-11">
                  ...
                  <p class="mb-0 text-muted">
                    Acesse dados demográficos e geográficos sobre quem ouve
                    sua música. Use essas informações para planejar turnês,
                    lançamentos e campanhas de marketing mais eficazes.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="p-4 p-lg-5 rounded-4 shadow-sm border-start border-4 border-wasomupfy">
              <div class="row align-items-center">
                ...
                <div class="col-lg-11">
                  ...
                  <p class="mb-0 text-muted">
                    Protegemos sua música contra pirataria e usos não
                    autorizados. Ativamos sistemas de identificação de
                    conteúdo para garantir que você monetize sempre que sua
                    obra for utilizada.
                  </p>
                </div>
              </div>
          ...
          <div class="col-md-12" data-cue="slideInUp">
            <div class="p-4 p-lg-5 rounded-4 shadow-sm border-start border-4 border-wasomupfy">
              <div class="row align-items-center">
                ...
                <div class="col-lg-11">
                  <h2 class="h4 fw-bold text-dark">
                    Smart Links e Páginas de Pre-save
                  </h2>
                  <p class="mb-0 text-muted">
                    Gere automaticamente links personalizados para os seus
                    lançamentos. Com o Pre-save, os seus fãs podem adicionar a
                    música à biblioteca antes da estreia, impulsionando os
                    algoritmos das lojas digitais no dia do lançamento.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-8 text-center mb-5" data-cue="fadeIn">
            <div class="p-5 rounded-5 position-relative overflow-hidden shadow-lg border-end border-4 border-wasomupfy">
              ...
              <div class="align-items-center position-relative z-index-2">
                <div class="col-lg-8 mb-4 mb-lg-0">
                  <h2 class="display-6 fw-bold mb-3">
                    Pronto para colocar sua música no mapa mundial?
                  </h2>
                  <p class="lead mb-0 opacity-75">
                    Junte-se a milhares de artistas que já utilizam os
                    recursos da Wasom Upfy para gerir as suas carreiras.
                  </p>
                </div>
                <div class="col-lg-6 mt-3 text-lg-center">
                  ...
                  <p class="small mt-3 opacity-50 text-center">
                    Sem taxas ocultas. 100% de controle.
                  </p>
                </div>
              </div>
            </div>
