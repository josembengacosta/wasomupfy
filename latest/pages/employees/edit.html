...
<head>
  ...
  <title>Editar Funcionário — Wasom Upfy</title>
  ...
  <div class="wrapper">
    ...
    <div class="content w-100" id="mainContent">
      ...
      <div class="container-fluid py-0">
        <div class="row mb-3 mt-2">
          <div class="welcome-text col-auto d-sm-block">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item">
                  <a href="all-employees" class="text-secondary">Funcionários</a>
                </li>
          ...
          <div class="col-auto ms-auto text-end mt-n1 mt-3 mb-2">
            <div class="d-flex gap-2">
              <a href="all-employees" class="btn btn-outline-secondary me-2 shadow-sm">
                <i class="bi bi-arrow-left me-1"></i> Voltar
              </a>
              <button class="btn btn-danger shadow-sm" id="deleteEmployeeBtn">
        ...
        <!-- ID do Funcionário (simulado da URL) -->
        <div class="row mb-4">
          <div class="col-12">
            <div class="alert alert-custom">
              <div class="d-flex align-items-center">
                <i class="bi bi-info-circle-fill text-wasomupfy me-3 fs-4"></i>
                <div class="text-black">
                  <h6 class="mb-1">
                    Editando Funcionário ID:
                    <span id="employeeId" class="fw-bold">1005</span>
                  </h6>
                  <p class="mb-0">
                    Altere as informações abaixo para atualizar os dados do
                    funcionário.
                  </p>
                </div>
              </div>
            ...
            <div class="card mb-4">
              <div class="card-body text-center">
                <div class="avatar-upload mb-3">
                  <img src="https://i.pravatar.cc/150?img=32" alt="Foto do Funcionário" class="profile-avatar"
                    id="profileAvatar" />
                ...
                <h4 id="employeeName">Maria Silva Santos</h4>
                <p class="text-muted mb-1">@maria.silva</p>
                <p class="text-muted mb-3">Gerente Financeiro</p>

                <div class="mb-3">
                  <span class="status-badge status-active" id="employeeStatus">Ativo</span>
                </div>

                <div class="d-flex justify-content-center mb-3">
                  <span class="badge bg-primary badge-role me-2">Administrador</span>
                ...
                <div class="text-start">
                  <p>
                    ...
                    <span id="employeeEmail">maria.silva@wasomupfy.com</span>
                  </p>
                  <p>
                    <i class="bi bi-telephone me-2"></i>
                    <span id="employeePhone">+351 912 345 678</span>
                  </p>
                  <p>
                    <i class="bi bi-geo-alt me-2"></i>
                    <span id="employeeLocation">Lisboa, Portugal</span>
                  </p>
                  <p>
                    <i class="bi bi-calendar me-2"></i> Membro desde:
                    <span id="employeeSince">15/03/2022</span>
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="card-body">
                <div class="timeline">
                  <div class="timeline-item">
                    <small class="text-muted d-block mb-1">Hoje, 14:30</small>
                    <p class="mb-0">
                      Login realizado
                      <span class="badge bg-success activity-badge">Segurança</span>
                    </p>
                  </div>
                  <div class="timeline-item">
                    <small class="text-muted d-block mb-1">Ontem, 16:45</small>
                    <p class="mb-0">
                      Relatório financeiro exportado
                      <span class="badge bg-info activity-badge">Ação</span>
                    </p>
                  </div>
                  <div class="timeline-item">
                    <small class="text-muted d-block mb-1">3 dias atrás</small>
                    <p class="mb-0">
                      Senha alterada
                      <span class="badge bg-warning activity-badge">Segurança</span>
                    </p>
                  </div>
                  <div class="timeline-item">
                    <small class="text-muted d-block mb-1">1 semana atrás</small>
                    <p class="mb-0">
                      Perfil atualizado
                      <span class="badge bg-secondary activity-badge">Perfil</span>
                    </p>
                  </div>
                </div>
              </div>
                ...
                <ul class="nav nav-tabs card-header-tabs" id="editTabs" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="permissions-tab" data-bs-toggle="tab" data-bs-target="#permissions"
                      type="button" role="tab">
                      <i class="bi bi-key me-1"></i> Permissões
                    </button>
                  </li>
                </ul>
              </div>
                  ...
                  <div class="tab-pane fade show active" id="profile" role="tabpanel">
                    <form id="profileForm">
                      <div class="row">
                        <div class="col-md-6">
                          <div class="mb-3">
                            <label for="editName" class="form-label required-field">Nome Completo</label>
                            <input type="text" class="form-control" id="editName" value="Maria Silva Santos" required />
                          </div>
                          <div class="mb-3">
                            <label for="editAccount" class="form-label required-field">Conta</label>
                            <input type="text" class="form-control" id="editAccount" value="@maria.silva" required />
                          </div>
                          <div class="mb-3">
                            <label for="editUsername" class="form-label required-field">Nome de Usuário</label>
                            <input type="text" class="form-control" id="editUsername" value="maria.silva" required />
                          </div>
                          <div class="mb-3">
                            <label for="editEmail" class="form-label required-field">E-mail</label>
                            <input type="email" class="form-control" id="editEmail" value="maria.silva@wasomupfy.com"
                              required />
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="mb-3">
                            ...
                            <input type="tel" class="form-control" id="editPhone" value="+351 912 345 678" />
                          </div>
                          <div class="mb-3">
                            <label for="editCountry" class="form-label required-field">País</label>
                          ...
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="editCity" value="Lisboa" />
                          </div>
                          <div class="mb-3">
                            <label for="editStatus" class="form-label required-field">Estado da Conta</label>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="mb-3">
                            <label for="editRoles" class="form-label required-field">Funções</label>
                            <select class="form-select" id="editRoles" multiple required>
                              ...
                              <option value="financial" selected>
                                Financeiro
                              </option>
                            </select>
                            <small class="text-muted">Ctrl+click para selecionar múltiplas
                              funções</small>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="mb-3">
                            <label for="editPlan" class="form-label">Plano</label>
...
Funcionária responsável pelo departamento financeiro. Acesso total ao sistema.</textarea>
                      </div>
                    ...
                    <form id="securityForm">
                      <div class="form-section">
                        ...
                        <div class="alert alert-warning mb-4">
                          ...
                          <strong>Atenção:</strong> Ao alterar a senha, o
                          usuário será notificado por e-mail e será forçado a
                          fazer login novamente.
                        </div>

                        <div class="mb-3">
                          <label for="currentPassword" class="form-label">Senha Atual do Usuário</label>
                        ...
                        <div class="mb-3">
                          ...
                          <small class="text-muted d-block mt-1" id="passwordStrengthText">Força da senha: Muito
                            fraca</small>
                        </div>
                        ...
                        <div class="form-check mb-3">
                          <input class="form-check-input" type="checkbox" id="forceLogout" />
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-3">
                          <div>
                            ...
                            <p class="text-muted mb-0">
                              Aumente a segurança da conta com 2FA
                            </p>
                          </div>
                        ...
                        <div id="2faSettings" style="display: none">
                          <div class="mb-3">
                            ...
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="2faMethod" id="2faApp" checked />
                              <label class="form-check-label" for="2faApp">
                                Aplicativo de autenticação (Google
                                Authenticator, Authy, etc.)
                              </label>
                            </div>
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="2faMethod" id="2faSMS" />
                          ...
                          <div class="alert alert-info">
                            ...
                            <span>O usuário receberá instruções para configurar a
                              autenticação de dois fatores no próximo
                              login.</span>
                          </div>
                        </div>

                        <button type="button" class="btn btn-outline-primary" id="save2FABtn">
                  ...
                  <div class="tab-pane fade" id="permissions" role="tabpanel">
                    <div class="alert alert-info mb-4">
                      <i class="bi bi-info-circle me-2"></i>
                      <span>Gerencie as permissões de acesso do funcionário ao
                        sistema. As permissões são baseadas nas funções
                        selecionadas.</span>
                    </div>

                    <div class="permission-group">
                      <h6>
                        <i class="bi bi-bar-chart me-2"></i> Análises e
                        Relatórios
                      </h6>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="permissionAnalyticsView" checked />
                            <label class="form-check-label" for="permissionAnalyticsView">
                              Visualizar análises
                            </label>
                          </div>
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="permissionReportsGenerate" checked />
                            <label class="form-check-label" for="permissionReportsGenerate">
                              Gerar relatórios
                            </label>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="permissionExportData" checked />
                            <label class="form-check-label" for="permissionExportData">
                              Exportar dados
                            </label>
                          </div>
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="permissionCustomReports" />
                            <label class="form-check-label" for="permissionCustomReports">
                    ...
                    <div class="permission-group">
                      <h6>
                        <i class="bi bi-music-note-list me-2"></i> Gestão de
                        Músicas
                      </h6>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="permissionMusicReview" />
                            <label class="form-check-label" for="permissionMusicReview">
                              Revisar envios
                            </label>
                          </div>
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="permissionMusicApprove" />
                            <label class="form-check-label" for="permissionMusicApprove">
                              Aprovar músicas
                            </label>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="permissionMusicReject" />
                            <label class="form-check-label" for="permissionMusicReject">
                              Rejeitar músicas
                            </label>
                          </div>
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="permissionMusicEdit" />
                            <label class="form-check-label" for="permissionMusicEdit">
                              Editar metadados
                            </label>
                          </div>
                        </div>
                    ...
                    <div class="permission-group">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="permissionUsersView" checked />
                            <label class="form-check-label" for="permissionUsersView">
                              Ver usuários
                            </label>
                          </div>
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="permissionUsersCreate" checked />
                            <label class="form-check-label" for="permissionUsersCreate">
                              Criar usuários
                            </label>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="permissionUsersEdit" checked />
                            <label class="form-check-label" for="permissionUsersEdit">
                              Editar usuários
                            </label>
                          </div>
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="permissionUsersDelete" />
                            <label class="form-check-label" for="permissionUsersDelete">
                              Excluir usuários
                            </label>
                          </div>
                        </div>
                    ...
                    <div class="permission-group">
                      <h6><i class="bi bi-globe me-2"></i> Distribuição</h6>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="permissionDistributionView" checked />
                            <label class="form-check-label" for="permissionDistributionView">
                              Ver distribuição
                            </label>
                          </div>
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="permissionReleasesManage" checked />
                            <label class="form-check-label" for="permissionReleasesManage">
                        ...
                        <div class="col-md-6">
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="permissionScheduleRelease" />
                            <label class="form-check-label" for="permissionScheduleRelease">
                              Agendar lançamentos
                            </label>
                          </div>
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="permissionStoreManage" />
                            <label class="form-check-label" for="permissionStoreManage">
                              Gerenciar lojas
                            </label>
                          </div>
                        </div>
                    ...
                    <div class="permission-group">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="permissionPaymentsView" checked />
                            <label class="form-check-label" for="permissionPaymentsView">
                              Ver pagamentos
                            </label>
                          </div>
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="permissionEarningsView" checked />
                            <label class="form-check-label" for="permissionEarningsView">
                              Ver rendimentos
                            </label>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="permissionProcessPayments" />
                            <label class="form-check-label" for="permissionProcessPayments">
                              Processar pagamentos
                            </label>
                          </div>
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="permissionFinancialReports" />
                            <label class="form-check-label" for="permissionFinancialReports">
                    ...
                    <div class="d-flex justify-content-between mt-4">
                      ...
                      <button type="button" class="btn btn-wasomupfy" id="savePermissionsBtn">
  ...
  <script src="js/edit-employee.js"></script>
</body>
