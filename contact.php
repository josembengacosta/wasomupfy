...
<head>
  ...
  <meta name="keywords"
    content="Wasom Upfy, Wasom, Upfy, Contacto, Contact, Fale-connosco, Entre em contacto, contacta-nós" />
  ...
  <meta property="og:title" content="Wasom Upfy - Fale-connosco." />
  ...
  <title>Wasom Upfy | Contacto</title>
...
<style>
  ...
  /* Estilo para destacar os ícones de contacto */
  .icon-shape {
    display: flex;
    align-items: center;
    justify-content: center;
        ...
        <div class="offcanvas offcanvas-start offcanvas-nav" style="width: 20rem">
          ...
          <div class="offcanvas-body pt-0 align-items-center">
            <ul class="navbar-nav mx-auto align-items-lg-center">
              ...
              <li class="nav-item dropdown">
                <a title="Contacto" class="nav-link active" href="#" role="button" data-bs-toggle="dropdown"
                  aria-expanded="false">Contactar <i data-feather="chevron-down"></i></a>
                <ul class="dropdown-menu">
                  <li>
                    <a title="Caixa de mensagem" class="dropdown-item active" href="contact">
                      Caixa de mensagem</a>
                  </li>
                  <li>
            ...
            <div class="row align-items-center g-5">
              <div class="col-lg-5 col-12 text-white-stable" data-cue="slideInLeft">
                ...
                <h2 class="h1 mb-4 mt-4 text-uppercase text-white-stable fw-bold">
                  Conecte-se com a
                  <span class="text-wasomupfy">nossa equipa</span>
                </h2>

                <p class="lead opacity-75">
                  Estamos prontos para ouvir as suas ideias, resolver questões
                  ou receber o seu feedback. Escolha o canal que preferir.
                </p>

                <div class="mb-6 mt-5">
                  <ul class="list-unstyled mb-0">
                    <li class="d-flex mb-4 align-items-start">
                      <div class="icon-shape bg-wasomupfy bg-opacity-10 text-wasomupfy rounded-circle p-3 shadow-sm">
                        <i class="fa-solid fa-handshake fs-2"></i>
                      </div>
                      <div class="ms-3">
                        <h5 class="fw-bold mb-1 text-white-stable">
                          Compromisso Total
                        </h5>
                        <p class="small mb-0 opacity-75">
                          Estamos sempre disponíveis para agendar uma reunião
                          ou call. A sua carreira é a nossa prioridade.
                        </p>
                      </div>
                    </li>
                    ...
                    <li class="d-flex mb-4 align-items-start">
                      ...
                      <div class="ms-3">
                        ...
                        <p class="small mb-0 opacity-75">
                          Tempo é música. Respondemos às mensagens em tempo
                          recorde, geralmente em menos de 30 minutos.
                        </p>
                      </div>
                    </li>
                  </ul>
              ...
              <div class="col-md-7" data-cue="slideInRight">
                <div class="position-relative mx-3">
                  <div class="card shadow-sm mb-6">
                    <div class="card-body">
                      <form action="enviar.php" method="post" class="row g-3 needs-validation" novalidate
                        accept-charset="utf-8" id="caixa-sms">
                        <div class="col-md-6">
                          <label for="name_user" class="form-label text-dark-form text-left">Nome Completo
                            <span class="text-danger text-xs">*</span></label>
                          <input type="text" minlength="8" maxlength="25" placeholder="Insira o seu nome completo"
                            class="form-control" autocomplete="name" id="name_user" name="name" required />
                          <div class="valid-feedback"></div>
                          <div class="invalid-feedback">
                            <span class="text-base">Qual é o seu nome completo?</span>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <label for="tel_user" class="form-label text-dark-form">Número de Telefone
                            <span class="text-muted opacity-8 hit">
                              (opcional)</span></label>
                          <input type="tel" maxlength="18" placeholder="Insira o seu número de telefone"
                            class="form-control" autocomplete="tel-country-code" id="tel_user" name="tel" list="tele" />
                          <datalist id="tele">
                            <div class="select">
                        ...
                        <div class="col-md-12">
                          <label for="email_user" class="form-label text-dark-form">E-mail
                            <span class="text-danger text-xs">*</span>
                            <span class="text-muted opacity-8 hit">
                              (Insira um e-mail que útiliza)</span></label>
                          <input type="email" maxlength="60" placeholder="usuario@exemplo.com" class="form-control"
                            autocomplete="email" id="email_user" required name="email" />
                          <div class="valid-feedback">
                            <span class="text-base">E-mail válido.</span>
                          </div>
                          <div class="invalid-feedback">
                            <span class="text-base">Insira um e-mail válido!</span>
                          </div>
                        </div>
                        <div class="col-md-12">
                          <label for="newlleter" class="form-label text-dark-form">Assunto
                            <span class="text-danger text-xs">*</span></label>
                          <input type="text" maxlength="60" minlength="8" placeholder="Insira o seu assunto"
                            class="form-control" autocomplete="on" id="newlleter" required name="newlleter" />
                          <div class="valid-feedback"></div>
                          <div class="invalid-feedback">
                        ...
                        <div class="col-md-12">
                          <label for="sms" class="form-label text-dark-form">Mensagem
                            <span class="text-danger text-xs">*</span></label>
                          <textarea name="sms" id="sms" required cols="30" class="form-control" autocomplete="on"
                            maxlength="400" rows="5" placeholder="Escreva a sua mensagem aqui!"></textarea>
                          <div class="valid-feedback"></div>
                          <div class="invalid-feedback">
                            <span class="text-base">Por favor, escreva a sua mensagem!</span>
                          </div>
                        </div>
