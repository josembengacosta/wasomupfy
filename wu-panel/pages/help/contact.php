...
<head>
  ...
  <title>Contacto de suporte — <?php echo APP_NAME; ?></title>
...
<body>
  <div class="wrapper">
    ...
    <div class="sidebar" id="sidebar">
      ...
      <ul class="nav flex-column mt-3">
        ...
        <li class="nav-item">
          <a href="#collapseHelp" class="nav-link active" data-bs-toggle="collapse" aria-expanded="false"
          ...
          <div class="collapse" id="collapseHelp">
            ...
            <a href="../help/contact" class="nav-link active">
        ...
        <li class="nav-item mt-4">
          <a href="https://wasomupfy.rf.gd/home" target="_blank" class="nav-link">
    ...
    <div class="content w-100" id="mainContent">
      ...
      <!-- Header do Suporte -->
      <div class="support-header mt-2">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-8">
              <h1 class="display-6 mb-2">
                <i class="bi bi-headset me-3"></i> Central de Suporte
              </h1>
              <p class="mb-0">
        ...
        <div class="row mb-4">
          <div class="col-md-3">
            <div class="stats-card open">
              <h3 class="mb-1" id="openTicketsCount">12</h3>
              <p class="mb-0">Tickets Abertos</p>
            </div>
          </div>
          <div class="col-md-3">
            <div class="stats-card pending">
              <h3 class="mb-1" id="pendingTicketsCount">5</h3>
              <p class="mb-0">Em Andamento</p>
            </div>
          </div>
          <div class="col-md-3">
            <div class="stats-card closed">
              <h3 class="mb-1" id="closedTicketsCount">42</h3>
              <p class="mb-0">Resolvidos</p>
            </div>
          </div>
          <div class="col-md-3">
            <div class="stats-card urgent">
              <h3 class="mb-1" id="urgentTicketsCount">3</h3>
        ...
        <div class="row">
          <div class="col-md-8">
                  ...
                  <div class="tab-pane fade show active" id="tickets" role="tabpanel">
                    <div class="d-flex justify-content-between mb-3">
                      <div class="quick-actions">
                        <button class="btn btn-outline-primary btn-sm quick-action-btn" onclick="filterTickets('all')">
                          Todos
                        </button>
                        <button class="btn btn-outline-success btn-sm quick-action-btn" onclick="filterTickets('open')">
                          Abertos
                        </button>
                        <button class="btn btn-outline-warning btn-sm quick-action-btn"
                          onclick="filterTickets('pending')">
                          Pendentes
                        </button>
                        <button class="btn btn-outline-danger btn-sm quick-action-btn"
                          onclick="filterTickets('urgent')">
                          Urgentes
                        </button>
                      ...
                      <div class="search-box">
                        <div class="input-group input-group-sm">
                          <input type="text" class="form-control" placeholder="Buscar tickets..." id="ticketSearch" />
                    ...
                    <div id="ticketsList">
                      <!-- Lista de tickets será carregada aqui -->
                    ...
                    <div class="chat-container">
                      <div class="chat-header">
                        <div class="d-flex justify-content-between align-items-center">
                          <div>
                            <h6 class="mb-0">
                              <i class="bi bi-headset me-2"></i> Chat com
                              Suporte
                            </h6>
                            <small class="text-muted" id="agentStatus">Conectando...</small>
                          </div>
                          <div>
                            <span class="badge bg-success" id="chatStatus">Online</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="chat-messages" id="chatMessages">
                        <div class="message received fade-in">
                          <div class="message-content">
                            <p class="mb-1">
                              Olá! Sou a Ana do suporte. Como posso ajudá-lo
                              hoje?
                            </p>
                        ...
                        <div class="message sent fade-in">
                          <div class="message-content">
                            <p class="mb-1">
                              Preciso de ajuda com a configuração de um novo
                              artista no sistema.
                            </p>
                        ...
                        <div class="message received fade-in">
                          <div class="message-content">
                            <p class="mb-1">
                              Claro! Posso te guiar passo a passo. Primeiro,
                              vá até a seção "Artistas" no menu principal.
                            </p>
                            <div class="attachment-badge">
                              <i class="bi bi-paperclip me-1"></i>
                              <span>guia_configuracao.pdf</span>
                            </div>
                      ...
                      <div class="chat-input">
                        ...
                        <div class="mt-2">
                          <button class="btn btn-sm btn-outline-secondary me-1"
                            onclick="addQuickResponse('Preciso de ajuda com pagamentos')">
                            Pagamentos
                          </button>
                          <button class="btn btn-sm btn-outline-secondary me-1"
                            onclick="addQuickResponse('Problema com upload de música')">
                            Upload
                          </button>
                          <button class="btn btn-sm btn-outline-secondary"
                            onclick="addQuickResponse('Configuração de lojas digitais')">
                            Lojas
                          </button>
                        </div>
                      </div>
                  ...
                  <div class="tab-pane fade" id="knowledge" role="tabpanel">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="knowledge-card">
                          <h6>
                            ...
                            Como adicionar um novo artista?
                          </h6>
                          <p class="text-muted mb-2">
                            Guia passo a passo para cadastrar novos artistas
                            no sistema.
                          </p>
                          <small class="text-muted">Última atualização: 15/01/2024</small>
                        </div>

                        <div class="knowledge-card">
                          <h6>
                            <i class="bi bi-question-circle text-primary me-2"></i>
                            Configuração de lojas digitais
                          </h6>
                          <p class="text-muted mb-2">
                            Integre suas lojas digitais favoritas com o Wasom
                            Upfy.
                          </p>
                          <small class="text-muted">Última atualização: 10/01/2024</small>
                        </div>
                        ...
                        <div class="knowledge-card">
                          ...
                          <p class="text-muted mb-2">
                            Resolução dos problemas mais comuns ao fazer
                            upload de músicas.
                          </p>
                          <small class="text-muted">Última atualização: 05/01/2024</small>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="knowledge-card">
                          ...
                          <p class="text-muted mb-2">
                            Como configurar e gerenciar pagamentos de
                            artistas.
                          </p>
                          <small class="text-muted">Última atualização: 20/12/2023</small>
                        </div>
                        ...
                        <div class="knowledge-card">
                          ...
                          <p class="text-muted mb-2">
                            Utilize os relatórios para acompanhar o
                            desempenho.
                          </p>
                          <small class="text-muted">Última atualização: 15/12/2023</small>
                        </div>
                        ...
                        <div class="knowledge-card">
                          ...
                          <p class="text-muted mb-2">
                            Configure permissões de acesso para sua equipe.
                          </p>
                          <small class="text-muted">Última atualização: 10/12/2023</small>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="text-center mt-3">
                      <a href="#" class="btn btn-outline-primary">
                        <i class="bi bi-search me-1"></i> Buscar na Base de
                        Conhecimento
                      </a>
                    </div>
                  </div>
            ...
            <div class="card">
              <div class="card-header">
                <h5 class="mb-0">
                  <i class="bi bi-people me-2"></i> Nossa Equipe de Suporte
                </h5>
              </div>
              <div class="card-body">
                <div class="row">
                  <div class="col-md-3">
                    <div class="support-agent agent-online text-center">
                      <div class="avatar-circle mb-2 mx-auto" style="background-color: #4e73df">
                        AS
                      </div>
                      <h6 class="mb-1">Ana Silva</h6>
                      <p class="text-muted mb-1">Suporte Técnico</p>
                      <small class="text-success">● Online</small>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="support-agent agent-online text-center">
                      <div class="avatar-circle mb-2 mx-auto" style="background-color: #1cc88a">
                        PC
                      </div>
                      <h6 class="mb-1">Pedro Costa</h6>
                      <p class="text-muted mb-1">Suporte Financeiro</p>
                      <small class="text-success">● Online</small>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="support-agent text-center">
                      <div class="avatar-circle mb-2 mx-auto" style="background-color: #36b9cc">
                        MS
                      </div>
                      <h6 class="mb-1">Maria Santos</h6>
                      <p class="text-muted mb-1">Suporte Artístico</p>
                      <small class="text-muted">● Offline</small>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="support-agent agent-online text-center">
                      <div class="avatar-circle mb-2 mx-auto" style="background-color: #f6c23e">
                        CR
                      </div>
                      <h6 class="mb-1">Carlos Rocha</h6>
                      <p class="text-muted mb-1">Gerente de Suporte</p>
                      <small class="text-success">● Online</small>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-md-4">
            ...
            <div class="card mb-4">
              <div class="card-header">
                <h5 class="mb-0">
                  <i class="bi bi-telephone me-2"></i> Contato Direto
                </h5>
              </div>
              <div class="card-body">
                <div class="mb-3">
                  ...
                  <p class="mb-1">
                    <a href="mailto:suporte@wasomupfy.com" class="text-decoration-none">
                ...
                <div class="mb-3">
                  ...
                  <p class="mb-1">
                    <a href="https://wa.me/5521999999999" class="text-decoration-none">
                      +55 21 99999-9999
                    </a>
                  </p>
                ...
                <div class="mb-3">
                  <h6>
                    <i class="bi bi-clock me-2 text-warning"></i> Horário de
                    Atendimento
                  </h6>
                  <p class="mb-1">Segunda a Sexta: 9h às 18h</p>
                  <p class="mb-1">Sábado: 9h às 13h</p>
                  <small class="text-muted">Horário de Brasília</small>
                </div>

                <div class="mb-3">
                  <h6>
                    <i class="bi bi-headset me-2 text-danger"></i> Telefone
                  </h6>
                  <p class="mb-1">
                    <a href="tel:+552130304040" class="text-decoration-none">
                      (21) 3030-4040
                    </a>
                  </p>
                  <small class="text-muted">Ramal: 1234</small>
                </div>

                <div class="text-center mt-4">
                  <button class="btn btn-wasomupfy me-2" data-bs-toggle="modal" data-bs-target="#callModal">
                    <i class="bi bi-telephone-outbound me-1"></i> Solicitar
                    Chamada
                  </button>
                </div>
              </div>
            ...
            <div class="card mb-4">
              <div class="card-header">
                <h5 class="mb-0">
                  <i class="bi bi-graph-up me-2"></i> Métricas de Suporte
                </h5>
              </div>
              <div class="card-body">
                <div class="mb-3">
              ...
              <div class="card-body">
                <div class="list-group list-group-flush">
                  <a href="#" class="list-group-item list-group-item-action border-0">
                    <i class="bi bi-download me-2"></i> Download de Manuais
                  </a>
                  <a href="#" class="list-group-item list-group-item-action border-0">
                    <i class="bi bi-camera-video me-2"></i> Tutoriais em Vídeo
                  </a>
                  <a href="#" class="list-group-item list-group-item-action border-0">
                    <i class="bi bi-file-text me-2"></i> Termos de Serviço
                  </a>
                  <a href="#" class="list-group-item list-group-item-action border-0">
                    <i class="bi bi-shield-check me-2"></i> Política de
                    Privacidade
                  </a>
                  <a href="#" class="list-group-item list-group-item-action border-0">
                    <i class="bi bi-question-circle me-2"></i> FAQ - Perguntas
                    Frequentes
                  </a>
                </div>
              </div>
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">
            <i class="bi bi-plus-circle me-2"></i> Novo Ticket de Suporte
          </h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <form id="newTicketForm">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="ticketSubject" placeholder="Descreva brevemente o problema"
                required />
            </div>
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                ...
                <select class="form-select" id="ticketCategory" required>
                  ...
                  <option value="account">Conta/Usuário</option>
            ...
            <div class="mb-3">
              <label for="ticketDescription" class="form-label">Descrição Detalhada *</label>
            ...
            <div class="mb-3">
              <label for="ticketAttachments" class="form-label">Anexos</label>
              <input type="file" class="form-control" id="ticketAttachments" multiple />
              <small class="text-muted">Você pode anexar screenshots, logs ou outros arquivos (máx.
                10MB cada)</small>
            </div>
          </form>
        </div>
  ...
  <!-- Modal Solicitar Chamada -->
  <div class="modal fade" id="callModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xs">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">
            <i class="bi bi-telephone-outbound me-2"></i> Solicitar Chamada
          </h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <p>
            Preencha os dados abaixo para que nossa equipe entre em contato
            com você:
          </p>

          <form id="callRequestForm">
            <div class="mb-3">
              <label for="callPhone" class="form-label">Telefone para Contato *</label>
              <input type="tel" class="form-control" id="callPhone" placeholder="+55 (21) 99999-9999" required />
            </div>

            <div class="mb-3">
              <label for="callBestTime" class="form-label">Melhor Horário</label>
              <select class="form-select" id="callBestTime">
            ...
            <div class="mb-3">
              <label for="callSubject" class="form-label">Assunto da Chamada *</label>
              <input type="text" class="form-control" id="callSubject" placeholder="Sobre o que gostaria de conversar?"
                required />
            </div>
          </form>
        </div>
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary" onclick="submitCallRequest()">
            <i class="bi bi-telephone me-1"></i> Solicitar Chamada
          </button>
        </div>
      </div>
    </div>
