                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="av-card">
                            ...
                            <div class="av-detail-row">
                                <span class="av-detail-label">Email do Artista</span>
                                <span class="av-detail-value">
                                    <a href="mailto:<?php echo htmlspecialchars($artist['artist_email']); ?>">
                                        <?php echo htmlspecialchars($artist['artist_email']); ?>
                                    </a>
                                </span>
                            </div>
                            <?php endif; ?>

                            <?php if (!empty($artist['default_role'])): ?>
                            <div class="av-detail-row">
                                <span class="av-detail-label">Função Habitual</span>
                                <span class="av-detail-value">
                                    <span class="badge" style="background:rgba(13,110,253,.12);color:#0d6efd">
                                        <i class="bi bi-person-badge me-1"></i>
                                        <?php echo htmlspecialchars(str_replace('_', ' ', $artist['default_role'])); ?>
                                    </span>
                                </span>
                            </div>
                            <?php endif; ?>
