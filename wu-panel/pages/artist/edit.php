...
// Arquivo: wu-panel/pages/artist/edit.php
// Rota:    wu-panel/artist/edit?id=X
// ══════════════════════════════════════════════
                        ...
                        <form method="POST" action="<?php echo APP_URL . '/' . ADMIN_PATH; ?>/artist/edit-process"
                            ...
                            <div class="ae-card">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <label class="ae-form-label">Email do Artista</label>
                                        <input type="email" class="form-control" name="artist_email"
                                            value="<?php echo htmlspecialchars($artist['artist_email'] ?? ''); ?>"
                                            placeholder="email@artista.com" />
                                    </div>
                                    <div class="col-md-6">
                                        <label class="ae-form-label">Função Habitual</label>
                                        <select class="form-select" name="default_role">
                                            ...
                                            foreach ($roles as $val => $label):
                                                $sel = ($artist['default_role'] ?? '') === $val ? 'selected' : '';
                            ...
                            <div class="ae-card">
                                ...
                                <div class="row g-3 align-items-center">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" readonly name="photo_artist"
