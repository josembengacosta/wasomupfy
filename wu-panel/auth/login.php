...
$feedback = match ($msg_type) {
    ...
    'suspended' => [
        'type' => 'danger',
        'icon' => 'bi-person-dash',
        'text' => 'Esta conta está suspensa. Contacta o super administrador.'
    ],
    'processing' => [
        'type' => 'warning',
        'icon' => 'bi-hourglass-split',
        'text' => 'Conta em processo de activação. Aguarda a confirmação do administrador.'
    ],
    'error'     => [
        'type' => 'danger',
        'icon' => 'bi-exclamation-octagon',
        'text' => 'Credenciais inválidas. Verifica o e-mail/username e a senha.'
    ],
    'logout'    => [
        'type' => 'success',
...
// Se há ?return= mas sem ?msg= — sessão expirou (redirect automático)
...
<body>
        ...
        <div class="auth-left">
            <div class="brand-area">
                <div class="brand-logo">
                    <img src="<?php echo APP_URL  ?>/assets/img/brand/wasomupfy.png" alt="Wasom Upfy" />
        ...
        <div class="auth-right">
            <div class="auth-form-wrap">
                ...
                <div class="mobile-brand">
                    <img src="<?php echo APP_URL  ?>/assets/img/brand/wasomupfy_authentic.png" alt="Wasom Upfy"
                        width="36" height="36" style="border-radius:8px" />
                ...
                <?php endif; ?>
                <?php if (($_GET['invite'] ?? '') === 'done'): ?>
                <div style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:12px;
            padding:14px 18px;margin-bottom:20px;font-size:.84rem;color:#166534;
            display:flex;align-items:center;gap:10px">
                    <i class="bi bi-check-circle-fill" style="font-size:1.1rem;flex-shrink:0"></i>
                    <div>
                        <strong>Conta activada com sucesso!</strong><br>
                        <span style="opacity:.8">Já podes fazer login com as tuas credenciais.</span>
                    </div>
                </div>
                <?php endif; ?>

                <!-- Formulário -->
                <form method="POST" action="<?php echo APP_URL . '/' . ADMIN_PATH; ?>/login-process" id="form-login"
                    ...
                    <input type="hidden" name="return_url"
                        value="<?php echo htmlspecialchars($_GET['return'] ?? ''); ?>" />
                    ...
                    <div class="mb-3 fade-up delay-2">
                        <label class="form-label" for="email_admin">
                            E-mail ou Username <span class="text-danger">*</span>
                        </label>
                        <div class="input-group">
                            <input type="text" class="form-control" id="email_admin" name="email_employees"
                                placeholder="email@... ou @username" maxlength="255" autocomplete="username email"
                                required />
                        ...
                        <div class="invalid-feedback" id="email-feedback">
                            Introduz o teu e-mail ou username.
                        </div>
                    </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        emailInput.addEventListener('input', function() {
            // Aceita email ou username — qualquer texto com 2+ chars é válido aqui
            const v = this.value.trim();
            const isEmail = /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(v);
            const isUser = v.length >= 2;
            this.classList.toggle('is-invalid', !isUser && v.length > 1);
            this.classList.toggle('is-valid', isUser);
        });
        ...
        btnSubmit.addEventListener('click', function() {
            ...
            // Aceita email OU username (texto não vazio com pelo menos 2 chars)
