...
<head>
    ...
    <meta name="keywords"
        content="Wasom Upfy, Wasom, Upfy, home, inicio página principal, distribuição de música, ganhe dinheiro com sua música, proteger os direitos de todas as obras" />
    ...
    <meta property="og:title" content="Wasom Upfy - Alcance novos fãs e ganhe dinheiro com sua música." />
    ...
    <script type="application/ld+json">
        {
            ...
            "sameAs": [
                "https://www.facebook.com/wasom.official",
                "https://www.instagram.com/@wasomupfy",
                "https://www.twitter.com/wasomupfy",
                "https://www.youtube.com/@wasomupfy",
                "https://www.tiktok.com/@wasomupfy",
                "https://www.threads.net/wasomupfy"
            ],
            "contactPoint": {
                "@type": "ContactPoint",
                "email": "info@wasomupfy.com",
...
<body>
                ...
                <div class="offcanvas offcanvas-start offcanvas-nav" style="width: 20rem">
                    ...
                    <div class="offcanvas-body pt-0 align-items-center">
                        <ul class="navbar-nav mx-auto align-items-lg-center">
                            <li class="nav-item">
                                <a class="nav-link active" href="home" title="Inicio" role="button"
                                    data-bs-toggle="link" aria-expanded="false">Início</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item dropdown">
                                <a title="Planos" class="nav-link" href="#" id="navbarDropdown" role="button"
                                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Planos <i
                                    ...
                                    <div class="row row-cols-lg-3">
                                        ...
                                        <div class="col">
                                            <div class="mt-3 mt-lg-0">
                                                ...
                                                <a title="Propagandas" class="dropdown-item"
                                            ...
                                            <div class="mt-3 mt-lg-0">
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <a title="Ocorreu um erro" class="dropdown-item"
                                                        href="page/support/support">Suporte
                                                        técnico</a>
                                                    <a title="Perguntas frequentes" class="dropdown-item"
                                                        href="page/support/faq">Perguntas
                                                        frequentes</a>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="resources" title="Recursos" role="button"
                                    data-bs-toggle="link" aria-expanded="false">
                                    Recursos</a>
                            </li>
                            <li class="nav-item dropdown">
    ...
    <main>
        ...
        <section class="jarallax py-7 hero-agency" data-jarallax data-speed="0.4" data-cue="fadeIn">
            <img class="jarallax-img" src="assets/img/theme/afro_girl_theme.png" alt="Capa Wasom Upfy" />
                        ...
                        <div class="col-xl-5 col-lg-7 col-12" data-cues="zoomIn" data-group="page-title"
                            ...
                            <div class="text-left text-lg-start">
                                <div class="text-white-stable">
                                    <small class="text-uppercase ls-lg">-Alcance novos fãs e ganhe dinheiro com sua
                                        música</small>
                                    ...
                                    <p class="lead font-weight-lighter mt-3">
                                        <q>Distribua sua música em plataformas como Spotify, Apple
                                            Music, Youtube, Instagram, Tiktok e muito mais. Matenha
                                            90% dos seus royalties e conserve os direitos autorais
                                            de suas músicas</q>.
                                    </p>
                                </div>
                                <div class="d-flex flex-row gap-2 justify-content-left">
                                    <a href="/wasomupfy/register" title="Junta-se agora"
                                        ...
                                        target="_blank" rel="internal">junta-se agora
                                    ...
                                    <a href="about" title="Sobre"
                                        class="btn btn-secondary hover-scale-x-105 icon-link icon-link-hover">Saiba mais
                                    </a>
                                </div>
                                <div class="col-sm-6 mt-3">
                                    ...
                                    <div
                                        class="text-md-start d-flex align-items-sttext-md-start justify-content-md-sttext-md-start">
                                        <div class="ms-1 d-flex gap-3">
                                            <a target="_blank" rel="external" title="Facebook Wasom Upfy"
                                                href="https://www.facebook.com/wasom.official"
                                            ...
                                            <a target="_blank" rel="external" title="Instagram Wasom Upfy"
                                                href="https://www.instagram.com/@wasomupfy" class="btn btn-wasomupfy">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            ...
                                            <a target="_blank" rel="external" title="Canal/WhatsApp da Wasom Upfy"
                                                href="https://wa.me/244923456789" class="btn btn-wasomupfy">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                    fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 24 24">
                                                    <path
                                            ...
                                            <a target="_blank" rel="external" title="Youtube Wasom Upfy"
                                                href="https://www.youtube.com/@wasomupfy" class="btn btn-wasomupfy">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            ...
                                            <a target="_blank" rel="external" title="Linkedin Wasom Upfy"
                                                href="https://linkedin.com/company/wasom-upfy"
                                                class="btn btn-wasomupfy">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
        ...
        <!-- Nossa aéra do site, com as pequennas informações -->
        <section class="my-xl-4 py-4">
                ...
                <div class="col-12" data-cue="zoomIn">
                    <div class="text-center mb-5">
                        ...
                        <h2 class="display-6 fw-bold text-dark mb-4">
                            Distribua sua música para o mundo inteiro
                        </h2>
                        <p class="lead text-body mb-0 px-lg-5">
                            Alcance novos fãs e ganhe dinheiro com sua música. A Wasom Upfy
                            é a plataforma de distribuição mais fácil e completa do mercado,
                            levando sua música para todas as principais plataformas de
                            streaming.
                        </p>
                    </div>
                </div>
                        ...
                        <div class="card-body p-4 p-lg-5">
                            ...
                            <div class="benefits-list">
                                <div class="benefit-item d-flex mb-4">
                                    ...
                                    <div>
                                        <h5 class="mb-1 fw-semibold">90% dos Royalties</h5>
                                        <p class="text-body mb-0 small">
                                            Receba a maior parte dos seus ganhos com uma das taxas
                                ...
                                <div class="benefit-item d-flex mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-body mb-0 small">
                                            Saques mensais direto para sua conta. Taxas
                                            transparentes e histórico completo 24/7.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="benefit-item d-flex mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-body mb-0 small">
                                            Acompanhe streams, países, dados demográficos e compare
                                ...
                                <div class="benefit-item d-flex">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-body mb-0 small">
                                            Inclusão em playlists, campanhas em redes sociais e
                                            acesso a influenciadores musicais.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="process-steps">
                                <div class="step-item d-flex mb-4 pb-3 border-bottom">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-body mb-0 small">
                                            Crie sua conta gratuitamente. Sem custos ocultos, sem
                                            compromissos.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="step-item d-flex mb-4 pb-3 border-bottom">
                                    ...
                                    <div>
                                        <h5 class="mb-1 fw-semibold">Envie sua Música</h5>
                                        <p class="text-body mb-0 small">
                                            Faça upload do áudio, capa do álbum e todos os metadados
                                            necessários.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="step-item d-flex">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-body mb-0 small">
                                            Sua música no ar em até 48 horas em todas as plataformas
                                            principais.
                                        </p>
                                    </div>
                                </div>
            ...
            <!--Porque escolher a Wasom Upfy? start-->
            <div class="container">
                <div class="row">
                    <div class="row justify-content-center mb-5 pt-5" data-cue="fadeIn">
                        <div class="col-lg-8 text-center">
                            <h2 class="fw-bold text-dark mb-2">
                                Por que artistas escolhem a Wasom Upfy?
                            </h2>
                            <p class="lead text-body mb-0">
                                Da sua cidade natal para o mundo. Sua música em rádios,
                                playlists virais e nas principais plataformas globais.
                            </p>
                        </div>
                    </div>
                    <div class="row g-4" data-cue="fadeIn">
                                ...
                                <div class="card-body p-5">
                                    <div class="d-lg-flex">
                                        <div class="p-3 icon-xl icon-shape rounded bg-opacity-10">
                                            <img src="assets/img/icones/promove_sua_música.png" width="120" height="120"
                                                alt />
                                        </div>
                                        <div class="ms-lg-5 mt-4 mt-lg-0">
                                            <div class="mb-4">
                                                <h3>Promoção eficiente da sua música</h3>
                                                <ul class="list-group mb-2">
                                                    <li>
                                                        - Estratégias personalizadas por gênero musical
                                                    </li>
                                                    <li>- Inclusão em playlists temáticas</li>
                                                    <li>- Campanhas de mídia paga otimizadas</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="card-lift h-100" data-cue="zoomIn" data-duration="500">
                                <div class="card-body p-5">
                                    <div class="d-lg-flex">
                                        <div class="p-3 icon-xl icon-shape rounded bg-opacity-10">
                                            <img src="assets/img/icones/controle1.png" width="120" height="120" alt />
                                        </div>
                                        <div class="ms-lg-5 mt-4 mt-lg-0">
                                            <div class="mb-4">
                                                <h3>Controle total sobre seus Lançamentos</h3>
                                                <ul class="list-group mb-2">
                                                    <li>- Adicione novos singles quando quiser</li>
                                                    <li>
                                                        - Atualize capas ou metadados a qualquer momento
                                                    </li>
                                                    <li>- Remova conteúdos sem burocracia</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="card-lift h-100" data-cue="zoomIn" data-duration="500">
                                <div class="card-body p-5">
                                    <div class="d-lg-flex">
                                        <div class="p-3 icon-xl icon-shape rounded bg-opacity-10">
                                            <img src="assets/img/icones/tempo_de_aprovacao.png" width="120" height="120"
                                                alt />
                                        </div>
                                        <div class="ms-lg-5 mt-4 mt-lg-0">
                                            <div class="mb-4">
                                                ...
                                                <ul class="list-group mb-2">
                                                    <li>- Processo de revisão ágil (24-48h)</li>
                                                    <li>- Feedback claro caso precise de ajustes</li>
                                                    <li>- Suporte humano durante todo o processo</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="card-lift h-100" data-cue="zoomIn" data-duration="500">
                                <div class="card-body p-5">
                                    <div class="d-lg-flex">
                                        <div class="p-3 icon-xl icon-shape rounded bg-opacity-10">
                                            <img src="assets/img/icones/analises_inovadoras.png" width="120"
                                                height="120" alt />
                                        </div>
                                        <div class="ms-lg-5 mt-4 mt-lg-0">
                                            <div class="mb-4">
                                                <h3>Análises Inovadoras</h3>
                                                <ul class="list-group mb-2">
                                                    <li>- Dashboard intuitivo com todos os dados</li>
                                                    <li>- Alertas quando sua música ganha tração</li>
                                                    <li>
                                                        - Insights para planejar próximos lançamentos
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="card-lift h-100" data-cue="zoomIn" data-duration="500">
                                <div class="card-body p-5">
                                    <div class="d-lg-flex">
                                        <div class="p-3 icon-xl icon-shape rounded bg-opacity-10">
                                            <img src="assets/img/icones/dinheiro.png" width="120" height="120" alt />
                                        </div>
                                        <div class="ms-lg-5 mt-4 mt-lg-0">
                                            <div class="mb-4">
                                                <h3>Maximize seus Ganhos</h3>
                                                <ul class="list-group mb-2">
                                                    <li>- Monetização em todas as plataformas</li>
                                                    <li>- Sistema de divisão de royalties</li>
                                                    <li>
                                                        - Oportunidades de licenciamento para filmes/ads
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="card-lift h-100" data-cue="zoomIn" data-duration="500">
                                <div class="card-body p-5">
                                    <div class="d-lg-flex">
                                        <div class="p-3 icon-xl icon-shape rounded bg-opacity-10">
                                            <img src="assets/img/icones/divisao_de_seus_royalties.png" width="120"
                                                height="120" alt />
                                        </div>
                                        <div class="ms-lg-5 mt-4 mt-lg-0">
                                            <div class="mb-4">
                                                <h3>Transparência nos Royalties</h3>
                                                <ul class="list-group mb-2">
                                                    <li>- Divisão clara entre todos os envolvidos</li>
                                                    <li>- Relatórios mensais detalhados</li>
                                                    <li>
                                                        - Sistema anti-fraude para proteger seus direitos
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                        ...
                        <div class="text-center">
                            <p>
                                Junte-se a milhares de artistas que já transformaram suas
                                carreiras com a Wasom Upfy.
                            </p>
                            <a href="/wasomupfy/register?new_account"
                                class="btn btn-wasomupfy btn-lg w-100 py-3 d-flex align-items-center justify-content-center">Cadastra-se
                                agora</a>
                        </div>
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="p-4 p-lg-5">
                                <h2 class="display-5 fw-bold text-wasomupfy mb-2">157+</h2>
            ...
            <!--Porque escolher a Wasom Upfy? end-->
        </section>
        <!-- Nossa aéra do site, com as pequennas informações -->

        <!-- Músicas em Destaque -->
        <section class="bg-light-100 py-5 d-none">
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 col-md-12">
                        <div class="mb-5 mb-lg-0">
                            <h2 class="mb-2">Músicas em destaque esta semana</h2>
                            <p class="mb-3">
                                Ouça as faixas mais populares dos nossos artistas. Novos
                                lançamentos toda semana!
                            </p>
                            <div class="mb-4">
                                <span class="badge bg-warning me-2"><i class="bi bi-fire"></i> Trending</span>
                                <span class="badge bg-success"><i class="bi bi-music-note"></i> Novos Lançamentos</span>
                            </div>
                            <a href="/wasomupfy/register" class="btn btn-wasomupfy me-3" target="_blank"
                                rel="external">Aproveite
                                já</a>
                        </div>
                    </div>
                    <div class="col-lg-6 offset-lg-1 col-md-12 text-white">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive-lg">
                                    <div class="row g-5 flex-nowrap pb-4 pb-lg-0 me-5 me-lg-0">
                                        ...
                                        <article class="col-lg-4 col-md-6 col-12" data-cue="zoomIn">
                                            <figure class="mb-4 zoom-img position-relative">
                                                <a href="#!" class="d-block position-relative">
                                                    <img src="https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80"
                                                        alt="Capa Álbum Afrobeat" class="img-fluid rounded-3" />
                                                    <div class="position-absolute bottom-0 end-0 m-2">
                                                        <span class="badge bg-dark bg-opacity-75"><i
                                                                class="bi bi-usb-micro"></i> 45K plays</span>
                                                    </div>
                                                </a>
                                            </figure>
                                            <h3 class="my-3 lh-base h4">
                                                <a href="#!" class="text-muted text-decoration-none">Afro Vibes</a>
                                            </h3>
                                            <div class="d-flex align-items-center justify-content-between mb-3 mb-md-0">
                                                <div class="d-flex align-items-center">
                                                    <img src="https://images.unsplash.com/photo-1516280440614-37939bbacd81?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80"
                                                        alt="Artista Kiala" class="avatar avatar-xs rounded-circle" />
                                                    <div class="ms-2">
                                                        <a href="#" class="text-muted fs-6">Kiala Sounds</a>
                                                        <div class="text-muted small">Kizomba • 2024</div>
                                                    </div>
                                                </div>
                                        ...
                                        <article class="col-lg-4 col-md-6 col-12" data-cue="zoomIn">
                                            <figure class="mb-4 zoom-img position-relative">
                                                <a href="#!" class="d-block position-relative">
                                                    <img src="https://images.unsplash.com/photo-1511379938547-c1f69419868d?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80"
                                                        alt="Capa Álbum Semba" class="img-fluid rounded-3" />
                                                    <div class="position-absolute bottom-0 end-0 m-2">
                                                        <span class="badge bg-dark bg-opacity-75"><i
                                                                class="bi bi-usb-micro"></i> 32K plays</span>
                                                    </div>
                                                </a>
                                            </figure>
                                            <h3 class="my-3 lh-base h4">
                                                <a href="#!" class="text-muted text-decoration-none">Semba
                                                    Revolution</a>
                                            </h3>
                                            <div class="d-flex align-items-center justify-content-between mb-3 mb-md-0">
                                                <div class="d-flex align-items-center">
                                                    <img src="https://images.unsplash.com/photo-1494790108755-2616b612b786?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80"
                                                        alt="Artista Bonga" class="avatar avatar-xs rounded-circle" />
                                                    <div class="ms-2">
                                                        <a href="#" class="text-muted fs-6">Bonga NG</a>
                                                        <div class="text-muted small">Semba • 2024</div>
                                                    </div>
                                                </div>
                                                <span class="badge bg-warning"><i class="bi bi-fire"></i> Hot</span>
                                            </div>
                                        </article>
                                        ...
                                        <article class="col-lg-4 col-md-6 col-12" data-cue="zoomIn">
                                            <figure class="mb-4 zoom-img position-relative">
                                                <a href="#!" class="d-block position-relative">
                                                    <img src="https://images.unsplash.com/photo-1518609878373-06d740f60d8b?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80"
                                                        alt="Capa Álbum Hip Hop" class="img-fluid rounded-3" />
                                                    <div class="position-absolute bottom-0 end-0 m-2">
                                                        <span class="badge bg-dark bg-opacity-75"><i
                                                                class="bi bi-usb-micro"></i> 28K plays</span>
                                                    </div>
                                                </a>
                                            </figure>
                                            <h3 class="my-3 lh-base h4">
                                                <a href="#!" class="text-muted text-decoration-none">Luanda City</a>
                                            </h3>
                                            <div class="d-flex align-items-center justify-content-between mb-3 mb-md-0">
                                                <div class="d-flex align-items-center">
                                                    <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80"
                                                        alt="Artista MC Jó" class="avatar avatar-xs rounded-circle" />
                                                    <div class="ms-2">
                                                        <a href="#" class="text-muted fs-6">MC Jó</a>
                                                        <div class="text-muted small">Hip Hop • 2024</div>
                                                    </div>
                                                </div>
                                ...
                                <div class="table-responsive-lg mt-3">
                                    <div class="row g-5 flex-nowrap pb-4 pb-lg-0 me-5 me-lg-0">
                                        ...
                                        <article class="col-lg-4 col-md-6 col-12" data-cue="zoomIn">
                                            <figure class="mb-4 zoom-img position-relative">
                                                <a href="#!" class="d-block position-relative">
                                                    <img src="https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80"
                                                        alt="Capa Álbum Reggae" class="img-fluid rounded-3" />
                                                    <div class="position-absolute bottom-0 end-0 m-2">
                                                        <span class="badge bg-dark bg-opacity-75"><i
                                                                class="bi bi-usb-micro"></i> 25K plays</span>
                                                    </div>
                                                </a>
                                            </figure>
                                            <h3 class="my-3 lh-base h4">
                                                <a href="#!" class="text-muted text-decoration-none">One Love</a>
                                            </h3>
                                            <div class="d-flex align-items-center justify-content-between mb-3 mb-md-0">
                                                <div class="d-flex align-items-center">
                                                    <img src="https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80"
                                                        alt="Artista Ras Tafari"
                                                        class="avatar avatar-xs rounded-circle" />
                                                    <div class="ms-2">
                                                        <a href="#" class="text-muted fs-6">Ras Tafari</a>
                                                        <div class="text-muted small">Reggae • 2024</div>
                                                    </div>
                                                </div>
                                        ...
                                        <article class="col-lg-4 col-md-6 col-12" data-cue="zoomIn">
                                            <figure class="mb-4 zoom-img position-relative">
                                                <a href="#!" class="d-block position-relative">
                                                    <img src="https://images.unsplash.com/photo-1518609878373-06d740f60d8b?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80"
                                                        alt="Capa Álbum Gospel" class="img-fluid rounded-3" />
                                                    <div class="position-absolute bottom-0 end-0 m-2">
                                                        <span class="badge bg-dark bg-opacity-75"><i
                                                                class="bi bi-quote"></i> 18K plays</span>
                                                    </div>
                                                </a>
                                            </figure>
                                            <h3 class="my-3 lh-base h4">
                                                <a href="#!" class="text-muted text-decoration-none">Heaven's Sound</a>
                                            </h3>
                                            <div class="d-flex align-items-center justify-content-between mb-3 mb-md-0">
                                                <div class="d-flex align-items-center">
                                                    <img src="https://images.unsplash.com/photo-1494790108755-2616b612b786?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80"
                                                        alt="Artista Celeste" class="avatar avatar-xs rounded-circle" />
                                                    <div class="ms-2">
                                                        <a href="#" class="text-muted fs-6">Celeste</a>
                                                        <div class="text-muted small">Gospel • 2024</div>
                                                    </div>
                                                </div>
                                                <span class="badge bg-purple"><i class="bi bi-heart"></i> Viral</span>
                                            </div>
                                        </article>
                                        ...
                                        <article class="col-lg-4 col-md-6 col-12" data-cue="zoomIn">
                                            <figure class="mb-4 zoom-img position-relative">
                                                <a href="#!" class="d-block position-relative">
                                                    <img src="https://images.unsplash.com/photo-1511379938547-c1f69419868d?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80"
                                                        alt="Capa Álbum Pop" class="img-fluid rounded-3" />
                                                    <div class="position-absolute bottom-0 end-0 m-2">
                                                        <span class="badge bg-dark bg-opacity-75"><i
                                                                class="bi bi-usb-micro"></i> 22K plays</span>
                                                    </div>
                                                </a>
                                            </figure>
                                            <h3 class="my-3 lh-base h4">
                                                <a href="#!" class="text-muted text-decoration-none">Summer Vibes</a>
                                            </h3>
                                            <div class="d-flex align-items-center justify-content-between mb-3 mb-md-0">
                                                <div class="d-flex align-items-center">
                                                    <img src="https://images.unsplash.com/photo-1516280440614-37939bbacd81?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80"
                                                        alt="Artista Maya" class="avatar avatar-xs rounded-circle" />
                                                    <div class="ms-2">
                                                        <a href="#" class="text-muted fs-6">Maya Sounds</a>
                                                        <div class="text-muted small">Pop • 2024</div>
                                                    </div>
                                                </div>
                                                <span class="badge bg-warning"><i class="bi bi-top"></i> Top 10</span>
                                            </div>
                                        </article>
                                    </div>
                                </div>
            ...
            <div class="container">
                ...
                <div class="row justify-content-center mb-6">
                    <div class="col-lg-8 text-center">
                        ...
                        <p class="lead text-body mb-0">
                            Desde artistas iniciantes até selos estabelecidos. Encontre o
                            plano perfeito para suas necessidades.
                        </p>
                    </div>
                </div>
                ...
                <div class="row g-4 justify-content-center">
                        ...
                        <div class="card border-0 shadow-sm h-100 hover-lift">
                            <div class="card-body p-4">
                                ...
                                <div class="text-center mb-4">
                                    <span class="badge bg-light text-dark rounded-pill px-3 py-1 mb-3 d-inline-block">
                                        Iniciante
                                    </span>
                                    <h3 class="h4 mb-2 text-wasomupfy">Single</h3>
                                    <div class="d-flex align-items-baseline justify-content-center mb-3">
                                        <span class="h1 fw-bold text-wasomupfy mb-0">2.000</span>
                                        <span class="text-body ms-1">Kz/ano</span>
                                    </div>
                                    <div class="mb-4">
                                        <span class="text-success fw-semibold">90% Royalties</span>
                                ...
                                <ul class="list-unstyled mb-4">
                                    ...
                                    <li class="d-flex align-items-start mb-3">
                                        <i class="bi bi-check-circle-fill text-success me-2 mt-1"></i>
                                        <span>Análise de dados avançados</span>
                                    </li>
                                    <li class="d-flex align-items-start mb-3">
                                        <i class="bi bi-check-circle-fill text-success me-2 mt-1"></i>
                                        <span>ISRC e UPC grátis</span>
                                    </li>
                                    <li class="d-flex align-items-start mb-3">
                                        <i class="bi bi-check-circle-fill text-success me-2 mt-1"></i>
                                        <span>Smartlink e pre-salve</span>
                                    </li>
                                    <li class="d-flex align-items-start mb-3">
                                        <i class="bi bi-check-circle-fill text-success me-2 mt-1"></i>
                                        <span>Lançamento mais rápido possível a 72h</span>
                                    </li>
                                    <li class="d-flex align-items-start mb-3">
                                        <i class="bi bi-check-circle-fill text-success me-2 mt-1"></i>
                                    ...
                                    <li class="d-flex align-items-start mb-3">
                                        ...
                                        <span class="text-body">Personalizar nome de selo</span>
                                    </li>
                                </ul>

                                <!-- CTA -->
                                <div class="text-center mt-auto">
                                    <a href="/wasomupfy/register?plan=single" class="btn btn-outline-primary w-100">
                                        <i class="bi bi-cart-plus me-2"></i>
                                        Escolher Plano
                                    </a>
                                    <p class="text-body small mt-2 mb-0">
                    ...
                    <!-- Plano Album (Destaque) -->
                    <div class="col-xl-3 col-lg-6" data-cue="zoomIn" data-delay="100">
                        <div class="card border-2 border-wasomupfy shadow-lg h-100 hover-lift position-relative">
                            <!-- Badge Popular -->
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center mb-4 pt-3">
                                    <span
                                        class="badge bg-wasomupfy bg-opacity-10 text-wasomupfy rounded-pill px-3 py-1 mb-3 d-inline-block">
                                        Artista
                                    </span>
                                    <h3 class="h4 mb-2 text-wasomupfy">Álbum</h3>
                                    <div class="d-flex align-items-baseline justify-content-center mb-3">
                                        <span class="h1 fw-bold text-wasomupfy mb-0">5.000</span>
                                        <span class="text-body ms-1">Kz/ano</span>
                                    </div>
                                    <div class="mb-4">
                                        <span class="text-success fw-semibold">90% Royalties</span>
                                ...
                                <ul class="list-unstyled mb-4">
                                    ...
                                    <li class="d-flex align-items-start mb-3">
                                        <i class="bi bi-check-circle-fill text-success me-2 mt-1"></i>
                                        <span>Personalizar nome de selo</span>
                                    </li>
                                </ul>

                                <!-- CTA -->
                                <div class="text-center mt-auto">
                                    <a href="/wasomupfy/register?plan=album" class="btn btn-wasomupfy w-100 py-3">
                                        <i class="bi bi-lightning-charge-fill me-2"></i>
                                        Começar Agora
                                    </a>
                                    <p class="text-body small mt-2 mb-0">
                                        <i class="bi bi-shield-check text-success me-1"></i>
                                        Ideal para artistas independentes
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- Plano Artista -->
                    <div class="col-xl-3 col-lg-6" data-cue="zoomIn" data-delay="200">
                        <div class="card border-0 shadow-sm h-100 hover-lift">
                            <div class="card-body p-4">
                                <!-- Cabeçalho do Plano -->
                                <div class="text-center mb-4">
                                    <span
                                        class="badge bg-primary bg-opacity-10 text-primary rounded-pill px-3 py-1 mb-3 d-inline-block">
                                        Profissional
                                    </span>
                                    <h3 class="h4 mb-2 text-wasomupfy">Artista</h3>
                                    <div class="d-flex align-items-baseline justify-content-center mb-3">
                                        <span class="h1 fw-bold text-wasomupfy mb-0">11.400</span>
                                        <span class="text-body ms-1">Kz/ano</span>
                                    </div>
                                    <div class="mb-4">
                                        <span class="text-success fw-semibold">90% Royalties</span>
                                ...
                                <ul class="list-unstyled mb-4">
                                    <li class="d-flex align-items-start mb-3">
                                        <i class="bi bi-check-circle-fill text-success me-2 mt-1"></i>
                                        <span>Upload de faixas ilimitadas </span>
                                    </li>
                                    <li class="d-flex align-items-start mb-3">
                                        <i class="bi bi-check-circle-fill text-success me-2 mt-1"></i>
                                        <span>1 Artistas</span>
                                    </li>
                                    <li class="d-flex align-items-start mb-3">
                                        <i class="bi bi-check-circle-fill text-success me-2 mt-1"></i>
                                    ...
                                    <li class="d-flex align-items-start mb-3">
                                        <i class="bi bi-circle-fill text-success me-2 mt-1"></i>
                                        <span>Personalizar nome de selo</span>
                                    </li>
                                </ul>
                                ...
                                <!-- CTA -->
                                <div class="text-center mt-auto">
                                    <a href="/wasomupfy/register?plan=artist" class="btn btn-outline-primary w-100">
                                        <i class="bi bi-people-fill me-2"></i>
                                        Escolher Plano
                                    </a>
                                    <p class="text-body small mt-2 mb-0">
                                        Perfeito para produtores e managers
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- Plano Label -->
                    <div class="col-xl-3 col-lg-6" data-cue="zoomIn" data-delay="300">
                        <div class="card border-0 shadow-sm h-100 hover-lift">
                            <div class="card-body p-4">
                                <!-- Cabeçalho do Plano -->
                                <div class="text-center mb-4">
                                    <span
                                        class="badge bg-warning bg-opacity-10 text-warning rounded-pill px-3 py-1 mb-3 d-inline-block">
                                        Empresarial
                                    </span>
                                    <h3 class="h4 mb-2 text-wasomupfy">Label</h3>
                                    <div class="d-flex align-items-baseline justify-content-center mb-3">
                                        <span class="h1 fw-bold text-wasomupfy mb-0">70.000</span>
                                        <span class="text-body ms-1">Kz/ano</span>
                                    </div>
                                    <div class="mb-4">
                                        <span class="text-success fw-semibold">90% Royalties</span>
                                ...
                                <ul class="list-unstyled mb-4">
                                    ...
                                    <li class="d-flex align-items-start mb-3">
                                        <i class="bi bi-check-circle-fill text-success me-2 mt-1"></i>
                                        <span>Análise de dados avançados- ISRC e UPC grátis</span>
                                    </li>
                                    <li class="d-flex align-items-start mb-3">
                                        <i class="bi bi-check-circle-fill text-success me-2 mt-1"></i>
                                        <span>Smartlink e pre-salve</span>
                                    ...
                                    <li class="d-flex align-items-start mb-3">
                                        <i class="bi bi-circle-fill text-success me-2 mt-1"></i>
                                        <span>Sem lançamento obrigatório</span>
                                    </li>
                                </ul>

                                <!-- CTA -->
                                <div class="text-center mt-auto">
                                    <a href="/wasomupfy/register?plan=label" class="btn btn-outline-warning w-100">
                                        <i class="bi bi-handshake-fill me-2"></i>
                                        Tornar-se Parceiro
                                    </a>
                                    <p class="text-body small mt-2 mb-0">
                                        Para selos e gravadoras
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body p-4 p-lg-5">
                                <div class="text-center mb-4">
                                    ...
                                    <p class="text-body mb-0">
                                        Veja as principais diferenças entre os planos
                                    </p>
                                </div>
                                    ...
                                    <table class="table table-borderless mb-0">
                                        ...
                                        <tbody>
                                            <tr class="border-bottom">
                                                ...
                                                <td class="text-center text-success fw-bold">90%</td>
                                                <td class="text-center text-success fw-bold">90%</td>
                                                <td class="text-center">90%</td>
                                            </tr>
                                            <tr class="border-bottom">
                        ...
                        <div class="accordion" id="planosFAQ">
                            <div class="accordion-item border-0 mb-3">
                                ...
                                <div id="faq1" class="accordion-collapse collapse show" data-bs-parent="#planosFAQ">
                                    <div class="accordion-body">
                                        ...
                                        qualquer momento. A diferença de valor será ajustada
                                        proporcionalmente.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item border-0 mb-3">
                                ...
                                <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#planosFAQ">
                                    <div class="accordion-body">
                                        Os royalties são pagos mensalmente, diretamente na sua
                                        conta bancária. Você recebe relatórios detalhados de todas
                                        as streams e downloads.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item border-0">
                                ...
                                <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#planosFAQ">
                                    <div class="accordion-body">
                                        Não! Todos os planos oferecem lançamentos ilimitados. Você
                                        pode distribuir quantas músicas quiser durante a vigência
                                        do plano.
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card border-wasomupfy border-2 bg-wasomupfy bg-opacity-5">
                            <div class="card-body p-4 p-lg-5 text-center">
                                ...
                                <p class="text-body mb-4">
                                    Nossa equipe está pronta para ajudá-lo a escolher o plano
                                    ideal para sua carreira musical.
                                </p>
                                ...
                                <p class="text-body small mt-4 mb-0">
                                    ...
                                    * Impostos adicionais podem ser aplicados conforme a
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2 col-md-12">
                        <div class="text-center mb-5 mb-lg-5">
                            <span
                                class="badge bg-wasomupfy bg-opacity-10 text-wasomupfy rounded-pill px-4 py-2 mb-3 d-inline-block">
                                <i class="bi bi-globe2"></i> Plataformas de streamings & Wasom
                                Upfy
                            </span>
                            <h2 class="mt-4"></h2>
                            <p class="mb-0 px-xl-4">
                                Assine agora e você terá as suas músicas em mais de
                                <span class="text-wasomupfy">157 plataformas</span> digitais
                                como Spotify, Apple Music, Amazon Music, Tiktok, Instagram
                                entre outras.
                            </p>
                        </div>
                    </div>
                ...
                <div class="marquee" style="height: 92px">
                    <div class="track py-3">
                        <a href="#!" class="btn btn-icon btn-lg shadow-sm mx-2 btn-lift">
                            <i class="fa-brands fa-spotify fs-1 text-success"></i>
                        </a>

                        <a href="#!" class="btn btn-icon btn-lg shadow-sm mx-2 btn-lift">
                            <i class="fa-brands fa-apple fs-1 text-danger"></i>
                        </a>

                        <a href="#!" class="btn btn-icon btn-lg shadow-sm mx-2 btn-lift">
                            <i class="fa-brands fa-amazon fs-1 text-info"></i>
                        </a>

                        <a href="#!" class="btn btn-icon btn-lg shadow-sm mx-2 btn-lift">
                            <i class="fa-brands fa-youtube fs-1 text-danger"></i>
                        </a>

                        <a href="#!" class="btn btn-icon btn-lg shadow-sm mx-2 btn-lift">
                            <i class="fa-brands fa-deezer fs-1 text-dark"></i>
                        </a>
                        ...
                        <a href="#!" class="btn btn-icon btn-lg shadow-sm mx-2 btn-lift">
                            <i class="fa-brands fa-tiktok fs-1 text-dark"></i>
                        </a>

                        <a href="#!" class="btn btn-icon btn-lg shadow-sm mx-2 btn-lift">
                            <i class="fa-brands fa-instagram fs-1 text-danger"></i>
                        </a>

                        <a href="#!" class="btn btn-icon btn-lg shadow-sm mx-2 btn-lift">
                            <i class="fa-brands fa-facebook fs-1 text-primary"></i>
                        </a>

                        <a href="#!" class="btn btn-icon btn-lg shadow-sm mx-2 btn-lift">
                            <i class="fa-brands fa-snapchat fs-1 text-warning"></i>
                        </a>

                        <a href="#!" class="btn btn-icon btn-lg shadow-sm mx-2 btn-lift">
                            <i class="fa-brands fa-twitch fs-1 text-primary"></i>
                        </a>

                        <a href="#!" class="btn btn-icon btn-lg shadow-sm mx-2 btn-lift">
                            <i class="fa-solid fa-bolt-lightning fs-1 text-info"></i>
                        </a>

                        <a href="#!" class="btn btn-icon btn-lg shadow-sm mx-2 btn-lift">
                            <i class="fa-brands fa-soundcloud fs-1 text-warning"></i>
                        </a>

                        <a href="#!" class="btn btn-icon btn-lg shadow-sm mx-2 btn-lift">
                            <i class="fa-solid fa-p fs-1 text-primary"></i>
                        </a>

                        <a href="#!" class="btn btn-icon btn-lg shadow-sm mx-2 btn-lift">
                            <i class="fa-solid fa-play fs-1 text-warning"></i>
                        </a>

                        <a href="#!" class="btn btn-icon btn-lg shadow-sm mx-2 btn-lift">
                            <i class="fa-solid fa-compact-disc fs-1 text-muted"></i>
                        </a>

                        <a href="#!" class="btn btn-icon btn-lg shadow-sm mx-2 btn-lift">
                            <i class="fa-brands fa-vimeo-v fs-1 text-info"></i>
                        </a>

                        <a href="#!" class="btn btn-icon btn-lg shadow-sm mx-2 btn-lift">
                            <i class="fa-brands fa-pinterest fs-1 text-danger"></i>
                        </a>

                        <a href="#!" class="btn btn-icon btn-lg shadow-sm mx-2 btn-lift">
                            <i class="fa-brands fa-napster fs-1 text-dark"></i>
                        </a>

                        <a href="#!" class="btn btn-icon btn-lg shadow-sm mx-2 btn-lift">
                            <i class="fa-brands fa-discord fs-1 text-primary"></i>
                        </a>

                        <a href="#!" class="btn btn-icon btn-lg shadow-sm mx-2 btn-lift">
                            <i class="fa-brands fa-telegram fs-1 text-info"></i>
                        </a>

                        <i class="fa-brands fa-line fs-1 text-success"></i>
                        <a href="#!" class="btn btn-icon btn-lg shadow-sm mx-2 btn-lift">
                        </a>

                        <a href="#!" class="btn btn-icon btn-lg shadow-sm mx-2 btn-lift">
                            <i class="fa-brands fa-x-twitter fs-1 text-dark"></i>
                        </a>

                        <a href="#!" class="btn btn-icon btn-lg shadow-sm mx-2 btn-lift">
                            <i class="fa-brands fa-reddit-alien fs-1 text-warning"></i>
                        </a>

                        <a href="#!" class="btn btn-icon btn-lg shadow-sm mx-2 btn-lift">
                            <i class="fa-solid fa-record-vinyl fs-1 text-info"></i>
                        </a>

                        <a href="#!" class="btn btn-icon btn-lg shadow-sm mx-2 btn-lift">
                            <i class="fa-brands fa-lastfm fs-1 text-danger"></i>
                        </a>

                        <a href="#!" class="btn btn-icon btn-lg shadow-sm mx-2 btn-lift">
                            <i class="fa-brands fa-mixcloud fs-1 text-info"></i>
                        </a>

                        <a href="#!" class="btn btn-icon btn-lg shadow-sm mx-2 btn-lift">
                            <i class="fa-solid fa-wave-square fs-1 text-primary"></i>
                        </a>
                        ...
                        <a href="#!" class="btn btn-icon btn-lg shadow-sm mx-2 btn-lift">
                            <i class="fa-solid fa-globe fs-1 text-muted"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="row mt-4">
                    <div class="col-lg-12">
                        <div class="text-center mt-lg-6">
                            <a href="/wasomupfy/register" title="Inscreva-se agora" target="_blank"
                                class="btn btn-wasomupfy btn-lg px-5 py-3 hover-scale-x-105 icon-link icon-link-hover">Inscreve-se
                                agora</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="container" data-cue="fadeIn">
                ...
                <div class="row justify-content-center mb-6">
                    <div class="col-lg-8 text-center">
                        ...
                        <p class="lead text-body mb-0">
                            Artistas reais, resultados reais. Descubra como a Wasom Upfy
                            transformou carreiras musicais.
                        </p>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="position-relative">
                            ...
                            <div class="d-flex justify-content-center gap-3 mb-4">
                                <button class="btn btn-outline-primary testimonial-prev">
                                    <i class="bi bi-chevron-left"></i>
                                </button>
                                <button class="btn btn-outline-primary testimonial-next">
                                    ...
                                    <div class="card border-0 shadow-sm h-100">
                                        <div class="card-body p-4 p-lg-5">
                                            <div class="mb-4">
                                                ...
                                                <p class="lead mb-0">
                                                    "Em apenas 1 mês na Wasom Upfy, minha música
                                                    alcançou 10x mais ouvintes do que em 2 anos tentando
                                                    sozinho! A distribuição global realmente funciona."
                                                </p>
                                            </div>
                                            <div class="d-flex align-items-center">
                                                <div class="position-relative">
                                                    <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Cristiano&backgroundColor=ff009d&eyes=wink&mouth=smile"
                                                        alt="Cristiano Amadeu"
                                                        class="avatar avatar-lg rounded-circle" />
                                                    <div
                                                        class="position-absolute bottom-0 end-0 bg-wasomupfy text-white rounded-circle p-1">
                                                ...
                                                <div class="ms-3">
                                                    ...
                                                    <p class="text-body-secondary mb-1 small">
                                                        Artista Album • Afrobeat
                                                    </p>
                                                    <div class="d-flex align-items-center small">
                                                        <i class="bi bi-spotify text-success me-1"></i>
                                                        <span class="text-body-secondary">+45K streams mensais</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body p-4 p-lg-5">
                                            <div class="mb-4">
                                                <div class="d-flex align-items-center mb-3">
                                                    ...
                                                    <span class="badge bg-info bg-opacity-10 text-info ms-3">
                                                        <i class="bi bi-graph-up me-1"></i>
                                                        Crescendo
                                                    </span>
                                                </div>
                                                <p class="lead mb-0">
                                                    "Os relatórios detalhados da Wasom Upfy me ajudaram
                                                    a entender meu público e planejar minha turnê
                                                    virtual. Finalmente vejo para onde minha música está
                                                    indo!"
                                                </p>
                                            </div>
                                            <div class="d-flex align-items-center">
                                                <div class="position-relative">
                                                    <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=José&backgroundColor=1db954&eyes=happy&mouth=smile"
                                                        alt="José Mbenga" class="avatar avatar-lg rounded-circle" />
                                                    <div
                                                ...
                                                <div class="ms-3">
                                                    <h5 class="mb-1 fw-bold text-muted">José Mbenga</h5>
                                                    <p class="text-body-secondary mb-1 small">
                                                        Produtor • Semba
                                                    </p>
                                                    <div class="d-flex align-items-center small">
                                                        <i class="bi bi-youtube text-danger me-1"></i>
                                                        <span class="text-body-secondary">+32K views no YouTube</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body p-4 p-lg-5">
                                            <div class="mb-4">
                                                <div class="d-flex align-items-center mb-3">
                                                    ...
                                                    <span class="badge bg-purple bg-opacity-10 text-white ms-3">
                                                        <i class="bi bi-currency-dollar me-1"></i>
                                                        Royalties
                                                    </span>
                                                </div>
                                                <p class="lead mb-0">
                                                    "Finalmente recebi meus primeiros royalties
                                                    internacionais com total transparência! A Wasom Upfy
                                                    cuida de tudo enquanto eu foco na música."
                                                </p>
                                            </div>
                                            <div class="d-flex align-items-center">
                                                <div class="position-relative">
                                                    <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Bruna&backgroundColor=9146ff&eyes=surprised&mouth=twinkle"
                                                        alt="Bruna Silva" class="avatar avatar-lg rounded-circle" />
                                                    <div
                                                        class="position-absolute bottom-0 end-0 bg-purple text-white rounded-circle p-1">
                                                        <i class="bi bi-cash-stack"></i>
                                                    </div>
                                                </div>
                                                <div class="ms-3">
                                                    <h5 class="mb-1 fw-bold text-muted">Bruna Silva</h5>
                                                    <p class="text-body-secondary mb-1 small">
                                                        Cantora • Pop
                                                    </p>
                                                    <div class="d-flex align-items-center small">
                                                        <i class="bi bi-tiktok text-black me-1"></i>
                                                        <span class="text-body-secondary">Viral no TikTok</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body p-4 p-lg-5">
                                            <div class="mb-4">
                                                <div class="d-flex align-items-center mb-3">
                                                    ...
                                                    <span class="badge bg-warning bg-opacity-10 text-warning ms-3">
                                                        <i class="bi bi-rocket-takeoff me-1"></i>
                                                        Lançamento
                                                    </span>
                                                </div>
                                                <p class="lead mb-0">
                                                    "Meu single foi para o ar em menos de 24 horas e já
                                                    está em todas as plataformas. A velocidade da Wasom
                                                    Upfy é impressionante!"
                                                </p>
                                            </div>
                                            <div class="d-flex align-items-center">
                                                <div class="position-relative">
                                                    <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Pedro&backgroundColor=ff9900&eyes=default&mouth=smile"
                                                        alt="Pedro Santos" class="avatar avatar-lg rounded-circle" />
                                                    <div
                                                        class="position-absolute bottom-0 end-0 bg-warning text-white rounded-circle p-1">
                                                ...
                                                <div class="ms-3">
                                                    ...
                                                    <div class="d-flex align-items-center small">
                                                        <i class="bi bi-apple text-dark me-1"></i>
                                                        <span class="text-body-secondary">#2 em playlists Apple
                                                            Music</span>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="card-body p-4 p-lg-5">
                                <div class="row align-items-center">
                                    <div class="col-lg-6 mb-4 mb-lg-0">
                                        ...
                                        <p class="50 mb-0">
                                            Nossos artistas já alcançaram marcas impressionantes com
                                            a Wasom Upfy.
                                        </p>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="row text-center">
                                            ...
                                            <div class="col-6 col-md-3 mb-3">
                                                <div class="h2 fw-bold text-wasomupfy mb-1 counter_ws"
                                                    data-valor="5000000" data-tipo="moeda">
                                                    0
                                                </div>
                    ...
                    <div class="col-lg-4" data-cue="zoomIn">
                        <div class="card border-0 shadow-sm h-100 hover-lift">
                            <div class="card-body p-4">
                                ...
                                <p class="mb-4">
                                    "O suporte da Wasom Upfy é excepcional. Eles realmente se
                                    importam com o sucesso dos artistas."
                                </p>
                                <div class="d-flex align-items-center">
                                    <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Maria&backgroundColor=e4405f&eyes=wink&mouth=smile"
                                        alt="Maria Costa" class="avatar avatar-md rounded-circle me-3" />
                                    <div>
                                        <h6 class="mb-0 fw-semibold text-muted">Maria Costa</h6>
                                        <span class="text-body-secondary small">Plano Manager</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4" data-cue="zoomIn" data-delay="100">
                        <div class="card border-0 shadow-sm h-100 hover-lift">
                            <div class="card-body p-4">
                                ...
                                <p class="mb-4">
                                    "As ferramentas de promoção são incríveis. Minha música
                                    apareceu em playlists que eu nem imaginava!"
                                </p>
                                <div class="d-flex align-items-center">
                                    <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Rafael&backgroundColor=0088ff&eyes=default&mouth=smile"
                                        alt="Rafael Lima" class="avatar avatar-md rounded-circle me-3" />
                                    <div>
                                        <h6 class="mb-0 fw-semibold text-muted">Rafael Lima</h6>
                                        <span class="text-body-secondary small">Artista Album</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4" data-cue="zoomIn" data-delay="200">
                        <div class="card border-0 shadow-sm h-100 hover-lift">
                            <div class="card-body p-4">
                                ...
                                <p class="mb-4">
                                    "Transparência total nos pagamentos. Finalmente uma
                                    plataforma que respeita os artistas."
                                </p>
                                <div class="d-flex align-items-center">
                                    <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Ana&backgroundColor=00a8e1&eyes=happy&mouth=smile"
                                        alt="Ana Santos" class="avatar avatar-md rounded-circle me-3" />
                                    <div>
                                        <h6 class="mb-0 fw-semibold text-muted">Ana Santos</h6>
                                        <span class="text-body-secondary small">Produtora Musical</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-7 mb-5 mb-lg-0" data-cue="slideInLeft">
                        <div class="mb-5">
                            ...
                            <h2 class="display-5 fw-bold text-dark mb-4">
                                Transformando sonhos em realidade musical
                            </h2>
                            <p class="lead text-body mb-4">
                                Somos a ponte que conecta talentos africanos ao mercado
                                musical global. Da sua cidade natal para o mundo, com
                                tecnologia e paixão pela música.
                            </p>
                        </div>
                        ...
                        <div class="row g-4 mb-5">
                            <div class="col-6 col-md-3">
                                <div class="text-center">
                                    <div class="h2 fw-bold text-wasomupfy mb-2">2022</div>
                                    <div class="text-body small">Fundação</div>
                                </div>
                            </div>
                            <div class="col-6 col-md-3">
                                <div class="text-center">
                                    <div class="h2 fw-bold text-wasomupfy mb-2 counter_ws" data-valor="1500"
                                        data-tipo="contagem">
                                        0
                                    </div>
                                    <div class="text-body small">Artistas</div>
                                </div>
                            </div>
                            <div class="col-6 col-md-3">
                                <div class="text-center">
                                    <div class="h2 fw-bold text-wasomupfy mb-2 counter_ws" data-valor="157"
                                        data-tipo="contagem">
                                        0
                                    </div>
                                    <div class="text-body small">Plataformas</div>
                                </div>
                            </div>
                            <div class="col-6 col-md-3">
                                <div class="text-center">
                                    <div class="h2 fw-bold text-wasomupfy mb-2 counter_ws" data-valor="50000000"
                                        data-tipo="contagem">
                                        0
                                    </div>
                                    <div class="text-body small">Streams</div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="d-flex align-items-start mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-body mb-0">
                                            Democratizar o acesso ao mercado musical global para
                                            artistas independentes de Angola e África Lusófona.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="d-flex align-items-start mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-body mb-0">
                                            Ser a principal plataforma de distribuição digital para
                                            artistas africanos até 2030.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body p-4 p-lg-5">
                                ...
                                <div class="text-center mb-4">
                                    <div class="position-relative mb-4">
                                        <img src="https://media.licdn.com/dms/image/v2/D4D0BAQEZT7NgIGnmIg/img-crop_100/B4DZowkXkgG8AM-/0/1761751438182?e=2147483647&v=beta&t=oTDWQM3hF58kZey3ykwyIuBBzYmvgTBXIkxGwrcsfbs"
                                            alt="Wasom Music Group"
                                    ...
                                    <div class="d-flex justify-content-center gap-2 mb-3">
                                        <a href="https://www.linkedin.com/in/wasom-music-group" target="_blank"
                                ...
                                <div class="text-center mb-4">
                                    ...
                                    <p class="fst-italic mb-0">
                                        "Acreditamos que todo artista tem uma voz que merece ser
                                        ouvida. Nossa missão é amplificar essas vozes."
                                    </p>
                                </div>
                                ...
                                <div class="border-top pt-4">
                                    <div class="row text-center">
                                        <div class="col-6">
                                            <div class="h5 fw-bold text-wasomupfy mb-1">Luanda</div>
                                            <div class="text-body-secondary small">
                                                Sede Principal
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="h5 fw-bold text-wasomupfy mb-1">Angola</div>
                ...
                <div class="row mt-6 pt-5 border-top" data-cue="fadeIn">
                    <div class="col-12">
                        <div class="text-center mb-5">
                            ...
                            <p class="lead text-body mb-0">
                                Soluções completas para artistas independentes
                            </p>
                        </div>
                        ...
                        <div class="row g-4">
                                ...
                                <div class="card border-0 shadow-sm h-100 hover-lift">
                                    <div class="card-body p-4 p-lg-5">
                                        <div class="icon-shape icon-lg bg-wasomupfy bg-opacity-10 rounded-3 p-3 mb-4">
                                            <i class="bi bi-globe-americas text-wasomupfy fs-2"></i>
                                        </div>
                                        <h4 class="h5 mb-3">Distribuição Digital Global</h4>
                                        <p class="text-body mb-4">
                                            Sua música em todas as principais plataformas de
                                            streaming mundial.
                                        </p>
                                        <ul class="list-unstyled mb-0">
                                            <li class="d-flex align-items-start mb-2">
                                                <i class="bi bi-check-circle-fill text-success me-2 mt-1"></i>
                                                <span>Spotify, Apple Music, Deezer</span>
                                            </li>
                                            <li class="d-flex align-items-start mb-2">
                                                <i class="bi bi-check-circle-fill text-success me-2 mt-1"></i>
                                            ...
                                            <li class="d-flex align-items-start">
                                                <i class="bi bi-check-circle-fill text-success me-2 mt-1"></i>
                                                <span>+150 serviços globais</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="card border-0 shadow-sm h-100 hover-lift">
                                    <div class="card-body p-4 p-lg-5">
                                        <div class="icon-shape icon-lg bg-wasomupfy bg-opacity-10 rounded-3 p-3 mb-4">
                                            <i class="bi bi-megaphone-fill text-wasomupfy fs-2"></i>
                                        </div>
                                        <h4 class="h5 mb-3">Marketing Musical Estratégico</h4>
                                        <p class="text-body mb-4">
                                            Promoção inteligente para maximizar o alcance da sua
                                            música.
                                        </p>
                                        <ul class="list-unstyled mb-0">
                                            <li class="d-flex align-items-start mb-2">
                                                <i class="bi bi-check-circle-fill text-success me-2 mt-1"></i>
                                                <span>Campanhas segmentadas</span>
                                            </li>
                                            <li class="d-flex align-items-start mb-2">
                                                <i class="bi bi-check-circle-fill text-success me-2 mt-1"></i>
                                                <span>Inclusão em playlists</span>
                                            </li>
                                            <li class="d-flex align-items-start">
                                                <i class="bi bi-check-circle-fill text-success me-2 mt-1"></i>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="card border-0 shadow-sm h-100 hover-lift">
                                    <div class="card-body p-4 p-lg-5">
                                        <div class="icon-shape icon-lg bg-wasomupfy bg-opacity-10 rounded-3 p-3 mb-4">
                                            <i class="bi bi-bar-chart-fill text-wasomupfy fs-2"></i>
                                        </div>
                                        <h4 class="h5 mb-3">Análise e Relatórios</h4>
                                        <p class="text-body mb-4">
                                            Dados detalhados para tomar decisões estratégicas
                                            informadas.
                                        </p>
                                        <ul class="list-unstyled mb-0">
                                            <li class="d-flex align-items-start mb-2">
                            ...
                            <div class="card-body p-4 p-lg-5 text-center">
                                <div class="row align-items-center">
                                    <div class="col-lg-8 mb-4 mb-lg-0 text-lg-start">
                                        ...
                                        <p class="text-body mb-0">
                                            Junte-se à família Wasom Upfy e alcance novos patamares
                                            na sua jornada musical.
                                        </p>
                                    </div>
                                    <div class="col-lg-4">
        ...
        <div class="divider-fade"></div>
        <!--Area de suporte, sugestoes e ajuda-->
                                ...
                                <div class="container">
                                    <div class="row align-items-center g-5">
                                        <div class="col-lg-5 col-12" data-cue="slideInLeft">
                                            <div class="mb-3">
                                                <h2 class="mt-0">
                                                    Seja bem-vindo a nossa área de Suporte
                                                </h2>
                                                <i class="fa-solid fa-headset text-dark mb-3"
                                                    style="font-size: 80px"></i>
                                                <p class="text-dark lead">
                                                    Preencha os campos abaixo conforme sua necessidade:
                                                </p>
                                            </div>
                                            <div class="mb-6">
                                                <ul class="list-unstyled mb-0">
                                                    <li class="d-flex mb-3">
                                                        ...
                                                        <span class="ms-2">
                                                            <span class="text-dark fw-semibold">Compromisso:</span>
                                                            Solicitar acordo formal ou relatório de entrega.
                                                        </span>
                                                    </li>
                                                    <li class="d-flex mb-3">
                                                        <span><i
                                                                class="fa-solid fa-circle-check text-wasomupfy text-opacity-50"></i></span>
                                                        <span class="ms-2">
                                                            <span class="text-dark fw-semibold">Denúncia:</span>
                                                            Reportar problemas técnicos ou violações de uso.
                                                        </span>
                                                    </li>
                                                    <li class="d-flex mb-3">
                                                        <span><i
                                                                class="fa-solid fa-circle-check text-wasomupfy text-opacity-50"></i></span>
                                                        <span class="ms-2">
                                                            <span class="text-dark fw-semibold">Feedback:</span>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="col-md-12 m-auto text-left pt-3">
                                                            <form action method="post" class="row g-3 needs-validation"
                                                                novalidate accept-charset="utf-8" id="caixa-sms">
                                                                <div class="col-md-6">
                                                                    <label for="name_user"
                                                                        class="form-label text-dark-form text-left">Nome
                                                                        Completo
                                                                        <span
                                                                            class="text-danger text-xs">*</span></label>
                                                                    <input type="text" minlength="8" maxlength="25"
                                                                        placeholder="Insira o seu nome completo"
                                                                        class="form-control" autocomplete="name"
                                                                        id="name_user" name="name" required />
                                                                    <div class="valid-feedback"></div>
                                                                    <div class="invalid-feedback">
                                                                        <span class="text-base">Qual é o seu nome
                                                                            completo?</span>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <label for="tel_user"
                                                                        ...
                                                                        Telefone
                                                                        <span class="text-muted opacity-8 hit">
                                                                            (opcional)</span></label>
                                                                    <input type="tel" maxlength="18"
                                                                        placeholder="Insira o seu número de telefone"
                                                                        class="form-control"
                                                                        autocomplete="tel-country-code" id="tel_user"
                                                                        name="tel" list="tele" />
                                                                    <datalist id="tele">
                                                                        <div class="select">
                                                                            <select name="Codigo telefonico" id="ct">
                                                                                <optgroup label="Selecione codigo">
                                                                                    <option value="+93">
                                                                                        Afeganistão
                                                                                    </option>
                                                                                    <option value="+27">
                                                                                    ...
                                                                                    <option value="+591">
                                                                                        Bolívia e Herzegovina
                                                                                    </option>
                                                                                    <option value="+387">Bósnia</option>
                                                                                    <option value="+267">
                                                                                        Botsuana
                                                                                    </option>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <label for="email_user"
                                                                        class="form-label text-dark-form">E-mail
                                                                        <span class="text-danger text-xs">*</span>
                                                                        <span class="text-muted opacity-8 hit">
                                                                            (Insira um e-mail que
                                                                            útiliza)</span></label>
                                                                    <input type="email" maxlength="60"
                                                                        placeholder="usuario@exemplo.com"
                                                                        class="form-control" autocomplete="email"
                                                                        id="email_user" required name="email" />
                                                                    <div class="valid-feedback">
                                                                        <span class="text-base">E-mail válido.</span>
                                                                    </div>
                                                                    <div class="invalid-feedback">
                                                                        <span class="text-base">Insira um e-mail
                                                                            válido!</span>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12">
                                                                    <label for="newlleter"
                                                                        class="form-label text-dark-form">Assunto
                                                                        <span
                                                                            class="text-danger text-xs">*</span></label>
                                                                    <input type="text" maxlength="60" minlength="8"
                                                                        placeholder="Insira o seu assunto"
                                                                        class="form-control" autocomplete="on"
                                                                        id="newlleter" required name="newlleter" />
                                                                    <div class="valid-feedback"></div>
                                                                    <div class="invalid-feedback">
                                                                        <span class="text-base">Qual é o Assunto?</span>
                                                                    </div>
                                                                </div>

                                                                <div class="col-md-12">
                                                                    <label for="sms"
                                                                        class="form-label text-dark-form">Mensagem
                                                                        <span
                                                                            class="text-danger text-xs">*</span></label>
                                                                    <textarea name="sms" id="sms" required cols="30"
                                                                        class="form-control" autocomplete="on"
                                                                        maxlength="400" rows="5"
                                                                        placeholder="Escreva a sua mensagem aqui!"></textarea>
                                                                    <div class="valid-feedback"></div>
                                                                    <div class="invalid-feedback">
                                                                        <span class="text-base">Por favor, escreva a sua
                                                                            mensagem!</span>
                                                                    </div>
                                                                </div>
                                ...
                                <div class="container">
                                    <div class="row align-items-center g-5">
                                        <div class="col-lg-5 col-12" data-cue="slideInLeft">
                                            <div class="mb-3">
                                                <h2 class="mt-0">
                                                    Seja bem-vindo a nossa área de Sugestões
                                                </h2>
                                                <i class="fa-solid fa-lightbulb text-dark mb-3"
                                                    style="font-size: 80px"></i>
                                                <p class="text-dark lead">
                                                    Ajude-nos a melhorar! Deixe sua sugestão abaixo:
                                                </p>
                                            </div>
                                            <div class="mb-6">
                                                <ul class="list-unstyled mb-0">
                                                    <li class="d-flex mb-3">
                                                        <span><i
                                                                class="fa-solid fa-circle-check text-wasomupfy text-opacity-50"></i></span>
                                                        <span class="ms-2">
                                                            <span class="text-dark fw-semibold">Melhorias:</span>
                                                            O que podemos aprimorar em nossos serviços?
                                                        </span>
                                                    </li>
                                                    <li class="d-flex mb-3">
                                                        <span><i
                                                                class="fa-solid fa-circle-check text-wasomupfy text-opacity-50"></i></span>
                                                        <span class="ms-2">
                                                            <span class="text-dark fw-semibold">Suporte:</span>
                                                            Como podemos te atender melhor?
                                                        </span>
                                                    </li>
                                                    <li class="d-flex mb-3">
                                                        <span><i
                                                                class="fa-solid fa-circle-check text-wasomupfy text-opacity-50"></i></span>
                                                        <span class="ms-2">
                                                            <span class="text-dark fw-semibold">Soluções:</span>
                                                            Ideias para novos recursos ou ferramentas.
                                                        </span>
                                                    </li>
                                                </ul>
                                            </div>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="col-md-12 m-auto text-left pt-3">
                                                            <form action method="post" class="row g-3 needs-validation"
                                                                novalidate accept-charset="utf-8" id="caixa-sms">
                                                                <div class="col-md-6">
                                                                    <label for="name_user_1_feed"
                                                                        class="form-label text-dark-form text-left">Primeiro
                                                                        nome
                                                                        <span
                                                                            class="text-danger text-xs">*</span></label>
                                                                    <input type="text" minlength="8" maxlength="25"
                                                                        ...
                                                                        class="form-control" autocomplete="name"
                                                                        id="name_user_1_feed" name="name_1_feed"
                                                                        required />
                                                                    <div class="valid-feedback"></div>
                                                                    <div class="invalid-feedback">
                                                                        <span class="text-base">Qual é o seu primeiro
                                                                            nome?</span>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <label for="name_user_2_feed"
                                                                        class="form-label text-dark-form text-left">Segundo
                                                                        nome
                                                                        <span class="text-muted opacity-8 hit">
                                                                            (opcional)</span></label>
                                                                    <input type="text" minlength="8" maxlength="25"
                                                                        ...
                                                                        class="form-control" autocomplete="name"
                                                                        id="name_user_2_feed" name="name_2_feed" />
                                                                    <div class="valid-feedback"></div>
                                                                </div>

                                                                <div class="col-md-12">
                                                                    <label for="newlleter_feed"
                                                                        class="form-label text-dark-form">Assunto
                                                                        <span
                                                                            class="text-danger text-xs">*</span></label>
                                                                    ...
                                                                    <input type="text" maxlength="60" minlength="8"
                                                                        placeholder="Insira o seu assunto"
                                                                        class="form-control" autocomplete="on"
                                                                        id="newlleter_feed" required name="newlleter" />
                                                                    <div class="valid-feedback"></div>
                                                                    <div class="invalid-feedback">
                                                                        <span class="text-base">Qual é o Assunto de
                                                                            sugestão?</span>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <label for="sms_feed"
                                                                        ...
                                                                        <span
                                                                            class="text-danger text-xs">*</span></label>
                                                                    <textarea name="sms_feed" id="sms_feed" required
                                                                        cols="30" class="form-control" autocomplete="on"
                                                                        maxlength="400" rows="5"
                                                                        placeholder="Escreva a sua mensagem aqui!"></textarea>
                                                                    <div class="valid-feedback"></div>
                                                                    <div class="invalid-feedback">
                                                                ...
                                                                <div class="col-12 mt-3">
                                                                    <button name="feed" class="btn btn-wasomupfy w-100"
                                                                        type="submit">
                                                                        Enviar mensagem
                                                                    </button>
                                                                    <div class="mt-1">
        ...
        <!--Area de suporte, sugestoes e ajuda fim-->

        <div class="divider-fade"></div>

        <!-- Comunidade Wasom Upfy -->
            ...
            <div class="container position-relative z-1">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 mb-5 mb-lg-0" data-cue="slideInLeft">
                        <div class="mb-4">
                            ...
                            <p class="lead mb-4">
                                Conecte-se com outros artistas, receba insights valiosos e
                                acelere sua carreira musical com nossa comunidade ativa.
                            </p>
                        </div>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-6">
                                <div class="d-flex align-items-center bg-white bg-opacity-10 rounded-3 p-3">
                                    <div class="icon-shape icon-sm bg-success rounded-2 p-2 me-3">
                                        <i class="bi bi-lightning-charge-fill text-success"></i>
                                    </div>
                                    <div>
                                        <h6 class="mb-0 small fw-semibold">Dicas Exclusivas</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="d-flex align-items-center bg-white bg-opacity-10 rounded-3 p-3">
                                    <div class="icon-shape icon-sm bg-warning rounded-2 p-2 me-3">
                                        <i class="bi bi-graph-up-arrow text-warning"></i>
                                    </div>
                                    <div>
                                        <h6 class="mb-0 small fw-semibold">Tendências</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="d-flex align-items-center bg-white bg-opacity-10 rounded-3 p-3">
                                    <div class="icon-shape icon-sm bg-info rounded-2 p-2 me-3">
                                        <i class="bi bi-tags-fill text-info"></i>
                                    </div>
                                    <div>
                                        <h6 class="mb-0 small fw-semibold">Ofertas Especiais</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="d-flex align-items-center bg-white bg-opacity-10 rounded-3 p-3">
                                    <div class="icon-shape icon-sm bg-purple rounded-2 p-2 me-3">
                                        <i class="bi bi-trophy-fill text-purple"></i>
                                    </div>
                                    <div>
                                        <h6 class="mb-0 small fw-semibold">Concursos</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card border-0 shadow-lg overflow-hidden">
                            <div class="card-body p-4 p-lg-5">
                                ...
                                <div class="text-center mb-4">
                                    ...
                                    <p class="text-body mb-0">
                                        Entre para o grupo exclusivo de artistas
                                    </p>
                                </div>
                                ...
                                <div class="mb-4">
                                    <div class="d-flex align-items-start mb-3">
                                        ...
                                        <div>
                                            <h6 class="mb-1 fw-semibold text-muted">
                                                Dicas Diárias de Promoção
                                            </h6>
                                            <p class="text-body small mb-0">
                                                Aprenda a promover sua música de forma eficiente
                                            </p>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-start mb-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-body small mb-0">
                                                Fique por dentro das novidades da indústria musical
                                            </p>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-start mb-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-body small mb-0">
                                                Acesso antecipado a concursos e colaborações
                                            </p>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-body small mb-0">
                                                Conecte-se com produtores e artistas da comunidade
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="text-body-secondary small mb-0">
                                        <i class="bi bi-info-circle me-1"></i>
                                        Clique no botão para ser redirecionado ao WhatsApp
                                    </p>
                                </div>
                            </div>
                ...
                <div class="row mt-6 border-top" data-cue="fadeIn">
                    <div class="col-lg-10 mx-auto">
                        <div class="text-center mb-4">
                            <h4 class="mb-3">Perguntas Frequentes</h4>
                            <p class="50 mb-0">Tire suas dúvidas sobre nossa comunidade</p>
                        </div>
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="bg-white bg-opacity-10 rounded-3 p-4 h-100">
                                    <h6 class="mb-2">
                                        <i class="bi bi-question-circle text-wasomupfy me-2"></i>
                                        O grupo é realmente gratuito?
                                    </h6>
                                    <p class="50 small mb-0">
                                        Sim! A comunidade WhatsApp é 100% gratuita para todos os
                                        artistas cadastrados na Wasom Upfy.
                                    </p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="bg-white bg-opacity-10 rounded-3 p-4 h-100">
                                    <h6 class="mb-2">
                                        <i class="bi bi-question-circle text-wasomupfy me-2"></i>
                                        Com que frequência recebo conteúdo?
                                    </h6>
                                    <p class="50 small mb-0">
                                        Enviamos dicas diárias, atualizações semanais do mercado e
                                        oportunidades mensais especiais.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="text-center">
                            <div class="d-flex align-items-center justify-content-center mb-3">
                                ...
                                <div class="text-start">
                                    ...
                                    <p class="50 mb-0">
                                        A comunidade está crescendo rapidamente
                                    </p>
                                </div>
                            </div>
                            <a href="https://whatsapp.com/channel/0029VaCEDqo59PwWpU0nGa04" target="_blank"
        ...
        <!-- Seccão de aderir ao grupo da pagina Wasom Upfy fim-->
    </main>
                ...
                <div class="row g-5" id="ft-links">
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <ul class="list-unstyled mb-0">
                            ...
                            <li class="mb-2">
                                <a href="about#nossamarca" class="text-reset text-decoration-none hover-white">A nossa
                                    marca
                                </a>
                            </li>
                            <li class="mb-2">
                            ...
                            <li class="mb-2">
                                <a href="page/services/customized-services"
                                    class="text-reset text-decoration-none hover-white">Serviços
                                    Premium</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <ul class="list-unstyled mb-0">
                            ...
                            <li class="mb-2">
                                <a href="page/support/help" class="text-reset text-decoration-none hover-white">
                                    Ajuda
                                </a>
                            </li>
                            <li class="mb-2">
        ...
        <div class="cookie-alert-content">
            <div class="cookie-alert-header">
                <h3 id="cookie-alert-title" class="cookie-alert-title">
                    <i data-feather="cookie" aria-hidden="true"></i>
                    Uso de Cookies
                </h3>
            ...
            <div class="cookie-alert-body">
                <p id="cookie-alert-description" class="cookie-alert-text">
                    A Wasom Upfy utiliza cookies e tecnologias similares para melhorar
                    sua experiência de navegação, personalizar conteúdo e anúncios,
                    fornecer recursos de mídia social e analisar nosso tráfego. Ao
                    clicar em "Aceitar todos", você concorda com o uso de todos os
                    cookies.
                </p>
                ...
                <div class="cookie-alert-actions">
                    <button type="button" class="btn btn-outline-light cookie-alert-btn" id="reject-cookies">
                        Rejeitar todos
                    </button>
                    <button type="button" class="btn btn-primary cookie-alert-btn" id="accept-cookies">
                        Aceitar todos
                    </button>
                </div>
            </div>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            let currentIndex = 0;
            const itemWidth = items[0].offsetWidth + 24; // Largura do item + gap
