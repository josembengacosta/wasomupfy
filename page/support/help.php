...
<head>
  ...
  <meta name="keywords"
    content="Ajuda sobre a plataforma Wasom Upfy, incluindo cadastro de artistas, estatísticas e suporte." />
  ...
  <meta property="og:title" content="Wasom Upfy - Ajuda." />
...
<body>
                    ...
                    <div class="col">
                      <div class="mt-3 mt-lg-0">
                        <div>
                          ...
                          <a title="Ajuda" class="dropdown-item active" href="../support/help">Ajuda
                            <span class="badge bg-success">Novo</span></a>
  ...
  <main>
    ...
    <section class="tutorial-hero jarallax position-relative overflow-hidden py-5" data-jarallax data-speed="0.4">
      <img class="jarallax-img" src="../../assets/img/theme/help.png" alt="Tutorial Wasom Upfy" loading="lazy" />
          ...
          <div class="col-xl-8 col-lg-10 text-center" data-cue="fadeIn">
            ...
            <div class="position-relative mb-3">
              <div class="search-container position-relative">
                ...
                <!-- Sugestões de busca (aparece ao digitar) -->
                <div id="searchSuggestions" class="search-suggestions bg-white rounded-3 shadow-lg mt-2 p-2 d-none">
                  <div class="suggestion-item p-2">
                    <i class="fa-regular fa-file-audio me-2 text-wasomupfy"></i>
                    Formato de áudio aceito
                  </div>
                  <div class="suggestion-item p-2">
                    <i class="fa-regular fa-circle-dollar me-2 text-wasomupfy"></i>
                    Como receber meus royalties
                  </div>
                  <div class="suggestion-item p-2">
            ...
            <p class="text-white-stable opacity-90 small">
              Busque por tópicos ou navegue pelas categorias abaixo.
            </p>
            <!-- Tags populares -->
        ...
        <div class="row g-4 justify-content-center">
          ...
          <div class="col-lg-3 col-md-6" data-cue="zoomIn" data-delay="100">
            <a href="#financeiro"
              ...
              <div class="card-body">
                <div class="icon-shape icon-lg bg-light-success text-success rounded-circle mb-3 mx-auto">
          ...
          <div class="col-lg-3 col-md-6" data-cue="zoomIn" data-delay="300">
            <a href="#promocao"
              ...
              <div class="card-body">
                <div class="icon-shape icon-lg bg-light-warning text-warning rounded-circle mb-3 mx-auto">
          ...
          <div class="col-12">
            <div class="d-flex flex-wrap justify-content-center gap-2">
              ...
              <a href="#!" class="badge bg-wasomupfy border py-2 px-3 rounded-pill text-decoration-none">
                <i class="fa-regular fa-circle-play me-1"></i> Vídeos
                Tutoriais
              </a>
              <a href="#!" class="badge bg-wasomupfy border py-2 px-3 rounded-pill text-decoration-none">
    ...
    <!-- Seção de Artigos com Accordion Melhorado -->
              ...
              <div class="card border-0 shadow-sm p-3">
                ...
                <div class="nav flex-column nav-pills">
                  <a class="nav-link active py-2 px-3 rounded-3 mb-1" href="#distribuicao">
                    <i class="fa-regular fa-circle-check me-2 text-wasomupfy"></i>
                    Distribuição
                    <span class="badge bg-wasomupfy bg-opacity-10 text-wasomupfy float-end">12</span>
                  </a>
                  ...
                  <a class="nav-link py-2 px-3 rounded-3 mb-1" href="#promocao">
                    <i class="fa-regular fa-circle-check me-2 text-wasomupfy"></i>
                    Marketing
                    <span class="badge bg-wasomupfy bg-opacity-10 text-wasomupfy float-end">11</span>
                  </a>
                ...
                <div class="p-3 rounded-3">
                  ...
                  <p class="small text-muted mb-2">
                    Nossa equipe responde em até 2h
                  </p>
                  <a href="#" class="btn btn-sm btn-wasomupfy w-100">
          ...
          <div class="col-lg-9">
            ...
            <div class="d-flex align-items-center mb-4">
              ...
              <div class="btn-group" role="group">
                <button type="button" class="btn btn-outline-wasomupfy btn-sm active">
                  Todos
                </button>
                <button type="button" class="btn btn-outline-wasomupfy btn-sm">
                  Mais Vistos
                </button>
                <button type="button" class="btn btn-outline-wasomupfy btn-sm">
                  Recentes
            ...
            <!-- Seção Distribuição -->
            <div id="distribuicao" class="mb-5 scroll-margin-top-100 category-section" data-category="distribuicao">
              <div class="d-flex align-items-center mb-4">
              ...
              <div class="accordion accordion-flush shadow-sm rounded-3 overflow-hidden" id="accordionDistro">
                <!-- Item 1 - Formato de Áudio (expandido) -->
                <div class="accordion-item search-item border-bottom">
                  <h2 class="accordion-header">
                    <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse"
                      data-bs-target="#distro1">
                      <i class="fa-regular fa-circle-question me-2 text-wasomupfy"></i>
                      Qual o formato de áudio aceito?
                    </button>
                  </h2>
                  <div id="distro1" class="accordion-collapse collapse" data-bs-parent="#accordionDistro">
                    <div class="accordion-body">
                        ...
                        <div class="col-md-8">
                          ...
                          <ul class="list-unstyled">
                            <li class="mb-2">
                              ...
                              <strong>WAV estéreo</strong> (recomendado)
                            </li>
                            <li class="mb-2">
                              <i class="fa-regular fa-circle-check text-success me-2"></i>
                              <strong>16-bit ou 24-bit</strong>
                            </li>
                            <li class="mb-2">
                              <i class="fa-regular fa-circle-check text-success me-2"></i>
                              <strong>44.1kHz</strong> (taxa de amostragem)
                            </li>
                            <li class="mb-2">
                              <i class="fa-regular fa-circle-xmark text-danger me-2"></i>
                              <strong>MP3, AAC, OGG</strong> (não aceitos)
                            </li>
                          </ul>
                        </div>
                        <div class="col-md-4">
                          <div class="bg-light p-3 rounded-3">
                            <p class="small text-muted mb-2">
                              <i class="fa-regular fa-lightbulb text-warning me-1"></i>
                              Dica Profissional:
                            </p>
                            <p class="small mb-0">
                              Se sua música tem muitos graves, opte por 24-bit
                      ...
                      <div class="alert alert-wasomupfy mt-3 mb-0">
                        <i class="fa-regular fa-circle-info me-2"></i>
                        Use nosso
                        <a href="#" class="fw-bold text-wasomupfy">verificador de arquivos</a>
                        antes do upload
                      </div>
                    </div>
                  </div>
                ...
                <!-- Item 2 - Arte da Capa (com exemplo visual) -->
                <div class="accordion-item search-item border-bottom">
                  <h2 class="accordion-header">
                    <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse"
                      data-bs-target="#distro2">
                      <i class="fa-regular fa-image me-2 text-wasomupfy"></i>
                      Requisitos da Arte da Capa
                    </button>
                  </h2>
                  <div id="distro2" class="accordion-collapse collapse" data-bs-parent="#accordionDistro">
                    <div class="accordion-body">
                      <div class="row">
                        <div class="col-md-7">
                          ...
                          <ul>
                            ...
                            <li>
                              Tamanho mínimo:
                              <strong>3000 x 3000 pixels</strong>
                            </li>
                            <li>Modo de cor: <strong>RGB</strong></li>
                            <li>
                              Qualidade: <strong>Alta, sem artefatos</strong>
                            </li>
                          </ul>
                          <div class="bg-danger bg-opacity-10 p-3 rounded-3">
                            <p class="text-danger mb-0">
                              <i class="fa-solid fa-triangle-exclamation me-2"></i>
                              <strong>Proibido:</strong> logotipos de redes
                              sociais, marcas d'água, preços, QR codes,
                        ...
                        <div class="col-md-5">
                          <div class="border rounded-3 p-2">
                            <img src="../../assets/img/theme/capa-exemplo.jpg" alt="Exemplo de capa"
                              class="img-fluid rounded-2" />
                            <p class="small text-muted mt-2 mb-0 text-center">
                              Exemplo de capa aprovada
                            </p>
                          </div>
                        </div>
                      </div>
                ...
                <!-- Item 3 - Prazos (com timeline) -->
                <div class="accordion-item search-item border-bottom">
                  <h2 class="accordion-header">
                    <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse"
                      data-bs-target="#distro3">
                      <i class="fa-regular fa-clock me-2 text-wasomupfy"></i>
                      Prazos de Distribuição
                    </button>
                  </h2>
                  <div id="distro3" class="accordion-collapse collapse" data-bs-parent="#accordionDistro">
                    <div class="accordion-body">
                      <div class="timeline-steps">
                        <div class="row">
                          <div class="col-4 text-center">
                            <div class="step-circle bg-wasomupfy text-white">
                              1
                            </div>
                ...
                <div class="accordion-item search-item border-bottom">
                  <h2 class="accordion-header">
                    <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse"
                      data-bs-target="#distro4">
                      <i class="fa-regular fa-store me-2 text-wasomupfy"></i>
                      Para quais lojas distribuímos?
                    </button>
                  </h2>
                  <div id="distro4" class="accordion-collapse collapse" data-bs-parent="#accordionDistro">
                    <div class="accordion-body">
                      <div class="row">
                        <div class="col-6 col-md-4 mb-3">
                          <div class="d-flex align-items-center">
                            <i class="fa-brands fa-spotify text-success fs-5 me-2"></i>
                            <span>Spotify</span>
                          </div>
                        </div>
                        <div class="col-6 col-md-4 mb-3">
                          <div class="d-flex align-items-center">
                            <i class="fa-brands fa-apple text-dark fs-5 me-2"></i>
                            <span>Apple Music</span>
                          </div>
                        </div>
                        <div class="col-6 col-md-4 mb-3">
                          <div class="d-flex align-items-center">
                            <i class="fa-brands fa-deezer text-warning fs-5 me-2"></i>
                            <span>Deezer</span>
                          </div>
                        </div>
                        <div class="col-6 col-md-4 mb-3">
                          <div class="d-flex align-items-center">
                            <i class="fa-brands fa-tiktok text-dark fs-5 me-2"></i>
                            <span>TikTok</span>
                          </div>
                        </div>
                        <div class="col-6 col-md-4 mb-3">
                          <div class="d-flex align-items-center">
                            <i class="fa-brands fa-amazon text-warning fs-5 me-2"></i>
                            <span>Amazon Music</span>
                          </div>
                        </div>
                        <div class="col-6 col-md-4 mb-3">
                          <div class="d-flex align-items-center">
                            <i class="fa-solid fa-music text-primary fs-5 me-2"></i>
                            <span>TIDAL</span>
                          </div>
                        </div>
                      </div>
                      <p class="small text-muted mb-0">
                        + 150 lojas parceiras em todo mundo
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div class="text-end mt-2">
                <a href="#" class="text-wasomupfy text-decoration-none">
            ...
            <!-- Seção Financeiro -->
            <div id="financeiro" class="mb-5 scroll-margin-top-100 category-section" data-category="financeiro">
              <div class="d-flex align-items-center mb-4">
              ...
              <div class="accordion accordion-flush shadow-sm rounded-3 overflow-hidden" id="accordionFinance">
                <!-- Itens financeiros... (similar ao anterior com mais detalhes) -->
                <div class="accordion-item search-item border-bottom">
                  <h2 class="accordion-header">
                    <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse"
                      data-bs-target="#fin1">
                      <i class="fa-regular fa-percent me-2 text-wasomupfy"></i>
                      Qual a porcentagem de royalties que eu recebo?
                    </button>
                  </h2>
                  <div id="fin1" class="accordion-collapse collapse" data-bs-parent="#accordionFinance">
                    <div class="accordion-body">
                      <div class="text-center mb-4">
                        <div class="display-3 fw-bold text-wasomupfy">
                          90%
                        </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="bg-light p-3 rounded-3">
                            <p class="fw-bold mb-2">
                              <i class="fa-regular fa-check-circle text-success me-2"></i>Incluso:
                            </p>
                            <ul class="small">
                        ...
                        <div class="col-md-6">
                          <div class="bg-light p-3 rounded-3">
                            <p class="fw-bold mb-2">
                              <i class="fa-regular fa-clock text-warning me-2"></i>Os 10% cobrem:
                            </p>
                            <ul class="small">
                ...
                <div class="accordion-item search-item border-bottom">
                  ...
                  <div id="fin2" class="accordion-collapse collapse" data-bs-parent="#accordionFinance">
                    <div class="accordion-body">
            ...
            <div id="conta" class="mb-5 scroll-margin-top-100">
              ...
              <div class="accordion accordion-flush shadow-sm rounded-3 overflow-hidden" id="accordionAccount">
                <div class="accordion-item search-item">
                  <h2 class="accordion-header">
                    <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse"
                      data-bs-target="#acc1">
                      <i class="fa-solid fa-gear me-2 text-wasomupfy"></i>Como
                      verificar meu perfil no Spotify (S4A)?
                    </button>
                  </h2>
                  <div id="acc1" class="accordion-collapse collapse" data-bs-parent="#accordionAccount">
                    <div class="accordion-body text-muted">
                      Após seu primeiro lançamento estar online, você pode
                      reivindicar seu perfil no
                      <a href="https://artists.spotify.com" target="_blank">Spotify for Artists</a>. Se precisar de
                      acesso rápido antes do lançamento
                      (Instant Access), entre em contato com nosso suporte
                ...
                <div class="accordion-item search-item">
                  <h2 class="accordion-header">
                    <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse"
                      data-bs-target="#acc2">
                      <i class="fa-solid fa-lock me-2 text-wasomupfy"></i>Esqueci minha senha, o que fazer?
                    </button>
                  </h2>
                  <div id="acc2" class="accordion-collapse collapse" data-bs-parent="#accordionAccount">
                    <div class="accordion-body text-muted">
                      Na tela de login, clique em "Esqueci a Senha".
                      Enviaremos um link de redefinição segura para o seu
                      e-mail cadastrado.
                    </div>
                  </div>
                </div>
            ...
            <div id="promocao" class="mb-5 scroll-margin-top-100">
              ...
              <div class="accordion accordion-flush shadow-sm rounded-3 overflow-hidden" id="accordionMarketing">
                <!-- Item 1 - Playlists -->
                <div class="accordion-item">
                  <h2 class="accordion-header">
                    <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse"
                      data-bs-target="#mkt1">
                      <i class="fa-solid fa-music me-2 text-wasomupfy"></i>
                      Como ser incluído em playlists?
                    </button>
                  </h2>
                  <div id="mkt1" class="accordion-collapse collapse" data-bs-parent="#accordionMarketing">
                    <div class="accordion-body">
                      <p>
                        Faça pitching diretamente pelo painel com até 4
                        semanas de antecedência. Inclua informações sobre
                        gênero, mood e instrumentos.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header">
                    <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse"
                      data-bs-target="#mkt2">
                      <i class="fa-solid fa-chart-line me-2 text-wasomupfy"></i>
                      Posso fazer anúncios?
                    </button>
                  </h2>
                  <div id="mkt2" class="accordion-collapse collapse" data-bs-parent="#accordionMarketing">
                    <div class="accordion-body">
                      <p>
                        Não, oferecemos integração com Facebook/Instagram Ads
          ...
          <div class="col-md-6 col-lg-3">
            <div class="card h-100 border-0 shadow-sm hover-lift">
              <div class="card-body">
                ...
                <p class="small text-muted mb-0">
                  Sim, desde que possua a licença mecânica necessária. Entre
          ...
          <div class="col-md-6 col-lg-3">
            <div class="card h-100 border-0 shadow-sm hover-lift">
              <div class="card-body">
                ...
                <p class="small text-muted mb-0">
                  Após aprovado, não é possível editar. Cancele e faça um novo
                  upload com as correções.
                </p>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-3">
            <div class="card h-100 border-0 shadow-sm hover-lift">
              <div class="card-body">
                ...
                <p class="small text-muted mb-0">
                  Solicite a remoção pelo painel. O processo leva de 2 a 5
                  dias úteis em todas as lojas.
                </p>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-3">
            <div class="card h-100 border-0 shadow-sm hover-lift">
              <div class="card-body">
                ...
                <p class="small text-muted mb-0">
                  Sim, escolha a data no upload. Recomendamos 2-3 semanas de
                  antecedência para melhor performance.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-8">
              ...
              <div class="col-md-4">
                <div class="card border-0 shadow-sm h-100">
                  <div class="card-body">
                    ...
                    <a href="#" class="btn btn-sm btn-outline-wasomupfy w-100">Iniciar Chat</a>
                  </div>
                </div>
              </div>
              <div class="col-md-4">
                <div class="card border-0 shadow-sm h-100">
                  <div class="card-body">
                    ...
                    <a href="mailto:suporte@wasomupfy.com" class="small text-wasomupfy">suporte@wasomupfy.com</a>
                    <a href="#" class="btn btn-sm btn-outline-wasomupfy w-100 mt-3">Enviar Email</a>
                  </div>
                </div>
              </div>
              <div class="col-md-4">
                <div class="card border-0 shadow-sm h-100">
                  <div class="card-body">
                    ...
                    <a href="https://wa.me/244923456789" class="btn btn-sm btn-success w-100">
                      <i class="fa-brands fa-whatsapp me-2"></i> +244 923 456
                      789
                    </a>
                  </div>
                </div>
            ...
            <div class="p-5 rounded-4">
              ...
              <p class="mb-4 opacity-90">
                ...
                crescer sua carreira musical.
              </p>
              <div class="d-flex justify-content-center gap-3 flex-wrap">
                <a href="contact?assunto=suporte" class="btn btn-wasomupfy rounded-pill px-5 py-3 fw-bold shadow-lg">
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      const accordionItems = document.querySelectorAll(".search-item");
