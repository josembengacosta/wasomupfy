...
<head>
    ...
    <link rel="stylesheet" href="<?php echo APP_URL  ?>/css/faq-web.css" />
</head>
...
<body data-base-path="../..">
                ...
                <div class="offcanvas offcanvas-start offcanvas-nav" style="width: 20rem">
                    ...
                    <div class="offcanvas-body pt-0 align-items-center">
                        ...
                        <div class="mt-3 mt-lg-0 d-flex align-items-center">
                            ...
                            <?php if ($canRegister): ?>
                            <a title="Sign-up" href="<?php echo APP_URL  ?>/register"
                                class="btn btn-wasomupfy">Inscreva-se</a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                    ...
                    <section class="faq-content fade-in-custom">
                        ...
                        <div class="faq-item visible" id="faq1" data-category="conta">
                            ...
                            <div class="answer" id="faq1-answer" data-i18n="faq1_answer">
                                Aceda a <a href="<?php echo APP_URL  ?>/register"
    ...
    <script src="<?php echo APP_URL  ?>/js/faq.js"></script>
