...
<head>
    ...
    <meta name="keywords"
        content="Tutorial sobre a plataforma Wasom Upfy, incluindo cadastro de artistas, estatísticas e suporte." />
    ...
    <meta property="og:title" content="Wasom Upfy - Tutorial." />
    ...
    <title> Wasom Upfy | Tutorial</title>
...
<body>
    ...
    <header>
        <nav class="navbar navbar-expand-lg transparent navbar-transparent navbar-dark">
            <div class="container px-3">
                <a class="navbar-brand" href="../../home" title="Home"><img
                        src="../../assets/img/brand/wasomupfy_brand.png" width="65" class="img-logo" height="60"
                ...
                <div class="offcanvas offcanvas-start offcanvas-nav" style="width: 20rem">
                    <div class="offcanvas-header">
                        <a title="Home" href="../../home"><img width="65"
                                src="../../assets/img/brand/wasomupfy_brand.png" alt="Logo Wasom Upfy" /></a>
                        ...
                        <ul class="navbar-nav mx-auto align-items-lg-center">
                            ...
                            <li class="nav-item dropdown">
                                <a title="Páginas" class="nav-link active" href="#" role="button"
                                    data-bs-toggle="dropdown" aria-expanded="false">Páginas <i
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a title="Caixa de mensagem" class="dropdown-item" href="../../contact">
                                            Caixa de
                                            mensagem</a>
                                    </li>
    ...
    <main>
        ...
        <section class="tutorial-hero jarallax position-relative overflow-hidden py-5" data-jarallax data-speed="0.4">
            <img class="jarallax-img" src="../../assets/img/theme/tutorial.png" alt="Tutorial Wasom Upfy"
                loading="lazy" />
                ...
                <div class="row justify-content-center text-center">
                    <div class="col-xl-8 col-lg-10 text-center" data-cue="fadeIn">
                        ...
                        <p class="lead text-white-stable mb-4 opacity-90">
                            Encontre guia para desclarecer as tuas dúvidas da plataforma Wasom Upfy. Não encontrou o que
                            procurava? Entre em contato com nosso <a href="faq" title="Suporte"
                                class="text-secondary">suporte</a>!</p>
            ...
            <div class="container">
                <div class="row justify-content-center mb-6">
                    <div class="col-lg-7 text-center" data-cue="fadeIn">
                        <h2 class="mb-3">Como começar a distribuir sua música</h2>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6 col-lg-4" data-cue="slideInUp">
                        <div class="card border-0 shadow-sm h-100 p-4 btn-lift">
                            ...
                            <p class="text-muted">Evite rejeições: saiba as dimensões exatas e o que não pode conter na
                    ...
                    <div class="col-md-6 col-lg-4" data-cue="slideInUp">
                        <div class="card border-0 shadow-sm h-100 p-4 btn-lift">
                            ...
                            <p class="text-muted">Como preencher corretamente o nome dos compositores, produtores e
                    ...
                    <div class="col-md-6 col-lg-4" data-cue="slideInUp">
                        <div class="card border-0 shadow-sm h-100 p-4 btn-lift">
                            ...
                            <p class="text-muted">Dicas para enviar sua música para as playlists editoriais do Spotify e
                                Apple Music.</p>
                            <a href="#!" class="text-wasomupfy fw-bold mt-auto">Ler mais <i
                                    class="fa-solid fa-chevron-right ms-1 small"></i></a>
                        </div>
                    ...
                    <div class="col-lg-5 mb-5 mb-lg-0" data-cue="fadeIn">
                        <div class="mb-4">
                            ...
                            <p class="lead text-muted">
                                Preparamos um vídeo completo que mostra desde o login até a confirmação do envio do seu
                                Single ou Álbum.
                            </p>
                        </div>
                        ...
                        <div class="position-relative">
                            <div class="rounded-3 shadow-lg overflow-hidden position-relative">
                                ...
                                <a class="position-absolute top-50 start-50 translate-middle"
                                    href="https://www.youtube.com/watch?v=SEU_VIDEO_AQUI" data-fancybox>
                                    <div
                ...
                <div class="row justify-content-center text-center">
                    <div class="col-lg-8" data-cue="zoomIn">
                        ...
                        <p class="text-white-stable fs-4 mb-5">
                            Agora que você já sabe como funciona, não deixe sua música guardada na gaveta.
                        </p>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="tutorialModalLabel" data-i18n="tutorial_modal_title">Tutorial Wasom Upfy
                    </h5>
    ...
    <!-- MODAL - Adicione antes do fechamento do body ou após o main -->
                ...
                <div class="row g-5" id="ft-links">
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <ul class="list-unstyled mb-0">
                            ...
                            <li class="mb-2">
                                <a href="../../plan/all-plans"
                                    class="text-reset text-decoration-none hover-white">Planos
                                </a>
                            </li>
                            <li class="mb-2">
                                <a href="../services/customized-services"
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <ul class="list-unstyled mb-0">
                            ...
                            <li class="mb-2">
                                <a href="../../page/support/help"
                                    class="text-reset text-decoration-none hover-white">Ajuda
                                </a>
                            </li>
                            <li class="mb-2">
