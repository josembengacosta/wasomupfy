...
<head>
  ...
  <meta name="keywords"
    content="Wasom Upfy, Privacy, Políticas de privacidade, politicies, privacy politicies, Wasom Upfy Privacy, politicies wasom upfy" />
  ...
  <title>Wasom Upfy | Políticas de Privacidade</title>
  ...
  <link rel="stylesheet" href="../../css/privacy.wp.css" />
...
<body>
  ...
  <main>
    <section class="privacy-hero jarallax position-relative overflow-hidden py-5" data-jarallax data-speed="0.4">
      <img class="jarallax-img" src="../../assets/img/theme/privacy.png" alt="Privacidade Wasom Upfy" loading="lazy" />
        ...
        <div class="row justify-content-center text-center">
          <div class="col-xl-8 col-lg-10 text-center" data-cue="fadeIn">
            ...
            <p class="lead text-white-stable mb-4 opacity-90">
              Esta Política de Privacidade explica como a Wasom Upfy coleta,
              usa, armazena e protege seus dados pessoais. Veja também nossos
    ...
    <section id="detalhes-privacidade" class="my-xl-4 py-2 bg-ligth-100">
      <div class="container mb-xl-3" data-cue="fadeIn">
        ...
        <div class="nav-index">
          <h3>Índice</h3>
          <ul>
            <li><a href="#section1">1. Dados Coletados</a></li>
            <li><a href="#section2">2. Uso dos Dados</a></li>
            <li><a href="#section3">3. Armazenamento e Segurança</a></li>
            <li><a href="#section4">4. Compartilhamento de Dados</a></li>
            <li><a href="#section5">5. Seus Direitos</a></li>
            <li><a href="#section6">6. Segurança dos Dados</a></li>
            <li>
              <a href="#section7">7. Uso de Cookies e Tecnologias de Rastreamento</a>
            </li>
            <li><a href="#section8">8. Alterações nesta Política</a></li>
            <li><a href="#section9">9. Contato</a></li>
          </ul>
        </div>

        <div class="privacy-content">
          <div class="scroll-hint">
            <i class="bi bi-arrow-down"></i> Role até o final para entender
            nossa política.
          </div>
          ...
          <div class="privacy-section" id="section1">
            ...
            <ul class="list-group mb-2">
              ...
              <li class="list-inline-item">
                - Dados bancários para pagamento de royalties e transferências
              </li>
              <li class="list-inline-item">
                - Outras informações necessárias para identificar o usuário e
                proteger a plataforma
              </li>
            </ul>
            <p>
              Esses dados são coletados no momento do cadastro ou ao longo do
              uso da plataforma.
            </p>
          </div>
          ...
          <div class="privacy-section" id="section2">
            ...
            <ul class="list-group mb-2">
              ...
              <li class="list-inline-item">
                - Envio de comunicações, como newsletters e atualizações.
              </li>
              <li class="list-inline-item">
                - Análise de uso da plataforma, para melhorar a experiência do
                usuário.
              </li>
              <li class="list-inline-item">
          ...
          <div class="privacy-section" id="section3">
            ...
            <p>
              ...
              criptografia. Mantemos medidas de proteção contra acesso não
              autorizado, mas não podemos garantir segurança absoluta.
            </p>
          </div>
          ...
          <div class="privacy-section" id="section4">
            ...
            <p>
              Podemos compartilhar dados com autoridades legais sob ordem
              judicial ou para proteger os direitos da Wasom Upfy. Não
              realizamos compartilhamento comercial.
            </p>
          </div>
          ...
          <div class="privacy-section" id="section5">
            ...
            <p>
              ...
              de seus dados. Entre em contato pelo
              <a href="../../../support/support" class="text-wasomupfy">suporte</a>
          ...
          <div class="privacy-section" id="section6">
            ...
            <p>
              A Wasom Upfy utiliza diversas medidas de segurança para proteger
              os dados pessoais de seus usuários, incluindo:
            </p>
            <ul class="list-group mb-2">
              <li class="list-inline-item">
              ...
              <li class="list-inline-item">
                - Inativação de contas suspeitas de violar nossas políticas.
              </li>
              <li class="list-inline-item">
                - As contas solicitadas para exclusão serão recuperáveis por
                até 29 dias úteis; após esse período, serão permanentemente
                excluídas.
              </li>
            </ul>
          </div>
          ...
          <div class="privacy-section" id="section7">
            <h2>7. Uso de Cookies e Tecnologias de Rastreamento</h2>
            <p>
              A Wasom Upfy utiliza cookies e tecnologias de rastreamento para
              personalizar a experiência do usuário e coletar informações
              sobre como a plataforma é utilizada. Os cookies nos ajudam a:
            </p>
            <ul class="list-group mb-2">
              <li class="list-inline-item">
            ...
            <p>
              Os usuários podem optar por desativar os cookies diretamente nas
              configurações do navegador, mas isso pode afetar o funcionamento
          ...
          <div class="privacy-section" id="section8">
            ...
            <p>
              A Wasom Upfy reserva-se o direito de modificar esta Política de
              Privacidade a qualquer momento. Notificaremos os usuários sobre
              quaisquer alterações por meio da plataforma ou por e-mail.
            </p>
          </div>
          ...
          <div class="privacy-section" id="section9">
            <h2>9. Contato</h2>
            <p>
              Para dúvidas sobre esta política, entre em contato com nossa
              equipe de suporte através da página
              <a href="../../../support/support" class="text-wasomupfy">Enviar Pedido de Suporte</a>.
            </p>
          </div>
        </div>
      </div>
