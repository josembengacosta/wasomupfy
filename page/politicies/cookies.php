...
<head>
  ...
  <meta name="keywords" content="Wasom Upfy, Wasom, Upfy, Cookies, terms user, terms" />
  ...
  <meta property="og:title" content="Wasom Upfy - Cookies." />
  ...
  <title>Wasom Upfy | Cookies</title>
  ...
  <link rel="stylesheet" href="../../css/terms.wp.css" />
...
<body>
  ...
  <main>
    <section class="cookies-hero jarallax position-relative overflow-hidden py-5" data-jarallax data-speed="0.4">
      <img class="jarallax-img" src="../../assets/img/theme/cookies.png" alt="Cookies Wasom Upfy" loading="lazy" />
        ...
        <div class="row justify-content-center text-center">
          <div class="col-xl-8 col-lg-10 text-center" data-cue="fadeIn">
            ...
            <a href="#detalhes-privacidade" class="btn btn-wasomupfy btn-lg mt-2 smooth-scroll">
              Explorar a política <i class="fa-solid fa-arrow-down ms-2"></i>
            </a>
          </div>
        </div>
      </div>
        ...
        <div class="terms-content">
          ...
          <div class="term-section" id="section10">
            ...
            <p>
              ...
              <a href="../support/support" class="text-muted">Enviar Pedido de Suporte</a>.
            </p>
          </div>
        </div>
      </div>
