...
$modeConfig = [
    'free_analysis' => [
        ...
        'form_title' => 'Solicitar análise gratuita',
        'btn_label' => 'Solicitar Análise',
        'btn_icon' => 'fa-solid fa-paper-plane',
        'has_links' => true,
        'has_budget' => false,
        'has_date' => false,
        'has_meeting' => false,
    ...
    'consultant_initial' => [
        ...
        'form_title' => 'Falar com consultor — Impulso Single',
        'btn_label' => 'Enviar Pedido',
        'btn_icon' => 'fa-solid fa-paper-plane',
        'has_links' => true,
        'has_budget' => true,
        'has_date' => false,
    ...
    'consultant_talk' => [
        'badge' => 'Campanha 360°',
        'badge_cls' => 'bg-wasomupfy text-white',
        ...
        'form_title' => 'Agendar consulta — Campanha 360°',
        'btn_label' => 'Agendar Consulta',
        'btn_icon' => 'fa-solid fa-calendar-check',
        'has_links' => true,
        'has_budget' => true,
        'has_date' => true,
        'has_meeting' => false,
    ...
    'meeting_schedule' => [
        ...
        'form_title' => 'Agendar reunião executiva',
        'btn_label' => 'Confirmar Agendamento',
        'btn_icon' => 'fa-solid fa-calendar-check',
        'has_links' => false,
        'has_budget' => true,
        'has_date' => true,
    ...
    'general' => [
        ...
        'form_title' => 'Envia-nos uma mensagem',
                            ...
                            <form id="serviceContactForm" novalidate class="needs-validation">
                                ...
                                <div class="mb-4">
                                    <label for="fc_message" class="form-label fw-semibold small">
                                        <?php $msgLabels = ['free_analysis' => 'Conta-nos sobre a tua música', 'consultant_initial' => 'Objectivos e contexto', 'consultant_talk' => 'Objectivos da campanha', 'meeting_schedule' => 'Contexto da Label', 'general' => 'Mensagem'];
                                        echo $msgLabels[$mode]; ?>
                                    </label>
