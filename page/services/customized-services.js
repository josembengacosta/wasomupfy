document.addEventListener("DOMContentLoaded", function () {
  ...
  const publishingData = {
    ...
    descricao:
      "Maximize seus ganhos com direitos autorais e licenciamento sincronizado para filmes, TV e publicidade.",
    icone: "fa-music",
    ...
    passoAPasso: [
      {
        ...
        descricao:
          "Em Portugal: SPA (Sociedade Portuguesa de Autores). No Brasil: ECAD via UBC, ABRAMUS, etc.",
        detalhes:
          "Você precisa ser associado a uma sociedade para registrar suas composições.",
      },
      {
      ...
      },
      {
        ...
        descricao:
          "Informe exatamente a porcentagem de cada compositor e editora (se houver).",
        detalhes: "Use o contrato de parceria para documentar essas divisões.",
      },
      {
        titulo: "4. Monitore execuções públicas",
        descricao:
          "Sua sociedade coleta dados de rádio, TV, shows e estabelecimentos comerciais.",
    ...
    syncInfo: {
      ...
      descricao:
        "É a autorização para usar sua música junto com imagens: filmes, séries, comerciais, games, etc.",
      tipos: [
        {
          meio: "Cinema",
    ...
    faq: [
      {
        ...
        resposta:
          "Sim! Suas músicas podem tocar em rádio, TV, academias, restaurantes - todos geram royalties de execução pública que você só recebe se tiver publishing registrado.",
      },
      {
        pergunta: "Quanto custa registrar uma obra?",
        resposta:
          "Na maioria das sociedades, a filiação é gratuita e o registro tem um custo simbólico (€5-€10 por música) ou é incluso na anuidade.",
      },
      {
        pergunta: "Posso ter publishing internacional?",
        resposta:
          "Sim. Sociedades têm acordos recíprocos. Se sua música tocar nos EUA, sua sociedade portuguesa recebe e repassa para você.",
      },
      {
        pergunta: "Como encontro oportunidades de Sync?",
        resposta:
          "Através de editoras musicais, bibliotecas de música (Music Libraries) ou agências especializadas em licensing.",
      },
    ],
                ...
                <div class="accordion" id="accordionPublishing">
                    ...
                    <div class="accordion-item border-0 mb-3 shadow-sm">
                        ...
                        <div id="collapseSociedades" class="accordion-collapse collapse" data-bs-parent="#accordionPublishing">
                            <div class="accordion-body">
                                <div class="row">
                                    ${Object.entries(data.sociedades)
                                      .map(
                                        ([pais, socs]) => `
  ...
  document.querySelectorAll("a.btn-link.text-wasomupfy").forEach((link) => {
    if (link.textContent.trim() === "Saber mais sobre Publishing") {
      link.addEventListener("click", function (e) {
        ...
        document.getElementById("modalPublishingBody").innerHTML =
          gerarModalPublishing();

        // Abre o modal
        const modal = new bootstrap.Modal(
          document.getElementById("modalPublishing")
        );
        modal.show();
      });
    }
