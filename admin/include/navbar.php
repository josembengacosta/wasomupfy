    ...
    <div class="ms-auto d-flex align-items-center">
        ...
        <div class="dropdown me-2 position-relative">
            ...
            <ul class="dropdown-menu dropdown-menu-start p-0" style="min-width:260px">
                ...
                <li>
                    <a class="dropdown-item p-2" href="<?php echo APP_URL; ?>/admin/releases/pending">
                ...
                <li>
                    <a class="dropdown-item p-2" href="<?php echo APP_URL; ?>/admin/finances/payments">
                ...
                <li>
                    <a class="dropdown-item p-2" href="<?php echo APP_URL; ?>/admin/support">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                <li>
                    <a class="dropdown-item<?php echo adm_is_active('profile'); ?>"
                        href="<?php echo APP_URL; ?>/admin/profile">
                ...
                <li>
                    <a class="dropdown-item<?php echo adm_is_active('settings'); ?>"
                        href="<?php echo APP_URL; ?>/admin/settings">
