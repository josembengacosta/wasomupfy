...
if (isAdminLoggedIn() && !isLockscreenActive()) adminRedirect('/admin');

$token = trim($_GET['token'] ?? '');
if (empty($token) || strlen($token) !== 64) adminRedirect('/admin/forgot-password', ['msg' => 'error']);

$admin_id = validateAdminResetToken($token);
if (!$admin_id) adminRedirect('/admin/forgot-password', ['msg' => 'expired']);
    ...
    <div class="auth-shell">
        ...
        <div class="auth-right">
            <div class="auth-form-wrap">
                ...
                <form method="POST" action="<?php echo APP_URL; ?>/admin/reset-password-process" id="frm" novalidate
                ...
                <div class="text-center mt-4 fu d6">
                    <a href="<?php echo APP_URL; ?>/admin/login"
