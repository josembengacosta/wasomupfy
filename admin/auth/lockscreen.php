...
$feedback = match($msg_type) {
    'wrong'  => ['type' => 'danger',  'icon' => 'bi-x-circle',
...
<body>
    ...
    <div class="lock-card">
        ...
        <!-- Formulário -->
        <form method="POST" action="<?php echo APP_URL; ?>/admin/lockscreen-process" id="form-lock" novalidate
        ...
        <!-- Logout -->
        <div class="fade-up delay-4">
            <a href="<?php echo APP_URL; ?>/admin/logout" class="lock-logout">
