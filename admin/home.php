                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start">
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="mb-0">
                                            <a href="<?php echo APP_URL; ?>/admin/users" class="card-link">Ver usuários
                                                <i class="bi bi-arrow-right"></i></a>
                                        </div>
                                    </div>
                                    <div class="d-inline-block ms-3">
                                        <div class="stat">
                                            <a href="<?php echo APP_URL; ?>/admin/users" title="Ver usuários"><i
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start">
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="mb-0">
                                            <a href="<?php echo APP_URL; ?>/admin/employees" class="card-link">Ver
                                                funcionários <i class="bi bi-arrow-right"></i></a>
                                        </div>
                                    </div>
                                    <div class="d-inline-block ms-3">
                                        <div class="stat">
                                            <a href="<?php echo APP_URL; ?>/admin/employees" title="Ver funcionários"><i
                                                    class="align-middle bi bi-people card-icon"></i></a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start">
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="mb-0">
                                            <a href="<?php echo APP_URL; ?>/admin/releases" class="card-link">Ver
                                                lançamentos <i class="bi bi-arrow-right"></i></a>
                                        </div>
                                    </div>
                                    <div class="d-inline-block ms-3">
                                        <div class="stat">
                                            <a href="<?php echo APP_URL; ?>/admin/releases" title="Ver lançamentos"><i
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start">
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="mb-0">
                                            <a href="<?php echo APP_URL; ?>/admin/visitors" class="card-link">Ver os
                                                visitantes <i class="bi bi-arrow-right"></i></a>
                                        </div>
                                    </div>
                                    <div class="d-inline-block ms-3">
                                        <div class="stat">
                                            <a href="<?php echo APP_URL; ?>/admin/visitors" title="Ver visitantes"><i
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start">
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="mb-0">
                                            <a href="<?php echo APP_URL; ?>/admin/visitors" class="card-link">Ver
                                                actividade <i class="bi bi-arrow-right"></i></a>
                                        </div>
                                    </div>
                                    <div class="d-inline-block ms-3">
                                        <div class="stat">
                                            <a href="<?php echo APP_URL; ?>/admin/visitors" title="Usuários online"><i
                                ...
                                <div class="d-flex align-items-start">
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="mb-2">Vê agora todas as contas indisponível na <strong>Wasom
                                                Upfy</strong></p>
                                        <div class="mb-0">
                                            <a href="<?php echo APP_URL; ?>/admin/users/unavailable-account"
                                ...
                                <div class="d-flex align-items-start">
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="mb-2">Utilizadores com conta bancária registada na <strong>Wasom
                                                Upfy</strong></p>
                                        <div class="mb-0">
                                            <a href="<?php echo APP_URL; ?>/admin/users" class="card-link">Ver contas <i
                                                    class="bi bi-arrow-right"></i></a>
                                        </div>
                                    </div>
                                    <div class="d-inline-block ms-3">
                                        <div class="stat">
                                            <a href="<?php echo APP_URL; ?>/admin/users" title="Contas bancárias"><i
                                ...
                                <div class="d-flex align-items-start">
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="mb-2">Colaboradores registados pelos artistas da <strong>Wasom
                                                Upfy</strong></p>
                                        <div class="mb-0">
                                            <a href="<?php echo APP_URL; ?>/admin/users" class="card-link">Ver
                                                colaboradores <i class="bi bi-arrow-right"></i></a>
                                        </div>
                                    </div>
                                    <div class="d-inline-block ms-3">
                                        <div class="stat">
                                            <a href="<?php echo APP_URL; ?>/admin/users" title="Colaboradores"><i
                                ...
                                <div class="d-flex align-items-start">
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="mb-2">Total histórico de pagamentos aprovados na <strong>Wasom
                                                Upfy</strong></p>
                                        <div class="mb-0">
                                            <a href="<?php echo APP_URL; ?>/admin/finances" class="card-link">Ver
                                                finanças <i class="bi bi-arrow-right"></i></a>
                                        </div>
                                    </div>
                                    <div class="d-inline-block ms-3">
                                        <div class="stat">
                                            <a href="<?php echo APP_URL; ?>/admin/finances" title="Receita acumulada"><i
                                ...
                                <div class="d-flex align-items-start">
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="mb-2">Todos os pedidos de suporte da <strong>Wasom Upfy</strong> estão
                                            disponíveis aqui.</p>
                                        <div class="mb-0">
                                            <a href="<?php echo APP_URL; ?>/admin/support" class="card-link">Ver pedidos
                                                de suporte <i class="bi bi-arrow-right"></i></a>
                                        </div>
                                    </div>
                                    <div class="d-inline-block ms-3">
                                        <div class="stat">
                                            <a href="<?php echo APP_URL; ?>/admin/support" title="Suporte"><i
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3 d-flex">
                        <div class="card stats-card-primary flex-fill">
                            ...
                            <a href="<?php echo APP_URL; ?>/admin/analytics" class="card-link">Ver todas <i
                                    class="bi bi-arrow-right"></i></a>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="col-12 col-md-6 mb-3">
                        <div class="card stats-card-primary flex-fill">
                            ...
                            <a href="<?php echo APP_URL; ?>/admin/audit" class="card-link mt-3">Ver toda actividade <i
                                    class="bi bi-arrow-right"></i></a>
                        </div>
                    </div>
                    <?php endif; ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 mb-3 d-flex">
                        <div class="card stats-card-primary flex-fill">
                            <div class="section-card-header">
                                ...
                                <a href="<?php echo APP_URL; ?>/admin/users" class="card-link" style="font-size:.8rem">
                    ...
                    <div class="col-md-5 mb-3 d-flex">
                        <div class="card stats-card-primary flex-fill">
                            ...
                            <?php endforeach; ?>
                            <?php endif; ?>
                            <a href="<?php echo APP_URL; ?>/admin/users" class="card-link mt-3">Ver utilizadores <i
                                    class="bi bi-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3 d-flex">
                        <div class="card stats-card-primary flex-fill">
                            <div class="section-card-header">
                                ...
                                <a href="<?php echo APP_URL; ?>/admin/releases/pending" class="card-link"
                    ...
                    <div class="col-md-6 mb-3 d-flex">
                        <div class="card stats-card-primary flex-fill">
                            ...
                            <a href="<?php echo APP_URL; ?>/admin/settings" class="card-link">Ver histórico completo <i
                                    class="bi bi-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12 mb-3">
                        <div class="card stats-card-primary flex-fill">
                            <div class="section-card-header">
                                ...
                                <a href="<?php echo APP_URL; ?>/admin/finances/payments" class="card-link"
                                    style="font-size:.8rem">Ver todos <i class="bi bi-arrow-right"></i></a>
                            </div>
                    ...
                    <div class="col-12 mb-3">
                        <div class="card stats-card-primary flex-fill">
                            <div class="section-card-header">
                                ...
                                <a href="<?php echo APP_URL; ?>/admin/releases" class="card-link"
                ...
                <div class="col-12 mb-3">
                    <div class="card stats-card-primary flex-fill">
                        <div class="section-card-header">
                            ...
                            <a href="<?php echo APP_URL; ?>/admin/support" class="card-link" style="font-size:.8rem">
                                Ver todos <i class="bi bi-arrow-right"></i>
                            </a>
                        </div>
                        ...
                        <div class="activity-item d-flex mb-3 pb-3"
                            ...
                            <div class="flex-grow-1 ms-3">
                                ...
                                <div class="mt-1">
                                    ...
                                    <a href="<?php echo APP_URL; ?>/admin/support/<?php echo (int)$tk['id_ticket']; ?>"
