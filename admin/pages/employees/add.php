            ...
            <ul class="nav flex-column mt-3">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="collapseAdmins">
                        <a href="all-employes" class="nav-link">
            ...
            <div class="container-fluid p-0">
                <div class="row mb-3 mt-2">
                    <div class="welcome-text col-auto d-sm-block">
                        <h2 class="h4 mb-2"><i class="bi bi-person-add me-2"></i>Adicionar Funcionário</span></h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                <li class="breadcrumb-item"><a href="add" class="text-secondary">Funcionários</a>
                                </li>
                                <li class="breadcrumb-item active text-secondary" aria-current="page">Adcionar
                                    Funcionário
                                </li>
                            </ol>
                        </nav>
                    ...
                    <div class="col-auto ms-auto text-end mt-n1 mt-3 mb-2">
                        <a class="text-secondary shadow-sm me-2" href="all-employees">Todos Funcionários</a>
                        <a class="text-secondary shadow-sm me-2" href="edit">Editar Funcionários</a>
                        <a class="text-secondary shadow-sm" href="delete">Excluír Funcionários</a>
                    </div>
                    <!-- Stats Description -->
                        ...
                        <div class="row">
                                ...
                                <form id="create-user-form">
                                    ...
                                    <div class="form-section">
                                        ...
                                        <div class="row g-3 mt-3">
                                            <div class="col-md-6">
                                                <label for="gender" class="form-label">Genéro*</label>
                                                <input type="text" class="form-control"
                                                    placeholder="Insira o nome da conta" autocomplete="name" id="gender"
                                                    size="1" maxlength="1" required>
                                                <small class="text-muted">Digite inicial de género (M/F)</small>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control"
                                                    placeholder="(Nome de funcionário automático)"
                                                    autocomplete="username" id="username" required>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <small class="text-muted">O e-mail inserido pare este campo será usado
                                                    para enviar as crendeciais do novo funcionário</small>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-section mt-4">
                                        ...
                                        <div class="row g-3 mt-3">
                                            <div class="col-md-6">
                                                ...
                                                <select class="form-select" id="roles" size="1" required>
                                                    <option value="admin">Administrador</option>
                                                    <option value="distributor">Distribuidor</option>
                                                    <option value="analyst">Analista</option>
                                                    <option value="financial">Financeiro</option>
                                                </select>
                                                <small class="text-muted">Selecione o cargo
                                                    Cargo</small>
                                            </div>
                                            <div class="col-md-6">
                            ...
                            <div class="col-lg-4">
                                <div class="preview-section">
                                    ...
                                    <h5 class="text-center" id="preview-name">Nome do Funcionário</h5>
                                    <p class="text-center text-muted mb-3" id="preview-gender">genéro</p>
                                    ...
                                    <div class="mb-3">
                                        <h6><i class="bi bi-award me-2"></i> Cargo</h6>
                                        <div id="preview-roles">
                                            <span class="badge bg-secondary badge-role">Nenhuma cargo
                                                selecionada</span>
                                        </div>
                                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updatePreview() {
                // Informações básicas
                previewName.textContent = nameInput.value || "Nome do Funcionário";
                previewgender.textContent = genderInput.value ? `${genderInput.value}` : "genéro";
            ...
            [genderInput, nameInput, usernameInput, emailInput, countrySelect, cityInput, rolesSelect,
                statusSelect
            ].forEach(element => {
            ...
            form.addEventListener('submit', function(e) {
                ...
                alert('Conta criada com sucesso!\n\nSenha do funcionário: ' + passwordInput.value);
