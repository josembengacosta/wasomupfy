...
<head>
  ...
  <style>
    ...
    .custom-select-checkbox:hover input~.checkmark {
      background-color: #ccc;
    }

    .custom-select-checkbox input:checked~.checkmark {
      background-color: #6c5ce7;
    }
    ...
    .custom-select-checkbox input:checked~.checkmark:after {
      display: block;
      left: 7px;
      top: 3px;
      width: 5px;
...
<body>
      ...
      <ul class="nav flex-column mt-3">
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="collapseAnalytics">
            ...
            <a href="../analytics/artists" class="nav-link active">
      ...
      <div class="container-fluid py-0">
        <div class="row mb-3 mt-2">
          <div class="welcome-text col-auto d-sm-block">
            <h2 class="h4 mb-2">
              <i class="bi bi-person-lines-fill me-2"></i>Desempenho por
              Artista
            </h2>
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item">
                  <a href="../analytics/home" class="text-secondary">Analytics</a>
                </li>
          ...
          <div class="col-auto ms-auto text-end mt-n1 mt-3 mb-2">
            <div class="btn-group">
              <button class="btn btn-wasomupfy text-white shadow-sm" id="refresh-data-btn">
                <i class="bi bi-arrow-clockwise me-2"></i> Atualizar
              </button>
              <button class="btn btn-outline-primary shadow-sm" id="compare-artists-btn">
                <i class="bi bi-bar-chart me-2"></i> Comparar
              </button>
              <button class="btn btn-success shadow-sm" id="export-data-btn" data-bs-toggle="modal"
                ...
                <div class="card-body">
                  <div class="d-flex justify-content-between align-items-center">
                    <div>
                      ...
                      <h3 class="performance-metric badge badge-soft-pink" id="total-streams">
                        0
                      </h3>
                      <span class="performance-change trend-up" id="streams-change">
                        <i class="bi bi-arrow-up-right me-1"></i>12.5%
                      </span>
                    </div>
                    <div class="stat">
                      <i class="bi bi-play-circle card-icon align-middle"></i>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card-body">
                  <div class="d-flex justify-content-between align-items-center">
                    <div>
                      ...
                      <h3 class="performance-metric badge badge-soft-pink" id="active-artists">
                        0
                      </h3>
                      <span class="performance-change trend-up" id="artists-change">
                        <i class="bi bi-arrow-up-right me-1"></i>8.3%
                      </span>
                    </div>
                    <div class="stats-icon">
                      <i class="bi bi-person-badge card-icon align-middle"></i>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card-body">
                  <div class="d-flex justify-content-between align-items-center">
                    <div>
                      ...
                      <h3 class="performance-metric badge badge-soft-pink" id="playlist-tracks">
                        0
                      </h3>
                      <span class="performance-change trend-up" id="playlist-change">
                        <i class="bi bi-arrow-up-right me-1"></i>15.2%
                      </span>
                    </div>
                    <div class="stats-icon">
                      <i class="bi bi-music-note-list card-icon align-middle"></i>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card-body">
                  <div class="d-flex justify-content-between align-items-center">
                    <div>
                      ...
                      <h3 class="performance-metric badge badge-soft-pink" id="total-revenue">
                        $0
                      </h3>
                      <span class="performance-change trend-up" id="revenue-change">
                        <i class="bi bi-arrow-up-right me-1"></i>18.7%
                      </span>
                    </div>
                    <div class="stats-icon">
                      <i class="bi bi-currency-dollar card-icon align-middle"></i>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="filter-section fade-in-custom">
            ...
            <div class="row g-3">
              <div class="col-md-3">
                <label for="filter-artist">Artista:</label>
                <input type="text" class="form-control" id="filter-artist" placeholder="Nome do artista" />
              </div>
              <div class="col-md-3">
                <label for="filter-track">Música:</label>
                <input type="text" class="form-control" id="filter-track" placeholder="Nome da música" />
              </div>
              <div class="col-md-3">
                <label for="filter-account">Conta:</label>
                <select class="form-select" id="filter-account">
                  <option value="">Todas</option>
                  <option value="pro">Conta Pro</option>
                  <option value="basic">Conta Basic</option>
                  <option value="international">Conta Internacional</option>
                  <option value="intl">Conta Intl</option>
                </select>
              </div>
              <div class="col-md-3">
              ...
              <div class="col-md-3">
                ...
                <select class="form-select" id="filter-territory">
              ...
              <div class="col-md-3">
                <label for="filter-playlist">Playlist:</label>
                <select class="form-select" id="filter-playlist">
                  <option value="">Todas</option>
                  <option value="top50">Top 50</option>
                  <option value="editorial">Editorial</option>
                  <option value="viral">Viral</option>
                  <option value="none">Sem playlist</option>
                  <option value="new_music">New Music Friday</option>
            ...
            <div class="advanced-filters" id="advanced-filters">
              <div class="row g-3 mt-3 pt-3 border-top">
                <div class="col-md-4">
                  <label>Faixa de Streams:</label>
                  <div class="row g-2">
                    <div class="col">
                      <input type="number" class="form-control" id="streams-min" placeholder="Mín" />
                    </div>
                    <div class="col-auto align-self-center">
                      <span class="text-muted">-</span>
                    </div>
                    <div class="col">
                      <input type="number" class="form-control" id="streams-max" placeholder="Máx" />
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  ...
                  <select class="form-select" id="sort-by">
                    <option value="streams">Streams (maior primeiro)</option>
                    <option value="streams_asc">
                      Streams (menor primeiro)
                    </option>
                    <option value="date">Data (mais recente)</option>
                    <option value="date_asc">Data (mais antiga)</option>
                    <option value="artist">Artista (A-Z)</option>
                    <option value="track">Música (A-Z)</option>
                  </select>
                </div>
                <div class="col-md-4">
                  <label>Visualizar por:</label>
                  <select class="form-select" id="group-by">
                    <option value="none">Itens individuais</option>
                    <option value="artist">Agrupar por artista</option>
                    <option value="platform">Agrupar por plataforma</option>
                    <option value="territory">Agrupar por território</option>
                    <option value="playlist">Agrupar por playlist</option>
                  </select>
                </div>
                <div class="col-md-12">
                  <label class="mb-2">Selecionar Plataformas:</label>
                  <div class="platform-selector" id="platform-selector">
                    <!-- Plataformas serão carregadas dinamicamente -->
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="quick-filter mt-3">
              <span class="text-muted me-2">Visualizar:</span>
              <button class="btn btn-outline-primary btn-sm filter-quick" data-filter="today">
                Hoje
              </button>
              <button class="btn btn-outline-primary btn-sm filter-quick" data-filter="week">
                Esta Semana
              </button>
              <button class="btn btn-outline-primary btn-sm filter-quick" data-filter="month" data-active="true">
                Este Mês
              </button>
              <button class="btn btn-outline-primary btn-sm filter-quick" data-filter="quarter">
                Este Trimestre
              </button>
              <button class="btn btn-outline-primary btn-sm filter-quick" data-filter="year">
                Este Ano
              </button>
              <button class="btn btn-outline-primary btn-sm filter-quick" data-filter="all">
                Todo Período
              </button>
            </div>

            <div class="d-flex justify-content-between align-items-center mt-3">
              <button class="btn btn-wasomupfy text-white" id="apply-filters">
              ...
              <div>
                ...
                <button class="btn btn-outline-success" id="save-filter-btn">
                  <i class="bi bi-bookmark me-2"></i> Salvar Filtro
                </button>
              </div>
            </div>
          </div>
          ...
          <div class="comparison-panel" id="comparison-panel" style="display: none">
            <div class="d-flex justify-content-between align-items-center mb-3">
              <h5 class="mb-0">
                <i class="bi bi-bar-chart me-2"></i>Comparação de Artistas
              </h5>
              <button class="btn-close" id="close-comparison"></button>
            </div>
            <div id="comparison-content">
              <!-- Conteúdo da comparação será carregado dinamicamente -->
            </div>
          </div>
              ...
              <div class="card">
                <div class="card-header">
                  <h5 class="card-title mb-0">
                    <i class="bi bi-bar-chart-line me-2"></i>Desempenho por
                    Período
                  </h5>
                </div>
                <div class="card-body">
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    <div>
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="select-all-tracks" />
                        <label class="form-check-label" for="select-all-tracks">Selecionar Todos</label>
                      </div>
                      <span class="text-muted ms-3" id="selected-tracks-count">0 selecionados</span>
                    </div>
                    <div class="btn-group export-buttons">
                      <button class="btn btn-outline-primary btn-sm" id="export-selected-btn">
                        <i class="bi bi-download me-1"></i> Exportar
                        Selecionados
                      </button>
                      <button class="btn btn-outline-success btn-sm" id="generate-report-btn">
                        <i class="bi bi-file-earmark-bar-graph me-1"></i>
                        Gerar Relatório
                      </button>
                      <button class="btn btn-outline-warning btn-sm" id="compare-selected-btn">
          ...
          <div class="card fade-in-custom">
            <div class="card-header">
              <div class="d-flex justify-content-between align-items-center">
                <h5 class="card-title mb-0">
                  <i class="bi bi-table me-2"></i>Desempenho de Músicas
                </h5>
                <span class="badge bg-primary" id="performance-results-count">0 resultados</span>
              </div>
            </div>
            ...
            <nav aria-label="Page navigation">
              <ul class="pagination justify-content-center" id="performance-pagination"></ul>
            </nav>
          </div>

          <!-- Top Artistas e Plataformas -->
          <div class="row mt-4">
            <div class="col-md-6">
              <div class="card">
                <div class="card-header">
                  <h5 class="card-title mb-0">
                    <i class="bi bi-trophy me-2"></i>Top 5 Artistas
                  </h5>
                </div>
                <div class="card-body">
                  <div id="top-artists">
                    <!-- Top artistas será carregado dinamicamente -->
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="card">
                ...
                <div class="card-body">
                  <div id="platform-distribution">
                    <!-- Distribuição será carregada dinamicamente -->
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="modal-body">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="mb-3">
                      <label for="export-date-range" class="form-label">Período*</label>
                      <select class="form-select" id="export-date-range" required>
                        <option value="filtered">Período filtrado</option>
                    ...
                    <div class="mb-3" id="custom-date-range" style="display: none">
                      <label class="form-label">Datas Personalizadas</label>
                      <div class="date-range-picker">
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      <label class="form-label">Colunas a Incluir*</label>
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="col-id" checked />
                        <label class="form-check-label" for="col-id">ID</label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="col-account" checked />
                        <label class="form-check-label" for="col-account">Conta</label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="col-track" checked />
                        <label class="form-check-label" for="col-track">Música</label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="col-artist" checked />
                        <label class="form-check-label" for="col-artist">Artista</label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="col-streams" checked />
                        <label class="form-check-label" for="col-streams">Streams</label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="col-platform" checked />
                        <label class="form-check-label" for="col-platform">Plataforma</label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="col-playlist" checked />
                        <label class="form-check-label" for="col-playlist">Playlist</label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="col-territory" checked />
                        <label class="form-check-label" for="col-territory">Território</label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="col-date" checked />
                        <label class="form-check-label" for="col-date">Data</label>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="alert alert-info">
                  ...
                  <strong>Itens para exportar:</strong>
                  <span id="export-item-count">0</span> item(s)
                </div>

                <div class="mb-3">
                  <label for="export-filename" class="form-label">Nome do Arquivo</label>
                  <input type="text" class="form-control" id="export-filename" value="desempenho_artistas" />
                </div>
              </div>
              <div class="modal-footer">
      ...
      <div class="modal fade" id="detailModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title">
                <i class="bi bi-info-circle me-2"></i>Detalhes do Desempenho
              </h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-wasomupfy" id="export-detail-btn">
                <i class="bi bi-download me-2"></i> Exportar Detalhes
              </button>
            </div>
          </div>
        </div>
  ...
  <script src="js/artist-performance.js"></script>
</body>
