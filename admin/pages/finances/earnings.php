    ...
    <div class="wrapper">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav flex-column mt-3">
                ...
                <li class="nav-item">
                    <a href="../finances/earnings" class="nav-link active">
        ...
        <div class="content w-100" id="mainContent">
            ...
            <div class="container-fluid p-0">
                <div class="row mb-3 mt-2">
                    <div class="welcome-text col-auto d-sm-block">
                        <h2 class="h4 mb-2">Finanças e Rendimentos</span></h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                <li class="breadcrumb-item"><a href="../finances/earnings"
                                        class="text-secondary">Finanças</a>
                                </li>
                                <li class="breadcrumb-item active text-secondary" aria-current="page">Finanças e
                                    Rendimentos</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-auto ms-auto text-end mt-n1 mt-3 mb-2">
                        <a class="text-secondary shadow-sm me-2" href="">Pedidos de saque
                        </a>
                        <a class="text-secondary shadow-sm me-2" href="">Contas de saque</a>
                        <a class="text-secondary shadow-sm" href="">Divisão de royalties</a>
                        <button class="btn btn-wasomupfy text-white shadow-sm">
                            <i class="align-middle bi bi-plus" onclick=""></i> Adcionar dados</button>
                    </div>
                    <!-- Stats Description -->
                    ...
                    <div class="search-container date-range fade-in-custom">
                        <div class="row g-3">
                            <div class="col-md-2">
                                ...
                                <input type="number" class="form-control" min="1" id="account-id" placeholder="ID">
                            </div>
                            <div class="col-md-2">
                                <label for="account-name">Conta:</label>
                                <input type="text" class="form-control" id="account-name" placeholder="Nome da Conta">
                            </div>
                            <div class="col-md-2">
                                <label for="account-operator">Operador:</label>
                                <input type="text" class="form-control" id="account-operator" placeholder="Operador">
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-2">
                                <label for="account-date">Data:</label>
                                <input type="date" class="form-control" id="account-date">
                            </div>
                            <div class="col-md-2">
                                <label>&nbsp;</label>
                                <button class="btn btn-wasomupfy text-white w-100" id="clear-filters">
            ...
            <div class="container-fluid p-0" id="cash">
                <div class="row mb-3 mt-2">
                    <div class="welcome-text col-auto d-sm-block">
                        <h2 class="h4 mb-2">Receitas de Hoje</span></h2>
                    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="save-account-changes">Salvar</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="delete-account-password" class="form-label">Digite sua senha:</label>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                    <button type="button" class="btn btn-danger" id="confirm-account-delete">Excluir</button>
                </div>
            </div>
        </div>
    </div>
